...
Section -Main SEC0000
        ...
        DetailPrint "Installing Microsoft SQL Server Express 32-bit edition..."
        
        DetailPrint "Extracting SQL Server Express Installation Files..."
        SetDetailsPrint textonly
        File /r "${SQLServerExpress_SOURCE}\2008R2x86"
        SetDetailsPrint both
        
        DetailPrint "Installing SQL Server Express ${SQLServerExpressVersion} on local instance .\EncounterPRO_OS"
        DetailPrint "This may take several minutes..."
        nsExec::Exec '"$INSTDIR\2008R2x86\Setup.exe" /configurationfile="$INSTDIR\2008R2x86\EncounterPRO-OS-SQLConfiguration.ini"'
        ...
        sqlncli64:
        MessageBox MB_OK "This is the installer for the 32-bit edition of SQL Server Express.  Please use the 64-bit SQL Server Express Installer."
        Abort "Please use the 64-bit SQL Server Express Installer"
