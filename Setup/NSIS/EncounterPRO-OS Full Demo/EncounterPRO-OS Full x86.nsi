...
; Name and File
Name '${DISP_NAME}'
OutFile 'InstallEproFull.${VERSION}.x86.exe'
...
Function PreInstall
  ...
  ;MessageBox MB_OK "$WinVer"
    ...
    found64:
    MessageBox MB_OK "This is the installer for 32-bit computers.  Please use the 64-bit installer."
    Abort "Please use the 64-bit SQL installer"
...
SectionEnd
    ...
    Section 'SQL Server Express' SQLXpress
        ...
        File '${SRC_SQLServerExpressInstaller}\EproSQLx86.exe'
        
        nsExec::Exec '"$INSTDIR\EproSQLx86.exe"'
        IfErrors 0 +3
