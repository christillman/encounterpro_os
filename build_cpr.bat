...
REM pbc220.exe /d "%cd%\Client\cpr.pbt" /o "%cd%\Client\EncounterPRO.OS.Client.exe" /r "%cd%\Client\encounterpro.os.pbr" /w n /m y /in y /op 2 /x 32 /p "EncounterPRO-OS" /cp "EncounterPRO Foundation, Inc" /de "Electronic Medical Record System" /cr "(c) 1997-2025 EncounterPRO Foundation Inc." /v "%1" /fv "%1" /ge 2 /le 0 /ps n /pd nyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy /rt %runtimeversion%
...
pbc220.exe /d "%cd%\Client\cpr.pbt" /o "%cd%\Client\EncounterPRO.OS.Client.exe" /r "%cd%\Client\encounterpro.os.pbr" /w n /m n /x 32 /p "EncounterPRO-OS" /cp "EncounterPRO Foundation, Inc" /de "Electronic Medical Record System" /cr "(c) 1997-2025 EncounterPRO Foundation Inc." /v "%1" /fv "%1" /ge 2 /le 0 /ps n /pd yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy /rt %runtimeversion%
