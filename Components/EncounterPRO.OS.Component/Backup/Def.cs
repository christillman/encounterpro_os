...
namespace EncounterPRO.OS.Component
{
	...
	{
		Error = -1,		// Error
		NotComplete,	// User selected "I'll Be Back"
		Complete,		// User selected "I'm Finished"
		Cancelled,		// This service is not finished and will never be finished
		DoLater,		// Service not completed and changed from in-office to out-of-office
		//		user selected "I'll do later"
		LeaveForRole	// Service not completed and reverts back to the original role
		//		user selected "Leave for role"
	}

	public delegate System.Data.DataSet ExecuteSql(
		string SqlText, 
		ref System.Data.SqlClient.SqlParameter[] Params);
}
