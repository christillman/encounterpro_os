...
SELECT p.cpr_id
     ...
     INNER JOIN c_vaccine_disease cvd WITH (NOLOCK)
        ON i.drug_id = cvd.vaccine_id
...
-- A vaccine already done
      WHERE
        ...
        INNER JOIN c_vaccine_disease cvd2 WITH (NOLOCK)
        ON i2.drug_id = cvd2.vaccine_id
...
FROM c_vaccine_disease cvd WITH (NOLOCK),
     ...
     WHERE
        ...
        INNER JOIN c_vaccine_disease cvd3 WITH (NOLOCK)
        ON i3.drug_id = cvd3.vaccine_id
