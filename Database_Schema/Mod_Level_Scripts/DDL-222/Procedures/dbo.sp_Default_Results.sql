...
-- Drop Procedure [dbo].[sp_Default_Results]
Print 'Drop Procedure [dbo].[sp_Default_Results]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_Default_Results]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_Default_Results]
GO

-- Create Procedure [dbo].[sp_Default_Results]
