...
-- Drop Trigger [dbo].[tr_o_message_log_update]
Print 'Drop Trigger [dbo].[tr_o_message_log_update]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_o_message_log_update]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_o_message_log_update]
GO

-- Create Trigger [dbo].[tr_o_message_log_update]
Print 'Create Trigger [dbo].[tr_o_message_log_update]'
GO
SET ANSI_NULLS ON
