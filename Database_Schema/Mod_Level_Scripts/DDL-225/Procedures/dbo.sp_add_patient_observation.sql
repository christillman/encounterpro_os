...
-- Drop Procedure [dbo].[sp_add_patient_observation]
Print 'Drop Procedure [dbo].[sp_add_patient_observation]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_add_patient_observation]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_add_patient_observation]
GO

-- Create Procedure [dbo].[sp_add_patient_observation]
Print 'Create Procedure [dbo].[sp_add_patient_observation]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_add_patient_observation]
	TO [cprsystem]
GO
