...
-- Drop Procedure [dbo].[jmj_patient_immunization_schedule]
Print 'Drop Procedure [dbo].[jmj_patient_immunization_schedule]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_patient_immunization_schedule]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_patient_immunization_schedule]
GO

-- Create Procedure [dbo].[jmj_patient_immunization_schedule]
Print 'Create Procedure [dbo].[jmj_patient_immunization_schedule]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_patient_immunization_schedule]
	TO [cprsystem]
GO
