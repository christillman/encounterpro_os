...
-- Drop Procedure [dbo].[sp_get_todo_list_notpct_y]
Print 'Drop Procedure [dbo].[sp_get_todo_list_notpct_y]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_todo_list_notpct_y]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_todo_list_notpct_y]
GO

-- Create Procedure [dbo].[sp_get_todo_list_notpct_y]
Print 'Create Procedure [dbo].[sp_get_todo_list_notpct_y]'
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER OFF
GO
CREATE PROCEDURE sp_get_todo_list_notpct_y
(
...
GO
GRANT EXECUTE
	ON [dbo].[sp_get_todo_list_notpct_y]
	TO [cprsystem]
GO
