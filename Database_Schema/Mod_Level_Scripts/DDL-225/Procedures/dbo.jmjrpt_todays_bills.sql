DROP PROCEDURE IF EXISTS [jmjrpt_todays_bills]
...
GO
CREATE PROCEDURE [jmjrpt_todays_bills]
AS
...
Select @encounterdate = dbo.get_client_datetime()
...
SELECT	pe.cpr_id,
	...
	AND DATEDIFF(day, encounter_date, dbo.get_client_datetime()) = 0
...
GRANT EXECUTE ON [jmjrpt_todays_bills] TO [cprsystem] AS [dbo]
