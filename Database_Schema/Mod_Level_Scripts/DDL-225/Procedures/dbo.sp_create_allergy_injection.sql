...
-- Drop Procedure [dbo].[sp_create_allergy_injection]
Print 'Drop Procedure [dbo].[sp_create_allergy_injection]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_create_allergy_injection]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_create_allergy_injection]
GO

-- Create Procedure [dbo].[sp_create_allergy_injection]
Print 'Create Procedure [dbo].[sp_create_allergy_injection]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_create_allergy_injection]
	TO [cprsystem]
GO
