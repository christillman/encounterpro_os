...
-- Drop Procedure [dbo].[sp_close_encounter]
Print 'Drop Procedure [dbo].[sp_close_encounter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_close_encounter]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_close_encounter]
GO

-- Create Procedure [dbo].[sp_close_encounter]
Print 'Create Procedure [dbo].[sp_close_encounter]'
GO
SET ANSI_NULLS ON
