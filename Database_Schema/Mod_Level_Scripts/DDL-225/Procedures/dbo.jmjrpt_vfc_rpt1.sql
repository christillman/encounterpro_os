...
-- Drop Procedure [dbo].[jmjrpt_vfc_rpt1]
Print 'Drop Procedure [dbo].[jmjrpt_vfc_rpt1]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_vfc_rpt1]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_vfc_rpt1]
GO

-- Create Procedure [dbo].[jmjrpt_vfc_rpt1]
Print 'Create Procedure [dbo].[jmjrpt_vfc_rpt1]'
GO
SET ANSI_NULLS ON
