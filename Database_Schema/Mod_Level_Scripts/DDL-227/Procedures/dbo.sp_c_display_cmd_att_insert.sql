...
-- Drop Procedure [dbo].[sp_c_display_cmd_att_insert]
Print 'Drop Procedure [dbo].[sp_c_display_cmd_att_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_c_display_cmd_att_insert]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_c_display_cmd_att_insert]
GO

-- Create Procedure [dbo].[sp_c_display_cmd_att_insert]
Print 'Create Procedure [dbo].[sp_c_display_cmd_att_insert]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_c_display_cmd_att_insert]
	TO [cprsystem]
GO
