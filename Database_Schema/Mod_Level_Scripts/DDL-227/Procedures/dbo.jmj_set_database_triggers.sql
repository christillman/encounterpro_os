...
-- Drop Procedure [dbo].[jmj_set_database_triggers]
Print 'Drop Procedure [dbo].[jmj_set_database_triggers]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_set_database_triggers]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_set_database_triggers]
GO

-- Create Procedure [dbo].[jmj_set_database_triggers]
Print 'Create Procedure [dbo].[jmj_set_database_triggers]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_set_database_triggers]
	TO [cprsystem]
GO
