...
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_concept')
	BEGIN DROP TABLE sct2_concept END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_description')
	BEGIN DROP TABLE sct2_description END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_identifier')
	BEGIN DROP TABLE sct2_identifier END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_relationship')
	BEGIN DROP TABLE sct2_relationship END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_statedrelationship')
	BEGIN DROP TABLE sct2_statedrelationship END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'sct2_textdefinition')
	BEGIN DROP TABLE sct2_textdefinition END
IF EXISTS (SELECT 1 FROM sys.tables WHERE type = 'U' AND name = 'tls_Icd10cmHumanReadableMap')
	BEGIN DROP TABLE tls_Icd10cmHumanReadableMap END
GO
