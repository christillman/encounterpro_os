...
Import-DbaCsv -Path "C:\EncounterPro\encounterpro_os\Interfaces\Migration-Uganda\NATIONAL-DRUG-REGISTER-OF-UGANDA-HUMAN-MEDICINES-JULY-2024-1-utf8.csv"  -SqlInstance "localhost\EncounterPro"  -Database EncounterPro_Os  -Truncate  -KeepNulls  -AutoCreateTable -UseFileNameForSchema  -TrimmingOption All  -Encoding UTF8  -SkipEmptyLine  -SupportsMultiline  -UseColumnDefault  -NoTransaction  -EnableException
