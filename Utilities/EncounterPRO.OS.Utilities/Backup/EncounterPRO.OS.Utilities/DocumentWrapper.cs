...
{
	/// <summary>
	/// Summary description for DocumentWrapper.
	/// </summary>
	[Serializable]
	public class DocumentWrapper : PBCOMWrapper
	{
		public DocumentWrapper() : base() { }

		public string CreateDocument()
		{
			if(connectedType == null || connectedClass == null)
				throw new Exception("Not connected to implementation class.");
			System.Reflection.MethodInfo method = connectedType.GetMethod("CreateDocument", System.Type.EmptyTypes);
			string sRet = (string)method.Invoke(connectedClass, new object[]{});
			return sRet;
		}

		public string CreateDocument2(string XmlDocument)
		{
			if(connectedType == null || connectedClass == null)
				throw new Exception("Not connected to implementation class.");
			System.Reflection.MethodInfo method = connectedType.GetMethod("CreateDocument", new System.Type[]{typeof(string)});
			string sRet = (string)method.Invoke(connectedClass, new object[]{XmlDocument});
			return sRet;
		}

		public string ConfigureDocument(string XmlDocument)
		{
			if(connectedType == null || connectedClass == null)
				throw new Exception("Not connected to implementation class.");
			System.Reflection.MethodInfo method = connectedType.GetMethod("ConfigureDocument", new System.Type[]{typeof(string)});
			string sRet = (string)method.Invoke(connectedClass, new object[]{XmlDocument});
			return sRet;
		}

		public string GetDocumentElements(string XmlDocument)
		{
			if(connectedType == null || connectedClass == null)
				throw new Exception("Not connected to implementation class.");
			System.Reflection.MethodInfo method = connectedType.GetMethod("GetDocumentElements", new System.Type[]{typeof(string)});
			string sRet = (string)method.Invoke(connectedClass, new object[]{XmlDocument});
			return sRet;
		}
	}
