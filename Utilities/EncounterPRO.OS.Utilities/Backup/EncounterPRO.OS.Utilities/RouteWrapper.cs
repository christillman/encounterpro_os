...
{
    /// <summary>
    /// Summary description for RouteWrapper.
    /// </summary>
    [Serializable]
    public class RouteWrapper : PBCOMWrapper
    {
        public RouteWrapper() : base() { }
        ...
        public string SendDocument(string XmlDocument)
        {
            ...
            System.Reflection.MethodInfo method = connectedType.GetMethod("SendDocument", new System.Type[] { typeof(string) });
