HA$PBExportHeader$w_pop_printer_edit.srw
forward
...
if sqlca.sqlnrows = 0 then
	log.log(this, "open", "Printer not found (" +st_printer.text + ")" , 4)
	close(this)
	return
end if
...
event losefocus;integer li_len
