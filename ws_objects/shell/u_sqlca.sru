...
FUNCTION datetime fn_default_past_vaccine_date(string ps_cpr_id, datetime pdt_today) RPCFUNC ALIAS FOR "dbo.fn_default_past_vaccine_date"
...
FUNCTION long sp_cancel_service(string ps_cpr_id, long pl_encounter_id, long pl_encounter_log_id, string ps_accomplished_by) RPCFUNC ALIAS FOR "dbo.sp_cancel_service"
...
FUNCTION long sp_check_development_status(string ps_cpr_id, string ps_current_stage_id, ref integer pi_status) RPCFUNC ALIAS FOR "dbo.sp_check_development_status"
...
FUNCTION long sp_check_vaccine_status(string ps_cpr_id, long pl_disease_id, ref integer pi_status, ref datetime pdt_due_date_time) RPCFUNC ALIAS FOR "dbo.sp_check_vaccine_status"
...
FUNCTION long sp_close_encounter_if_done(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_close_encounter_if_done"
...
FUNCTION long sp_close_todo_encounter(string ps_cpr_id, long pl_encounter_id, string ps_created_by, ref datetime pdt_discharge_date, ref string ps_encounter_status) RPCFUNC ALIAS FOR "dbo.sp_close_todo_encounter"
...
FUNCTION long sp_complete_service(string ps_cpr_id, long pl_encounter_id, long pl_encounter_log_id, string ps_accomplished_by) RPCFUNC ALIAS FOR "dbo.sp_complete_service"
...
FUNCTION long sp_delete_assessment_therapy(string ps_user_id, string ps_assessment_id, long pl_treatment_sequence) RPCFUNC ALIAS FOR "dbo.sp_delete_assessment_therapy"
...
FUNCTION long sp_delete_report(string ps_report_id) RPCFUNC ALIAS FOR "dbo.sp_delete_report"
...
FUNCTION long sp_dispatch_pharmacist_service(string ps_cpr_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_dispatch_pharmacist_service"
...
FUNCTION long sp_get_assessment_icd9(string ps_cpr_id, string ps_assessment_id) RPCFUNC ALIAS FOR "dbo.sp_get_assessment_icd9"
...
FUNCTION long sp_get_assessment_therapies(string ps_user_id, string ps_assessment_id) RPCFUNC ALIAS FOR "dbo.sp_get_assessment_therapies"
...
FUNCTION long sp_get_current_finding(string ps_cpr_id, long pl_encounter_id, string ps_finding_list, string ps_user_id, ref long pl_finding_sequence) RPCFUNC ALIAS FOR "dbo.sp_get_current_finding"
...
FUNCTION long sp_get_diseases_to_attach(string ps_vaccine_id) RPCFUNC ALIAS FOR "dbo.sp_get_diseases_to_attach"
...
FUNCTION long sp_get_exam_observations(string ps_cpr_id, long pl_treatment_id, string ps_observation_type, string ps_observation_category_id) RPCFUNC ALIAS FOR "dbo.sp_get_exam_observations"
FUNCTION long sp_get_exams(string ps_cpr_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_get_exams"
...
FUNCTION long sp_get_history_questionnaires(string ps_cpr_id, string ps_questionnaire_type) RPCFUNC ALIAS FOR "dbo.sp_get_history_questionnaires"
FUNCTION long sp_get_holding_attachments() RPCFUNC ALIAS FOR "dbo.sp_get_holding_attachments"
FUNCTION long sp_get_immunization_schedule(long pl_disease_id) RPCFUNC ALIAS FOR "dbo.sp_get_immunization_schedule"
...
FUNCTION long sp_get_last_discussed_by(string ps_cpr_id, string ps_stage_id, ref long pl_encounter_id, ref string ps_discussed_by, ref datetime pdt_discussed_date_time) RPCFUNC ALIAS FOR "dbo.sp_get_last_discussed_by"
...
FUNCTION long sp_get_objective_flags(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, ref string ps_description, ref string ps_collection_location_domain, ref string ps_perform_location_domain, ref string ps_collection_flag, ref string ps_perform_flag, ref string ps_send_out_flag, ref string ps_collected, ref long pl_attachment_id) RPCFUNC ALIAS FOR "dbo.sp_get_objective_flags"
...
FUNCTION long sp_get_observation_results(string ps_cpr_id, long pl_treatment_id, string ps_observation_id) RPCFUNC ALIAS FOR "dbo.sp_get_observation_results"
...
FUNCTION long sp_get_office_status_all(string ps_office_id) RPCFUNC ALIAS FOR "dbo.sp_get_office_status_all"
...
FUNCTION long sp_get_outstanding_objectives(string ps_cpr_id) RPCFUNC ALIAS FOR "dbo.sp_get_outstanding_objectives"
...
FUNCTION long sp_get_performed_objectives(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_get_performed_objectives"
FUNCTION long sp_get_physical_objectives(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_get_physical_objectives"
FUNCTION long sp_get_physicals(string ps_cpr_id, long pl_encounter_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_get_physicals"
FUNCTION long sp_get_physicals_with_no_results(string ps_cpr_id, long pl_encounter_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_get_physicals_with_no_results"
...
FUNCTION long sp_get_result(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, integer pi_result_sequence, ref real pr_result_amount, ref string ps_result_unit) RPCFUNC ALIAS FOR "dbo.sp_get_result"
FUNCTION long sp_get_result_list(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, string ps_location) RPCFUNC ALIAS FOR "dbo.sp_get_result_list"
FUNCTION long sp_get_result_loc(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, string ps_location, integer pi_result_sequence, ref real pr_result_amount, ref string ps_result_unit) RPCFUNC ALIAS FOR "dbo.sp_get_result_loc"
FUNCTION long sp_get_results_by_loc(string ps_cpr_id, long pl_treatment_id, string ps_observation_id) RPCFUNC ALIAS FOR "dbo.sp_get_results_by_loc"
...
FUNCTION long sp_get_stage(datetime pdt_date_of_birth, datetime pdt_current_date, ref string ps_stage_id) RPCFUNC ALIAS FOR "dbo.sp_get_stage"
FUNCTION long sp_get_test(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, ref string ps_send_out_flag, ref string ps_collection_flag, ref string ps_perform_flag, ref string ps_description) RPCFUNC ALIAS FOR "dbo.sp_get_test"
FUNCTION long sp_get_test_attachment_id(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, ref long pl_attachment_id) RPCFUNC ALIAS FOR "dbo.sp_get_test_attachment_id"
FUNCTION long sp_get_todo_item(string ps_user_id, long pl_todo_item_id, ref string ps_service, ref string ps_ordered_by, ref string ps_todo_item, ref datetime pdt_todo_date_time, ref datetime pdt_start_date_time, ref datetime pdt_end_date_time, ref string ps_status) RPCFUNC ALIAS FOR "dbo.sp_get_todo_item"
...
FUNCTION long sp_get_unperformed_objectives(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_get_unperformed_objectives"
...
FUNCTION long sp_get_vaccines_to_attach(long pl_disease_id) RPCFUNC ALIAS FOR "dbo.sp_get_vaccines_to_attach"
FUNCTION long sp_get_vitals(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_get_vitals"
FUNCTION long sp_get_vitals_quick(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_get_vitals_quick"
...
FUNCTION long sp_interesting_objectives(string ps_cpr_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_interesting_objectives"
...
FUNCTION long sp_new_activity_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, real pr_duration_amount, string ps_duration_unit, string ps_duration_prn, string ps_administer_frequency, string ps_treatment_description) RPCFUNC ALIAS FOR "dbo.sp_new_activity_therapy"
...
FUNCTION long sp_new_assessment(string ps_assessment_type, string ps_icd_9_code, string ps_assessment_category_id, string ps_description, string ps_location_domain, string ps_auto_close, integer pi_auto_close_interval_amount, string ps_auto_close_interval_unit, long pl_risk_level, long pl_complexity, string ps_long_description, long pl_owner_id, string ps_status, ref string ps_assessment_id, string ps_allow_dup_icd_9_code) RPCFUNC ALIAS FOR "dbo.sp_new_assessment"
FUNCTION long sp_new_assessment_definition(string ps_assessment_type, string ps_icd_9_code, string ps_assessment_category_id, string ps_description, string ps_location_domain, string ps_auto_close, integer pi_auto_close_interval_amount, string ps_auto_close_interval_unit, long pl_risk_level, long pl_complexity, string ps_long_description) RPCFUNC ALIAS FOR "dbo.sp_new_assessment_definition"
FUNCTION long sp_new_assessment_treatment(string ps_user_id, string ps_assessment_id, string ps_treatment_type, real pr_duration_amount, string ps_duration_unit, string ps_duration_prn, string ps_administer_frequency, string ps_treatment_description, string ps_drug_id, string ps_dosage_form, string ps_specialty_id, string ps_observation_id, string ps_procedure_id, string ps_treatment_goal, string ps_referral_question, string ps_referral_question_asmnt_id, string ps_instructions, string ps_pharmacist_instructions, string ps_send_out_flag, integer pi_administration_sequence, long pl_parent_treatment_sequence, ref long pl_treatment_sequence) RPCFUNC ALIAS FOR "dbo.sp_new_assessment_treatment"
...
FUNCTION long sp_new_drug_administration(string ps_drug_id, integer pi_administration_sequence, string ps_administer_frequency, real pr_administer_amount, string ps_administer_unit, string ps_mult_by_what, string ps_calc_per, string ps_description) RPCFUNC ALIAS FOR "dbo.sp_new_drug_administration"
...
FUNCTION long sp_new_encounter_log(string ps_cpr_id, long pl_encounter_id, string ps_room_id, string ps_ordered_by, string ps_service, string ps_description, string ps_status, string ps_ordered_for, string ps_created_by, ref long pl_encounter_log_id) RPCFUNC ALIAS FOR "dbo.sp_new_encounter_log"
...
FUNCTION long sp_new_followup_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, real pr_duration_amount, string ps_duration_unit, string ps_duration_prn, string ps_treatment_goal, string ps_treatment_description) RPCFUNC ALIAS FOR "dbo.sp_new_followup_therapy"
FUNCTION long sp_new_history_questionnaire(string ps_cpr_id, long pl_encounter_id, string ps_administered_by, long pl_history_questionnaire_id, datetime pd_questionnaire_date, ref long pl_questionnaire_id) RPCFUNC ALIAS FOR "dbo.sp_new_history_questionnaire"
...
FUNCTION long sp_new_medication_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, string ps_drug_id, string ps_dosage_form, integer pi_administration_sequence, string ps_treatment_description) RPCFUNC ALIAS FOR "dbo.sp_new_medication_therapy"
...
FUNCTION long sp_new_procedure_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, string ps_procedure_id, string ps_treatment_description) RPCFUNC ALIAS FOR "dbo.sp_new_procedure_therapy"
FUNCTION long sp_new_referral_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, string ps_specialty_id, string ps_treatment_description) RPCFUNC ALIAS FOR "dbo.sp_new_referral_therapy"
FUNCTION long sp_new_test_therapy(string ps_user_id, string ps_assessment_id, string ps_treatment_type, string ps_observation_id, string ps_treatment_description, string ps_send_out_flag) RPCFUNC ALIAS FOR "dbo.sp_new_test_therapy"
...
FUNCTION long sp_order_child_test(string ps_cpr_id, long pl_treatment_id, long pl_encounter_id, string ps_observation_id, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_order_child_test"
...
FUNCTION long sp_order_recheck(string ps_cpr_id, long pl_encounter_id, string ps_ordered_by, string ps_ordered_for, string ps_service, string ps_description, ref long pl_encounter_log_id) RPCFUNC ALIAS FOR "dbo.sp_order_recheck"
FUNCTION long sp_order_service(string ps_cpr_id, long pl_encounter_id, string ps_ordered_by, string ps_service, string ps_room_id, string ps_status, ref long pl_encounter_log_id) RPCFUNC ALIAS FOR "dbo.sp_order_service"
FUNCTION long sp_order_service_for(string ps_cpr_id, long pl_encounter_id, string ps_ordered_by, string ps_service, string ps_room_id, string ps_status, string ps_description, string ps_ordered_for, ref long pl_encounter_log_id) RPCFUNC ALIAS FOR "dbo.sp_order_service_for"
FUNCTION long sp_order_service_param(string ps_cpr_id, long pl_encounter_id, string ps_ordered_by, string ps_service, string ps_room_id, string ps_status, string ps_service_param, ref long pl_encounter_log_id) RPCFUNC ALIAS FOR "dbo.sp_order_service_param"
...
FUNCTION long sp_order_test(string ps_cpr_id, long pl_encounter_id, long pl_problem_id, string ps_observation_id, string ps_send_out_flag, string ps_ordered_by, string ps_created_by, ref long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_order_test"
FUNCTION long sp_order_todo_service_enc(string ps_user_id, string ps_service, string ps_description, string ps_ordered_by, string ps_cpr_id, long pl_encounter_id, string ps_encounter_attribute, ref long pl_todo_item_id) RPCFUNC ALIAS FOR "dbo.sp_order_todo_service_enc"
FUNCTION long sp_order_todo_service_patient(string ps_user_id, string ps_service, string ps_ordered_by, string ps_cpr_id, string ps_todo_item, ref long pl_todo_item_id) RPCFUNC ALIAS FOR "dbo.sp_order_todo_service_patient"
...
FUNCTION long sp_overdue_vaccines() RPCFUNC ALIAS FOR "dbo.sp_overdue_vaccines"
...
FUNCTION long sp_queue_report(string ps_report_id, string ps_office_id, string ps_cpr_id, long pl_encounter_id, ref long pl_report_key) RPCFUNC ALIAS FOR "dbo.sp_queue_report"
FUNCTION long sp_queue_report_ready(string ps_report_id, ref long pl_report_key) RPCFUNC ALIAS FOR "dbo.sp_queue_report_ready"
FUNCTION long sp_queue_report_set_attribute(long pl_report_key, string ps_attribute, string ps_value) RPCFUNC ALIAS FOR "dbo.sp_queue_report_set_attribute"
FUNCTION long sp_queue_report_set_ready(long pl_report_key, string ps_report_status) RPCFUNC ALIAS FOR "dbo.sp_queue_report_set_ready"
FUNCTION long sp_queue_report_type(string ps_report_type, ref long pl_report_key) RPCFUNC ALIAS FOR "dbo.sp_queue_report_type"
FUNCTION long sp_recheck(string ps_cpr_id, long pl_encounter_id, string ps_treatment_type, datetime pdt_begin_date, string ps_ordered_by, string ps_created_by, ref long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_recheck"
FUNCTION long sp_reconcile_assessment_status() RPCFUNC ALIAS FOR "dbo.sp_reconcile_assessment_status"
FUNCTION long sp_reconcile_treatment_status() RPCFUNC ALIAS FOR "dbo.sp_reconcile_treatment_status"
...
FUNCTION long sp_reopen_encounter(string ps_cpr_id, long pl_encounter_id, ref string ps_room_id) RPCFUNC ALIAS FOR "dbo.sp_reopen_encounter"
...
FUNCTION long sp_room_patient_count(string ps_room_id, ref integer pi_patient_count) RPCFUNC ALIAS FOR "dbo.sp_room_patient_count"
...
FUNCTION long sp_set_cat_default_results(integer pi_exam_sequence, string ps_observation_type, string ps_observation_category_id, string ps_cpr_id, long pl_encounter_id, long pl_treatment_id, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_cat_default_results"
...
FUNCTION long sp_set_location(string ps_cpr_id, long pl_encounter_id, long pl_treatment_id, string ps_observation_id, integer pi_result_sequence, string ps_location, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_location"
...
FUNCTION long sp_set_obs_default_results(integer pi_exam_sequence, string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_encounter_id, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_obs_default_results"
FUNCTION long sp_set_obs_defaults(string ps_user_id, integer pi_exam_sequence, string ps_observation_id, string ps_cpr_id, long pl_treatment_id) RPCFUNC ALIAS FOR "dbo.sp_set_obs_defaults"
...
FUNCTION long sp_set_preferred_report(string ps_report_type, string ps_report_id) RPCFUNC ALIAS FOR "dbo.sp_set_preferred_report"
...
FUNCTION long sp_set_result(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, string ps_location, integer pi_result_sequence, long pl_encounter_id, long pl_attachment_id, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_result"
FUNCTION long sp_set_result_amount(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, integer pi_result_sequence, string ps_location, long pl_encounter_id, real pr_result_amount, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_result_amount"
...
FUNCTION long sp_set_service_status(string ps_cpr_id, long pl_encounter_id, long pl_encounter_log_id, string ps_accomplished_by, string ps_status) RPCFUNC ALIAS FOR "dbo.sp_set_service_status"
FUNCTION long sp_set_service_todo_item(string ps_cpr_id, long pl_encounter_id, long pl_encounter_log_id, string ps_user_id, long pl_todo_item_id) RPCFUNC ALIAS FOR "dbo.sp_set_service_todo_item"
FUNCTION long sp_set_test_attachment_id(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_attachment_id) RPCFUNC ALIAS FOR "dbo.sp_set_test_attachment_id"
FUNCTION long sp_set_test_collected(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, string ps_location, integer pi_result_sequence, long pl_encounter_id, datetime pdt_result_date_time, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_test_collected"
FUNCTION long sp_set_test_need_sample(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_encounter_id, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_test_need_sample"
FUNCTION long sp_set_test_not_collected(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_set_test_not_collected"
FUNCTION long sp_set_test_performed(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_encounter_id, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_test_performed"
FUNCTION long sp_set_test_send_out(string ps_cpr_id, long pl_treatment_id, string ps_observation_id, long pl_encounter_id, string ps_observed_by, string ps_created_by) RPCFUNC ALIAS FOR "dbo.sp_set_test_send_out"
...
FUNCTION long sp_start_service(string ps_cpr_id, long pl_encounter_id, long pl_encounter_log_id, string ps_user_id) RPCFUNC ALIAS FOR "dbo.sp_start_service"
FUNCTION long sp_stone_and_replicate(string ps_cpr_id, long pl_encounter_id) RPCFUNC ALIAS FOR "dbo.sp_stone_and_replicate"
FUNCTION long sp_synch_execute_database_script(string ps_script_name) RPCFUNC ALIAS FOR "dbo.sp_synch_execute_database_script"
FUNCTION long sp_synch_execute_database_script_charindex(string ps_search_string, long pl_script_id, long pl_start_location, ref long pl_found_location) RPCFUNC ALIAS FOR "dbo.sp_synch_execute_database_script_charindex"
FUNCTION long sp_table_update(string ps_table_name, string ps_updated_by) RPCFUNC ALIAS FOR "dbo.sp_table_update"
FUNCTION long sp_todo_rule_encounter_close(string ps_cpr_id, long pl_encounter_id, string ps_accomplished_by) RPCFUNC ALIAS FOR "dbo.sp_todo_rule_encounter_close"
FUNCTION long sp_todo_service(string ps_user_id, string ps_service, string ps_description, string ps_ordered_by, ref long pl_todo_item_id) RPCFUNC ALIAS FOR "dbo.sp_todo_service"
FUNCTION long sp_todo_service_set_attribute(string ps_user_id, long pl_todo_item_id, string ps_attribute, string ps_value) RPCFUNC ALIAS FOR "dbo.sp_todo_service_set_attribute"
FUNCTION long sp_todo_service_set_ready(string ps_user_id, long pl_todo_item_id, string ps_description) RPCFUNC ALIAS FOR "dbo.sp_todo_service_set_ready"
...
FUNCTION long sp_trigger_reports(string ps_cpr_id, long pl_encounter_id, string ps_event) RPCFUNC ALIAS FOR "dbo.sp_trigger_reports"
...
FUNCTION long sp_unset_cat(string ps_cpr_id, long pl_treatment_id, string ps_observation_type, string ps_observation_category_id) RPCFUNC ALIAS FOR "dbo.sp_unset_cat"
FUNCTION long sp_unset_discussed_by(string ps_cpr_id, long pl_encounter_id, string ps_stage_id) RPCFUNC ALIAS FOR "dbo.sp_unset_discussed_by"
FUNCTION long sp_unset_exam(string ps_cpr_id, long pl_treatment_id, string ps_observation_type, string ps_observation_category_id) RPCFUNC ALIAS FOR "dbo.sp_unset_exam"
FUNCTION long sp_unset_location(string ps_cpr_id, long pl_treatment_id, long pl_encounter_id, string ps_observation_id, string ps_location) RPCFUNC ALIAS FOR "dbo.sp_unset_location"
FUNCTION long sp_unset_observation(string ps_cpr_id, long pl_treatment_id, string ps_observation_id) RPCFUNC ALIAS FOR "dbo.sp_unset_observation"
FUNCTION long sp_unset_result(string ps_cpr_id, long pl_treatment_id, long pl_encounter_id, string ps_observation_id, integer pi_result_sequence) RPCFUNC ALIAS FOR "dbo.sp_unset_result"
...
FUNCTION long sp_update_assessment_def(string ps_assessment_id, string ps_icd_9_code, string ps_assessment_category_id, string ps_description, string ps_location_domain, string ps_auto_close, integer pi_auto_close_interval_amount, string ps_auto_close_interval_unit, long pl_risk_level, long pl_complexity, string ps_long_description) RPCFUNC ALIAS FOR "dbo.sp_update_assessment_def"
...
FUNCTION long sp_update_workplan_item(long pi_workplan_id, long pi_item_number, long pi_step_number, string ps_ordered_treatment_type, long pi_new_workplan_id, string ps_description, string ps_in_office_flag, long pi_sort_sequence) RPCFUNC ALIAS FOR "dbo.sp_update_workplan_item"
...
//if li_sts < 0 then
//	log.log(this, "set_server()", "Unable to connect to SQLDMO.SQLServer2 object (" + string(li_sts) + ").  Assuming both authentication modes are available.", 2)
...
PBDOM_ELEMENT lo_upgrade_scripts
...
// If no file was found see if there is already a material record for this mod level
if ll_material_id = 0 or isnull(ll_material_id) then
	...
	if ll_material_id = 0 or isnull(ll_material_id) then
		log.log(this, "upgrade_mod_level()", "No upgrade script found for mod level (" + string(ll_modification_level) + ")", 4)
		return -1
	end if
end if
...
if isnull(lbl_script) or len(lbl_script) <= 0 then
	log.log(this, "upgrade_mod_level()", "Empty upgrade script was found for mod level (" + string(ll_modification_level) + ")", 4)
	return -1
end if
...
TRY
	...
	lo_upgrade_scripts = lo_root.getchildelement("UpgradeScripts")
CATCH (throwable lo_error)
	log.log(this, "f_get_xml_document()", "Error reading XML schema data (" + lo_error.text + ")", 4)
	return -1
END TRY
...
lo_upgrade_scripts.GetChildElements(ref pbdom_element_array)
for i = 1 to UpperBound(pbdom_element_array)
	ls_element = pbdom_element_array[i].getname()
	ls_script = pbdom_element_array[i].gettext()
