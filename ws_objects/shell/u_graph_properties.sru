HA$PBExportHeader$u_graph_properties.sru
forward
...
if isnull(category_id) then
	log.log(this, "get_query", "category_id is null", 4)
	return ls_null
end if
...
if ll_row <= 0 then
	log.log(this, "get_query", "category_id not found (" + string(category_id) + ")", 4)
	return ls_null
end if
...
if sqlca.sqlcode = 100 then
	log.log(this, "load_graph()", "Graph not found (" + user_id + ", " + string(graph_id) + ")", 4)
	return -1
end if
...
if isnull(ll_data_id) then
	log.log(this, "get_query", "data_id is null", 4)
	return ls_null
end if
...
ll_row = data_items.find(ls_find, 1, data_items.rowcount())
if ll_row <= 0 then
	log.log(this, "get_query", "data item not found (" + string(ll_data_id) + ")", 4)
	return ls_null
end if
...
if li_sts <= 0 then
	log.log(this, "get_query()", "Error filtering restrictions", 4)
	return ls_null
end if
...
for i = 1 to ll_restriction_count
	...
	if li_sts <= 0 then
		log.log(this, "get_query()", "Error filtering restriction values", 4)
		return ls_null
	end if
...
if li_sts <= 0 then
	log.log(this, "load_graph()", "Error saving data series (" + user_id + ", " + string(graph_id) + ")", 4)
	return -1
end if
...
if li_sts <= 0 then
	log.log(this, "load_graph()", "Error saving restrictions (" + user_id + ", " + string(graph_id) + ")", 4)
	return -1
end if
...
if li_sts <= 0 then
	log.log(this, "load_graph()", "Error saving restriction values (" + user_id + ", " + string(graph_id) + ")", 4)
	return -1
end if
