HA$PBExportHeader$u_st_radio_test_yesno.sru
forward
global type u_st_radio_test_yesno from statictext
end type
end forward
...
u_st_radio_test_yesno last_button
end variables
...
global u_st_radio_test_yesno u_st_radio_test_yesno
...
public subroutine select_button ();backcolor = COLOR_DARK_GREY
borderstyle = stylelowered!
button_selected = true

if isvalid(last_button) and not isnull(last_button) then last_button.unselect_button()
last_button = this
