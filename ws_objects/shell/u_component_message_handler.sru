HA$PBExportHeader$u_component_message_handler.sru
forward
...
if isnull(message_id) then
	mylog.log(this, "handle_message()", "Null message_id", 4)
	return -1
end if

mylog.log(this, "handle_message()", "Handling Message (" + string(message_id) + ")", 2)
...
if cprdb.sqlcode = 100 then
	mylog.log(this, "handle_message()", "message_id not found (" + string(message_id) + ")", 4)
	return -1
end if
...
if li_sts <= 0 then
	mylog.log(this, "handle_message()", "Error Handling Message (" + string(message_id) + ")", 4)
	...
	mylog.log(this, "handle_message()", "Successfully Handled Message (" + string(message_id) + ")", 2)
	UPDATE o_Message_Log
	SET status = 'RECEIVED'
	WHERE message_id = :message_id
	USING cprdb;
...
if li_sts <= 0 then
	mylog.log(this, "get_message_file()", "Error writing message file", 4)
	return -1
end if
...
if not mydb.check() then
	mylog.log(this, "process_parts()", "Error Error checking p_Attachment_List records", 4)
	return -1
end if


for i = 1 to part_count
	mylog.log(this, "process_parts()", "Translating part(" + string(parts[i].message_part_sequence) + ", " + parts[i].part_table + ", " + parts[i].part_unique + ")", 1)
	if parts[i].part_type = "SPECIAL" then
		li_sts = do_special_part(parts[i])
		if li_sts < 0 then
			mylog.log(this, "process_parts()", "Error doing special part(" + string(parts[i].message_part_sequence) + ", " + parts[i].part_table + ")", 4)
			return -1
		end if
	elseif parts[i].part_unique = "X" then
		li_sts = translate_x_part(parts[i])
		if li_sts < 0 then
			mylog.log(this, "process_parts()", "Error translating x part(" + string(parts[i].message_part_sequence) + ", " + parts[i].part_table + ")", 4)
			return -1
		end if
	elseif parts[i].part_unique = "C" then
		li_sts = translate_c_part(parts[i])
		if li_sts < 0 then
			mylog.log(this, "process_parts()", "Error translating C part(" + string(parts[i].message_part_sequence) + ", " + parts[i].part_table + ")", 4)
			return -1
		end if
	else
		li_sts = translate_and_save_part(parts[i])
		if li_sts < 0 then
			mylog.log(this, "process_parts()", "Error translating fkeys for part(" + string(parts[i].message_part_sequence) + ", " + parts[i].part_table + ")", 4)
			return -1
		end if
	end if
next
...
for i = 1 to part_count
	...
	if ll_rows < 0 then
		mylog.log(this, "altkey_where_clause()", "error getting altkeys", 4)
		return -1
...
if ll_rows < 0 then
	mylog.log(this, "translate_and_save_part()", "Error loading message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
	...
	for i = pstr_part.fkey_count to 1 step -1
		...
		if not lb_xlate_where then
			...
			if lower(pstr_part.fkey[i].target_table) = "p_patient_encounter" then
				if not isnull(message_cpr_id) and not isnull(message_encounter_id) then
					...
					mylog.log(this, "translate_and_save_part()", "Invalid p_Patient_Encounter foreign key", 4)
					return -1
				end if
			else
				continue
		...
		CHOOSE CASE pstr_part.fkey[i].target_location
			CASE "DATABASE"
				...
				if li_sts < 0 then
					mylog.log(this, "translate_and_save_part()", "Error executing lookup query (" + ls_cpr_query + ")", 4)
					return -1
				end if
			CASE ELSE
				...
				if lower(pstr_part.part_table) = lower(pstr_part.fkey[i].target_table) then
					...
					if li_sts < 0 then
						mylog.log(this, "translate_and_save_part()", "Error finding key in message data (" + ls_msg_query + ")", 4)
						return -1
					end if
				else
					...
					if li_sts < 0 then
						mylog.log(this, "translate_and_save_part()", "Error executing lookup query (" + ls_msg_query + ")", 4)
						return -1
					end if
				end if
				if li_sts = 0 then
		...
		if li_sts = 0 then
			...
			if lower(left(pstr_part.fkey[i].target_table, 2)) = "p_" then
				...
				mylog.log(this, "translate_and_save_part()", "P data not found.  Requesting chart refresh. (" + ls_cpr_query + ")", 2)
//				order_chart_refresh()
			...
			elseif lower(left(pstr_part.fkey[i].target_table, 2)) = "c_" then
				...
				if li_sts < 0 then
					mylog.log(this, "translate_and_save_part()", "Error adding missing data (" + pstr_part.fkey[i].target_table + ")", 4)
					return -1
				end if
			end if
		elseif li_sts > 1 then
			// too many keys found
			mylog.log(this, "translate_and_save_part()", "Foreign key lookup found multiple records (" + ls_cpr_query + ")", 1)
		end if
	...
	if lower(pstr_part.part_table) = "p_patient" then
		...
		if not isnull(ls_billing_id) then
			...
			if cprdb.sqlcode = 100 then
				...
				if li_sts < 0 then
					mylog.log(this, "translate_and_save_part()", "Error adding patient record to database (" + ls_cpr_id + ")", 4)
					return -1
				end if
			...
			mylog.log(this, "translate_and_save_part()", "Billing_id is null.  This patient cannot be replicated", 4)
			return -1
		end if
	else
		...
		if li_sts < 0 then
			mylog.log(this, "translate_and_save_part()", "Error checking unique record (" + pstr_part.part_table + ")", 4)
			return -1
		elseif li_sts > 0 then
			...
			li_sts = luo_data.save_to_table(pstr_part.part_table, j)
			if li_sts < 0 then
				mylog.log(this, "translate_and_save_part()", "Error saving message records (" + pstr_part.part_table + ")", 4)
				return -1
			else
...
if li_sts < 0 then
	mylog.log(this, "translate_and_save_part()", "Error replacing message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
ll_rows = luo_data.load_query("select * from " + pstr_part.part_table)
if ll_rows < 0 then
	mylog.log(this, "translate_x_part()", "Error loading message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
for i = 1 to ll_rows
	...
	if isnull(ls_where_clause) then
		mylog.log(this, "translate_x_part()", "Unable to get where_clause", 3)
		continue
	end if
	...
	if li_sts < 0 then
		// Error
		mylog.log(this, "translate_x_part()", "Error executing lookup query (" + ls_query + ")", 4)
		return -1
	elseif li_sts = 0 then
		// If foreign key lookup fails and it should have found a "c_" table then we have
		// missing data in this database.  Attempt to add the data from the message.
		...
		if li_sts < 0 then
			mylog.log(this, "translate_x_part()", "Error adding missing data (" + pstr_part.part_table + ")", 4)
			return -1
		end if
	elseif li_sts > 1 then
		// too many keys found
		mylog.log(this, "translate_x_part()", "Primary key lookup found multiple records (" + ls_query + ")", 1)
	end if
...
if pi_fkey <= 0 then
	mylog.log(this, "add_missing_data()", "Invalid fkey index", 4)
	return -1
else
...
if li_sts < 0 then
	mylog.log(this, "add_missing_data()", "Error creating empty datastore", 4)
	return -1
end if
...
if li_sts < 0 then
	mylog.log(this, "add_missing_data()", "Error generating new primary keys (" + pstr_part.fkey[pi_fkey].target_table + ")", 4)
	return -1
end if

li_sts = luo_data.save_to_table(pstr_part.fkey[pi_fkey].target_table, false)
if li_sts < 0 then
	mylog.log(this, "add_missing_data()", "Error saving message records (" + pstr_part.fkey[pi_fkey].target_table + ")", 4)
	return -1
end if
...
if Len(ls_error_create) > 0 THEN
	mydb.mylog.log(this, "add_missing_x_data()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
if li_sts < 0 then
	mylog.log(this, "add_missing_x_data()", "Error saving message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
ll_rows = luo_data.load_query("select * from " + pstr_part.part_table)
if ll_rows < 0 then
	mylog.log(this, "translate_c_part()", "Error loading message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
for i = 1 to ll_rows
	...
	if li_sts < 0 then
		// Error
		mylog.log(this, "translate_c_part()", "Error executing lookup query (" + ls_query + ")", 4)
		return -1
	elseif li_sts = 0 then
		// If foreign key lookup fails and it should have found a "c_" table then we have
		// missing data in this database.  Attempt to add the data from the message.
		...
		if li_sts < 0 then
			mylog.log(this, "translate_c_part()", "Error adding missing data (" + pstr_part.part_table + ")", 4)
			return -1
		end if
	elseif li_sts > 1 then
		// too many keys found
		mylog.log(this, "translate_c_part()", "Foreign key lookup found multiple records (" + ls_query + ")", 1)
	end if
...
li_sts = luo_data.replace_table(pstr_part.part_table)
if li_sts < 0 then
	mylog.log(this, "translate_c_part()", "Error saving message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
luo_data.create(ls_syntax, ls_error_create)
if Len(ls_error_create) > 0 THEN
	mydb.mylog.log(this, "add_missing_c_data()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
if li_sts < 0 then
	mylog.log(this, "add_missing_c_data()", "Error generating new primary keys (" + pstr_part.part_table + ")", 4)
	return -1
end if

li_sts = luo_data.save_to_table(pstr_part.part_table, false)
if li_sts < 0 then
	mylog.log(this, "add_missing_c_data()", "Error saving message records (" + pstr_part.part_table + ")", 4)
	return -1
end if
...
elseif ll_rows = 0 then
	mylog.log(this, "altkey_where_clause()", "c_Table_Altkey record not found (" + ps_table + ")", 4)
	setnull(ls_where_clause)
	return ls_where_clause
end if
...
if not isnull(ls_primary_key1) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key1 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
	ls_where_clause += "WHERE " + ls_primary_key1 + " = " + ls_item
else
	mylog.log(this, "altkey_where_clause()", "First primary_key is null", 4)
	setnull(ls_where_clause)
	return ls_where_clause
end if
...
if not isnull(ls_primary_key2) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key2 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
...
if not isnull(ls_primary_key3) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key3 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
...
if not isnull(ls_primary_key4) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key4 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
...
if not isnull(ls_primary_key5) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key5 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
...
if not isnull(ls_primary_key6) then
	...
	if isnull(ls_item) then
		mylog.log(this, "prikey_where_clause()", "Null primary key field (" + ps_table + ", " + ls_primary_key6 + ")", 4)
		setnull(ls_where_clause)
		return ls_where_clause
	end if
...
CHOOSE CASE pstr_part.part_table
	CASE "Attachment_Files"
		...
		if li_sts < 0 then
			mylog.log(this, "do_special_part()", "Error getting attachment files", 4)
			return -1
		end if
...
luo_message.connected = true
	...
	mylog.log(this, "save_attachment_files()", "Error connecting to message database (" + luo_message.sqlerrtext + ")", 4)
	return -1
end if
////////////////////////////////////////////////////////////////////////////////////////////////
...
if not isnull(ls_alt_key1) then
	...
	mylog.log(this, "altkey_where_clause()", "First alt_key is null", 4)
	setnull(ls_where_clause)
	return ls_where_clause
end if
