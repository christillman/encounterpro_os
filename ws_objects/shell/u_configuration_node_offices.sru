HA$PBExportHeader$u_configuration_node_offices.sru
forward
global type u_configuration_node_offices from u_configuration_node_base
end type
end forward

global type u_configuration_node_offices from u_configuration_node_base
end type
global u_configuration_node_offices u_configuration_node_offices
...
for i = 1 to ll_count
	...
	lstr_nodes.node[lstr_nodes.node_count].class = "u_configuration_node_office"
	lstr_nodes.node[lstr_nodes.node_count].key = luo_data.object.office_id[i]
	lstr_nodes.node[lstr_nodes.node_count].button = "button_office.gif"
next
...
on u_configuration_node_offices.create
call super::create
end on

on u_configuration_node_offices.destroy
call super::destroy
end on
