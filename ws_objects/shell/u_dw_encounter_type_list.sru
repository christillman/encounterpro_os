HA$PBExportHeader$u_dw_encounter_type_list.sru
forward
...
CHOOSE CASE buttons[button_pressed]
	...
	CASE "SORT"
		...
		search()
	CASE "EDIT"
		current_service.add_attribute("encounter_type", ls_encounter_type)
		openwithparm(w_svc_config_encounter_type, current_service)
//		refresh()
	CASE "DELETE"
