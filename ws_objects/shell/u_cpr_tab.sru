HA$PBExportHeader$u_cpr_tab.sru
forward
...
log.log(this, "windowposchanging()", string(pl_x) + ", " + string(pl_y) + ", " + string(pl_width) + ", " + string(pl_height) + ", " + string(pl_flags), 2)
...
log.log(this, "initialize()", "calling get_section_list()", 1)
li_sts = get_section_list()
if li_sts <= 0 then return li_sts

log.log(this, "initialize()", "calling open_section_pages()", 1)
...
for i = 1 to section_count
	...
	if section[i].page_count = 1 then
		...
		CATCH (throwable lt_error)
			...
			log.log(this, "open_section_pages()", ls_text, 4)
...
log.log(this, "open_section_pages()", "Finished opening sections", 1)
