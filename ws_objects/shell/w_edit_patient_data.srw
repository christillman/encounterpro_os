HA$PBExportHeader$w_edit_patient_data.srw
forward
...
type st_birthdate from statictext within w_edit_patient_data
end type
...
type st_1 from statictext within w_edit_patient_data
end type
...
type st_9 from statictext within w_edit_patient_data
end type
type st_7 from statictext within w_edit_patient_data
end type
type st_6 from statictext within w_edit_patient_data
end type
...
this.Control[iCurrent+40]=this.sle_maiden_name
this.Control[iCurrent+41]=this.st_maiden_name_title
this.Control[iCurrent+42]=this.cbx_test_patient
end on
...
uo_cb_sex.set_sex(new_patient.sex)
