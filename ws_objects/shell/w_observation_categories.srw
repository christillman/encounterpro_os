HA$PBExportHeader$w_observation_categories.srw
forward
...
if ll_rows < 0 then
	log.log(this, "open", "Error getting all categories", 4)
	close(this)
	return
end if
...
if ll_rows < 0 then
	log.log(this, "open", "Error getting observation categories", 4)
	close(this)
	return
end if
