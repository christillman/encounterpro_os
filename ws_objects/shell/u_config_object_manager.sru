HA$PBExportHeader$u_config_object_manager.sru
forward
...
if li_sts <> 0 then
	log.log(this, "initialize_com()", "Error connecting to com source (" + ls_com_class + ", " + string(li_sts) + ")", 4)
	return -1
end if
...
CATCH (throwable lt_error)
	log.log(this, "initialize_com()", "Error calling Initialize (" + lt_error.text + ")", 4)
	return -1
END TRY
