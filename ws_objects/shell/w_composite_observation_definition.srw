HA$PBExportHeader$w_composite_observation_definition.srw
forward
...
if not isnull(ls_collection_procedure_id) then
	...
	if li_sts = 0 then
		log.log(this, "load_observation()", "Invalid collection procedure id (" + ps_observation_id + &
...
if not isnull(ls_perform_procedure_id) then
	...
	if li_sts < 0 then return li_sts
	if li_sts = 0 then
		log.log(this, "load_observation()", "Invalid perform procedure id (" + ps_observation_id + &
