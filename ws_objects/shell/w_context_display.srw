HA$PBExportHeader$w_context_display.srw
forward
...
type cb_libraries from commandbutton within w_context_display
end type
end forward
...
this.cb_libraries=create cb_libraries
...
this.Control[iCurrent+49]=this.cb_libraries
end on
...
event clicked;str_pblibraries lstr_pblibraries
str_popup popup
str_popup_return popup_return
long i
...
popup.title = "Installed PowerBuilder Libraries"
popup.display_only = true
popup.add_blank_row = true
popup.blank_text = "Application Libaries"
