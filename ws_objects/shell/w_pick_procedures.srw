HA$PBExportHeader$w_pick_procedures.srw
forward
global type w_pick_procedures from w_window_base
end type
type st_search_title from statictext within w_pick_procedures
end type
type st_procedure_type_title from statictext within w_pick_procedures
end type
type st_procedure_type from statictext within w_pick_procedures
end type
type pb_down_sel from u_picture_button within w_pick_procedures
end type
type pb_up_sel from u_picture_button within w_pick_procedures
end type
type st_page_sel from statictext within w_pick_procedures
end type
type pb_up from u_picture_button within w_pick_procedures
end type
type pb_down from u_picture_button within w_pick_procedures
end type
type st_page from statictext within w_pick_procedures
end type
type st_category from statictext within w_pick_procedures
end type
type st_top_20 from statictext within w_pick_procedures
end type
type st_cpt_code from statictext within w_pick_procedures
end type
type st_search_status from statictext within w_pick_procedures
end type
type st_specialty from statictext within w_pick_procedures
end type
type st_specialty_title from statictext within w_pick_procedures
end type
type st_title from statictext within w_pick_procedures
end type
type st_selected_items_title from statictext within w_pick_procedures
end type
type st_description from statictext within w_pick_procedures
end type
type st_common_flag from statictext within w_pick_procedures
end type
type dw_procedures from u_dw_procedure_list within w_pick_procedures
end type
type dw_selected_items from u_dw_pick_list within w_pick_procedures
end type
type cb_ok from commandbutton within w_pick_procedures
end type
type cb_new_procedure from commandbutton within w_pick_procedures
end type
type cb_cancel from commandbutton within w_pick_procedures
end type
end forward
...
st_title st_title
st_selected_items_title st_selected_items_title
...
global w_pick_procedures w_pick_procedures
...
if not multiselect then dw_selected_items.reset()
...
dw_procedures.multiselect = popup.multiselect
...
if not multiselect then
	...
	st_selected_items_title.visible = false
	pb_up_sel.visible = false
	pb_down_sel.visible = false
	st_page_sel.visible = false
end if
...
this.st_selected_items_title=create st_selected_items_title
...
this.Control[iCurrent+17]=this.st_selected_items_title
this.Control[iCurrent+18]=this.st_description
this.Control[iCurrent+19]=this.st_common_flag
this.Control[iCurrent+20]=this.dw_procedures
this.Control[iCurrent+21]=this.dw_selected_items
this.Control[iCurrent+22]=this.cb_ok
this.Control[iCurrent+23]=this.cb_new_procedure
this.Control[iCurrent+24]=this.cb_cancel
end on

on w_pick_procedures.destroy
call super::destroy
...
destroy(this.st_selected_items_title)
...
event post_click;call super::post_click;If clicked_row <= 0 Then Return
