HA$PBExportHeader$u_ds_data.sru
forward
...
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "save_query_to_file()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
if Len(ls_error_create) > 0 THEN
	log.log(this, "save_query_to_file()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
li_sts = retrieve()
if li_sts < 0 then
	log.log(this, "save_query_to_file()", "Error executing query (" + ps_query + ")", 4)
	return li_sts
end if
...
if li_sts > 0 then
	log.log(this, "save_query_to_file()", "Query data saved to file (" + ps_query + ", " + ps_file + ")", 1)
else
	log.log(this, "save_query_to_file()", "Error saving query to file (" + ps_query + ", " + ps_file + ")", 4)
end if
...
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "save_table_to_file()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
else
	// Create the datastore with the wildcard
	Create(ls_new_syntax, ls_error_create)
	if Len(ls_error_create) > 0 THEN
		log.log(this, "save_table_to_file()", "Error creating datastore (" + ls_error_create + ")", 4)
		return -1
	end if
	...
	ls_new_syntax = sqlca.SyntaxFromSQL(ls_query, "", ls_error_syntaxfromSQL)
	if Len(ls_error_syntaxfromSQL) > 0 THEN
		log.log(this, "save_table_to_file()", "Error getting new query syntax (" + ls_error_syntaxfromSQL + ")", 4)
		return -1
	else
		// Now recreate then datastore and retrieve the data
		Create(ls_new_syntax, ls_error_create)
		if Len(ls_error_create) > 0 THEN
			log.log(this, "save_table_to_file()", "Error creating new datastore (" + ls_error_create + ")", 4)
			return -1
		end if
		li_sts = settransobject(mydb)
		ls_sql = getsqlselect()
		li_sts = retrieve()
		if li_sts < 0 then
			log.log(this, "save_table_to_file()", "Error executing query (" + ls_query + ")", 4)
			return li_sts
		end if
		...
		li_sts = saveas(ps_file, text!, false)
		if li_sts > 0 then
			log.log(this, "save_table_to_file()", "Table data saved to file (" + ps_table + ", " + ps_file + ")", 1)
		else
			log.log(this, "save_table_to_file()", "Error saving table to file (" + ps_table + ", " + ps_file + ")", 4)
		end if
	end if
end if
...
if li_sts <= 0 then
	log.log(this, "save_to_file()", "Error saving to file (" + ps_file + ")", 4)
end if
...
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "save_table_to_table()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
else
	// Create the datastore with the wildcard
	Create(ls_new_syntax, ls_error_create)
	if Len(ls_error_create) > 0 THEN
		log.log(this, "save_table_to_table()", "Error creating datastore (" + ls_error_create + ")", 4)
		return -1
	end if
	...
	ls_new_syntax = sqlca.SyntaxFromSQL(ls_query, "", ls_error_syntaxfromSQL)
	if Len(ls_error_syntaxfromSQL) > 0 THEN
		log.log(this, "save_table_to_table()", "Error getting new query syntax (" + ls_error_syntaxfromSQL + ")", 4)
		return -1
	else
		// Now recreate then datastore and retrieve the data
		Create(ls_new_syntax, ls_error_create)
		if Len(ls_error_create) > 0 THEN
			log.log(this, "save_table_to_table()", "Error creating new datastore (" + ls_error_create + ")", 4)
			return -1
		end if
		li_sts = settransobject(mydb)
		ls_sql = getsqlselect()
		ll_rows = retrieve()
		if ll_rows < 0 then
			log.log(this, "save_table_to_table()", "Error executing query (" + ls_query + ")", 4)
			return li_sts
		end if
		...
		li_sts = update()
		if li_sts < 0 then
			log.log(this, "save_table_to_table()", "Error saving table", 4)
			return -1
		end if
	end if
end if
...
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "save_query_to_table()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
Create(ls_new_syntax, ls_error_create)
if Len(ls_error_create) > 0 THEN
	log.log(this, "save_query_to_table()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
li_sts = retrieve()
if li_sts < 0 then
	log.log(this, "save_query_to_table()", "Error executing query (" + ps_query + ")", 4)
	return li_sts
end if
...
li_sts = update()
if li_sts < 0 then
	log.log(this, "save_table_to_table()", "Error saving query to table", 4)
end if
...
li_sts = retrieve()
if li_sts < 0 then
	log.log(this, "save_query_to_file()", "Error executing query (" + ls_sql + ")", 4)
	return li_sts
end if
...
li_sts = saveas(ps_file, text!, false)
if li_sts > 0 then
	log.log(this, "save_query_to_file()", "Query data saved to file (" + ls_sql + ", " + ps_file + ")", 1)
else
	log.log(this, "save_query_to_file()", "Error saving query to file (" + ls_sql + ", " + ps_file + ")", 4)
end if
...
li_sts = update()
if li_sts <= 0 then
	log.log(this, "save_table_to_file()", "Error saving query to table (" + ls_sql + ", " + ps_table + ")", 4)
end if
...
if li_sts <= 0 then
	log.log(this, "save_to_table()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
if Len(ls_error_create) > 0 THEN
	log.log(this, "save_to_table()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
li_sts = update()
if li_sts <= 0 then
	log.log(this, "save_to_table()", "Error saving data to table", 4)
	return -1
end if
...
// Now get the 
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "delete_record()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
luo_tabledef.Create(ls_new_syntax, ls_error_create)
if Len(ls_error_create) > 0 THEN
	log.log(this, "delete_record()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
if not isnull(ls_where) and trim(ls_where) <> "" then
	...
	if li_sts < 0 then return -1
	if li_sts = 0 then
		log.log(this, "delete_record()", "No record found (" + ls_query + ")", 3)
	end if
end if
...
CHOOSE CASE lower(ps_table)
	CASE "c_assessment_definition"
		...
		if isnull(ls_newkey) then
			log.log(this, "generate_new_keys()", "Error generating new key (" + ps_table + ")", 4)
			return -1
		end if
...
li_sts = sqlca.get_dw_syntax(ls_query, ls_new_syntax)
if li_sts <= 0 then
	log.log(this, "save_to_table()", "Error getting query syntax (" + sqlca.dbms + ", " + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
if not isnull(ls_identity_column) then
	...
	li_sts = luo_data.load_query(ls_query)
	if li_sts <= 0 then
		log.log(this, "save_to_table()", "Error getting identity column value", 4)
		return -1
	end if
...
if not sqlca.check() then
	log.log(this, "load_table_from_file()", "Error getting count " + ps_table,  4)
	return -1
end if
...
if Len(ls_error_syntaxfromSQL) > 0 THEN
	log.log(this, "load_table_from_file()", "Error getting query syntax (" + ls_error_syntaxfromSQL + ")", 4)
	return -1
else
	// Create the datastore with the wildcard
	Create(ls_new_syntax, ls_error_create)
	if Len(ls_error_create) > 0 THEN
		log.log(this, "load_table_from_file()", "Error with create the datastore (" + ls_error_create + ")", 4)
		return -1
	end if
	...
	if Len(ls_error_syntaxfromSQL) > 0 THEN
		...
		next
		importfile(ps_file)
		log.log(this, "load_table_from_file()", string(rowcount()) + ps_file, 4)
		settransobject(mydb)
		if lb_identity then
			ls_sql = "SET IDENTITY_INSERT " + ps_table + " ON"
			li_sts = sqlca.execute_string(ls_sql)
			if li_sts <= 0 then
				log.log(this, "load_table_from_file()", "Error with set_identity_insert " + ps_file, 4)
				return li_sts
			end if
		end if
		...
		if pb_delete_first then
			...
			li_sts = sqlca.execute_string(ls_sql)
			if li_sts <= 0 then
				log.log(this, "load_table_from_file()","Delete First error " + ps_file, 4)
				return li_sts
			end if
		end if
		...
		li_sts = update()
		if li_sts <= 0 then
			log.log(this, "load_table_from_file()", "Update Error " + ps_file, 4)
		end if
...
if li_sts <= 0 then
	...
	log.log(this, "load_query()", "Error getting query syntax (" + sqlca.dbms + ", " + ls_error_syntaxfromSQL + ")", 4)
	return -1
end if
...
if Len(ls_error_create) > 0 THEN
	...
	log.log(this, "load_query()", "Error creating datastore (" + ls_error_create + ")", 4)
	return -1
end if
...
ll_rows = retrieve()
if ll_rows < 0 then
	log.log(this, "load_query()", "Error executing query (" + ps_query + ", " + sqlca.sqlerrtext + ")", 4)
	return ll_rows
end if
...
CATCH (PBDOM_EXCEPTION pbdom_except)
	log.log(this, "add_document_to_componentdata()", "XML Error: " + string(pbdom_except.GetExceptionCode()) + "~r~nText : " + pbdom_except.Text, 4)
	return -1
CATCH (throwable lo_error)
	log.log(this, "add_document_to_componentdata()", "XML Error: " + lo_error.Text, 4)
	return -1
end try
