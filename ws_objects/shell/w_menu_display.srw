HA$PBExportHeader$w_menu_display.srw
forward
...
if ll_rows < 0 then
	log.log(this, "initialize()", "Error retrieving workplans (" + id + ")", 4)
	return -1
elseif ll_rows = 0 then	
	log.log(this, "initialize()", "No menus found (" + id + ")", 4)
	return -1
end if
...
if sqlca.sqlcode = 100 then
	log.log(this, "open", "menu_id not found (" + string(ll_menu_id) + ")", 4)
	return
end if
