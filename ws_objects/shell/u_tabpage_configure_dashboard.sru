HA$PBExportHeader$u_tabpage_configure_dashboard.sru
forward
global type u_tabpage_configure_dashboard from u_tabpage
end type
type st_prop_2_height_percent from statictext within u_tabpage_configure_dashboard
end type
type st_prop_1_height_percent from statictext within u_tabpage_configure_dashboard
end type
type st_prop_1_min_height from statictext within u_tabpage_configure_dashboard
end type
type st_prop_2_height_percent_title from statictext within u_tabpage_configure_dashboard
end type
type st_prop_1_height_percent_title from statictext within u_tabpage_configure_dashboard
end type
type st_prop_1_min_height_title from statictext within u_tabpage_configure_dashboard
end type
type st_5 from statictext within u_tabpage_configure_dashboard
end type
type st_properties_width from statictext within u_tabpage_configure_dashboard
end type
type st_properties_width_title from statictext within u_tabpage_configure_dashboard
end type
type st_header_height_title from statictext within u_tabpage_configure_dashboard
end type
type st_header_height from statictext within u_tabpage_configure_dashboard
end type
type cb_clear_prop_3 from commandbutton within u_tabpage_configure_dashboard
end type
type cb_config_prop_3 from commandbutton within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_3_title from statictext within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_3 from statictext within u_tabpage_configure_dashboard
end type
type cb_clear_prop_2 from commandbutton within u_tabpage_configure_dashboard
end type
type cb_config_prop_2 from commandbutton within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_2_title from statictext within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_2 from statictext within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_1 from statictext within u_tabpage_configure_dashboard
end type
type st_prop_datawindow_1_title from statictext within u_tabpage_configure_dashboard
end type
type cb_config_prop_1 from commandbutton within u_tabpage_configure_dashboard
end type
type cb_clear_prop_1 from commandbutton within u_tabpage_configure_dashboard
end type
type st_body_datawindow from statictext within u_tabpage_configure_dashboard
end type
type st_body_datawindow_title from statictext within u_tabpage_configure_dashboard
end type
type cb_config_body from commandbutton within u_tabpage_configure_dashboard
end type
type cb_clear_body from commandbutton within u_tabpage_configure_dashboard
end type
type st_1 from statictext within u_tabpage_configure_dashboard
end type
type cb_clear_header from commandbutton within u_tabpage_configure_dashboard
end type
type cb_config_header from commandbutton within u_tabpage_configure_dashboard
end type
type st_header_datawindow_title from statictext within u_tabpage_configure_dashboard
end type
type st_header_datawindow from statictext within u_tabpage_configure_dashboard
end type
end forward
...
global u_tabpage_configure_dashboard u_tabpage_configure_dashboard
...
public function integer initialize (string ps_key);dashboard_preference_key = ps_key  // context_object_type
...
on u_tabpage_configure_dashboard.create
int iCurrent
call super::create
...
on u_tabpage_configure_dashboard.destroy
call super::destroy
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_2_datawindow_height_percent_preference_id, string(prop2_height_percent))
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_1_datawindow_height_percent_preference_id, string(prop1_height_percent))
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_1_datawindow_min_height_preference_id, string(prop1_min_height))
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, properties_datawindow_width_preference_id, string(prop_width))
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, header_datawindow_height_preference_id, string(header_height))
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_3_datawindow_preference_id, prop_3_datawindow)
if not tf_check() then return
...
long i
string ls_dashboard_preference_key
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_2_datawindow_preference_id, prop_2_datawindow)
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, prop_1_datawindow_preference_id, prop_1_datawindow)
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, body_datawindow_preference_id, body_datawindow)
if not tf_check() then return
...
sqlca.sp_set_preference(dashboard_preference_type, dashboard_preference_level, dashboard_preference_key, header_datawindow_preference_id, header_datawindow)
if not tf_check() then return
