HA$PBExportHeader$u_st_radio_multby_yesno.sru
forward
global type u_st_radio_multby_yesno from statictext
end type
end forward
...
u_st_radio_multby_yesno last_button
end variables
...
global u_st_radio_multby_yesno u_st_radio_multby_yesno
