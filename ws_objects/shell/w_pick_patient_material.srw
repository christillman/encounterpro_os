HA$PBExportHeader$w_pick_patient_material.srw
forward
global type w_pick_patient_material from w_window_base
end type
type st_search_title from statictext within w_pick_patient_material
end type
type pb_up from u_picture_button within w_pick_patient_material
end type
type pb_down from u_picture_button within w_pick_patient_material
end type
type st_page from statictext within w_pick_patient_material
end type
type st_category from statictext within w_pick_patient_material
end type
type st_top_20 from statictext within w_pick_patient_material
end type
type st_search_status from statictext within w_pick_patient_material
end type
type st_specialty from statictext within w_pick_patient_material
end type
type st_specialty_title from statictext within w_pick_patient_material
end type
type st_title from statictext within w_pick_patient_material
end type
type st_description from statictext within w_pick_patient_material
end type
type st_common_flag from statictext within w_pick_patient_material
end type
type dw_materials from u_dw_patient_materials_list within w_pick_patient_material
end type
type cb_new_material from commandbutton within w_pick_patient_material
end type
type cb_cancel from commandbutton within w_pick_patient_material
end type
end forward
...
global w_pick_patient_material w_pick_patient_material
...
on w_pick_patient_material.create
int iCurrent
call super::create
...
this.Control[iCurrent+13]=this.dw_materials
this.Control[iCurrent+14]=this.cb_new_material
this.Control[iCurrent+15]=this.cb_cancel
end on

on w_pick_patient_material.destroy
call super::destroy
...
type pb_epro_help from w_window_base`pb_epro_help within w_pick_patient_material
integer y = 136
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_pick_patient_material
end type
...
event selected;call super::selected;long ll_material_id

if lasttype <> 'compute' then
	ll_material_id = object.material_id[selected_row]
