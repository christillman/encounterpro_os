HA$PBExportHeader$u_configuration_node_document_purpose_context.sru
forward
global type u_configuration_node_document_purpose_context from u_configuration_node_base
end type
end forward

global type u_configuration_node_document_purpose_context from u_configuration_node_base
end type
global u_configuration_node_document_purpose_context u_configuration_node_document_purpose_context
...
on u_configuration_node_document_purpose_context.create
call super::create
end on

on u_configuration_node_document_purpose_context.destroy
call super::destroy
end on
