HA$PBExportHeader$w_patient_relation_edit.srw
forward
global type w_patient_relation_edit from window
end type
type cb_1 from commandbutton within w_patient_relation_edit
end type
type st_2 from statictext within w_patient_relation_edit
end type
type sle_url from singlelineedit within w_patient_relation_edit
end type
type st_1 from statictext within w_patient_relation_edit
end type
type cb_cancel from commandbutton within w_patient_relation_edit
end type
type cb_finished from commandbutton within w_patient_relation_edit
end type
type st_category from statictext within w_patient_relation_edit
end type
type st_category_title from statictext within w_patient_relation_edit
end type
type sle_title from singlelineedit within w_patient_relation_edit
end type
type st_title_title from statictext within w_patient_relation_edit
end type
end forward
...
global w_patient_relation_edit w_patient_relation_edit
...
on w_patient_relation_edit.create
...
on w_patient_relation_edit.destroy
destroy(this.cb_1)
destroy(this.st_2)
