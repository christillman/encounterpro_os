HA$PBExportHeader$w_svc_imm_record.srw
forward
...
if dw_vaccine_history.width > 3600 then
	dw_vaccine_history.object.treatment_description.width = long((dw_vaccine_history.width - 1530) * 0.3226 )
	dw_vaccine_history.object.location_description.width = long((dw_vaccine_history.width - 1530) * 0.2258 )
	dw_vaccine_history.object.maker_name.width = long((dw_vaccine_history.width - 1530) * 0.2258 )
	dw_vaccine_history.object.compute_where.width = long((dw_vaccine_history.width - 1530) * 0.2258 )
end if
/////////////////////////////////////////////////////////
