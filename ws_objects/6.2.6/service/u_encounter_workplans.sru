HA$PBExportHeader$u_encounter_workplans.sru
forward
global type u_encounter_workplans from u_tabpage
end type
type tab_workplans from u_tab_workplan_display within u_encounter_workplans
end type
type tab_workplans from u_tab_workplan_display within u_encounter_workplans
end type
type st_no_workplans from statictext within u_encounter_workplans
end type
end forward
...
global u_encounter_workplans u_encounter_workplans
...
public function integer initialize (long pl_encounter_id)
...
public function integer initialize (long pl_encounter_id);integer li_sts
...
li_sts = current_patient.encounters.encounter(encounter, pl_encounter_id)
if li_sts <= 0 then return -1

return tab_workplans.initialize( 'Encounter', pl_encounter_id)
...
if first_time then
	li_sts = tab_workplans.initialize('Encounter', parent_tab.service.encounter_id)
	first_time = false
end if
...
on u_encounter_workplans.create
int iCurrent
call super::create
...
on u_encounter_workplans.destroy
call super::destroy
