HA$PBExportHeader$w_edit_consultant.srw
forward
...
if li_sts < 0 then
	log.log(this,"open","Error loading consultant (" + consultant_id + ")", 4)
	closewithreturn(this, lstr_consultant)
	Return
elseif li_sts = 0 then
	log.log(this,"open","Consultant not found (" + consultant_id + ")", 4)
	closewithreturn(this, lstr_consultant)
	Return
end if
