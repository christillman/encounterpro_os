HA$PBExportHeader$w_svc_history_yesno.srw
forward
...
if li_sts = 0 then
	log.log(this, "open", "No observations to display (" + observation_id + ")", 4)
	closewithreturn(this, popup_return)
	return
elseif li_sts < 0 then
	log.log(this, "open", "Error initializing observations (" + observation_id + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
