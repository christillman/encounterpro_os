HA$PBExportHeader$w_svc_config_menus.srw
forward
global type w_svc_config_menus from w_window_base
end type
type st_search_title from statictext within w_svc_config_menus
end type
type pb_up from u_picture_button within w_svc_config_menus
end type
type pb_down from u_picture_button within w_svc_config_menus
end type
type st_page from statictext within w_svc_config_menus
end type
type st_context_object from statictext within w_svc_config_menus
end type
type st_top_20 from statictext within w_svc_config_menus
end type
type st_search_status from statictext within w_svc_config_menus
end type
type st_specialty from statictext within w_svc_config_menus
end type
type st_specialty_title from statictext within w_svc_config_menus
end type
type st_title from statictext within w_svc_config_menus
end type
type st_description from statictext within w_svc_config_menus
end type
type st_common_flag from statictext within w_svc_config_menus
end type
type dw_menus from u_dw_menus within w_svc_config_menus
end type
type cb_new from commandbutton within w_svc_config_menus
end type
type st_1 from statictext within w_svc_config_menus
end type
type st_category from statictext within w_svc_config_menus
end type
type cb_ok from commandbutton within w_svc_config_menus
end type
type cb_cancel from commandbutton within w_svc_config_menus
end type
end forward
...
global w_svc_config_menus w_svc_config_menus
...
event post_open;call super::post_open;dw_menus.mode = "EDIT"
dw_menus.initialize("")
...
type pb_epro_help from w_window_base`pb_epro_help within w_svc_config_menus
boolean visible = true
integer x = 2629
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_svc_config_menus
end type
...
long backcolor = 33538240
boolean enabled = false
string text = "Menu Configuration"
alignment alignment = center!
boolean focusrectangle = false
end type
