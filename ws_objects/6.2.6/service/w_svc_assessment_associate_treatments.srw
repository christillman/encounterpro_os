HA$PBExportHeader$w_svc_assessment_associate_treatments.srw
forward
...
if isnull(service.problem_id) then
	log.log(this, "open", "No assessment context", 4)
	closewithreturn(this, popup_return)
end if

li_sts = current_patient.assessments.assessment(assessment, service.problem_id)
if li_sts <= 0 then
	log.log(this, "open", "Error getting assessment (" + string(service.problem_id) + ")", 4)
	closewithreturn(this, popup_return)
end if
