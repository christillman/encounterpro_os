HA$PBExportHeader$w_config_encounter_types.srw
forward
global type w_config_encounter_types from w_window_base
end type
type st_search_title from statictext within w_config_encounter_types
end type
type pb_up from u_picture_button within w_config_encounter_types
end type
type pb_down from u_picture_button within w_config_encounter_types
end type
type st_page from statictext within w_config_encounter_types
end type
type st_top_20 from statictext within w_config_encounter_types
end type
type st_search_status from statictext within w_config_encounter_types
end type
type st_title from statictext within w_config_encounter_types
end type
type st_description from statictext within w_config_encounter_types
end type
type st_mode_direct from statictext within w_config_encounter_types
end type
type cb_ok from commandbutton within w_config_encounter_types
end type
type cb_new_encounter_type from commandbutton within w_config_encounter_types
end type
type cb_cancel from commandbutton within w_config_encounter_types
end type
type dw_encounter_types from u_dw_encounter_type_list within w_config_encounter_types
end type
type st_encounter_mode_title from statictext within w_config_encounter_types
end type
type st_mode_indirect from statictext within w_config_encounter_types
end type
type st_mode_other from statictext within w_config_encounter_types
end type
end forward
...
global w_config_encounter_types w_config_encounter_types
...
on w_config_encounter_types.create
int iCurrent
call super::create
...
on w_config_encounter_types.destroy
call super::destroy
...
type pb_epro_help from w_window_base`pb_epro_help within w_config_encounter_types
boolean visible = true
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_config_encounter_types
end type
