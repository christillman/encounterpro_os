HA$PBExportHeader$u_component_service_report.sru
forward
...
if li_sts < 0 then
	if cpr_mode = "CLIENT" then
		openwithparm(w_pop_message, "An error occured running this report'  See the log or event viewer for more information.")
	end if
	return -1
end if
