HA$PBExportHeader$u_component_service_repost_service.sru
forward
...
If isnull(ls_posting_service) then
	mylog.log(this, "xx_do_service()", "posting service is null", 4)
	return -1
End If

ls_ordered_for = get_attribute("ordered_for")
If isnull(ls_ordered_for) then
	mylog.log(this, "xx_do_service()", "ordered for is null", 4)
	return -1
End If
