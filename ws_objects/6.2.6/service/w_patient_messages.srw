HA$PBExportHeader$w_patient_messages.srw
forward
global type w_patient_messages from w_window_base
end type
type cb_finished from commandbutton within w_patient_messages
end type
type cb_be_back from commandbutton within w_patient_messages
end type
type cb_cancel from commandbutton within w_patient_messages
end type
type st_title from statictext within w_patient_messages
end type
end forward
...
global w_patient_messages w_patient_messages
...
type pb_epro_help from w_window_base`pb_epro_help within w_patient_messages
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_patient_messages
end type
