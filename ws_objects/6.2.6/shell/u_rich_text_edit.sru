HA$PBExportHeader$u_rich_text_edit.sru
forward
	...
	CASE "observations"
		...
		if ll_count > 0 then
			CHOOSE CASE lower(ls_format)
				...
				CASE "dates"
					luo_results.display_grid_date(ls_result_type, ls_abnormal_flag, lstr_table_attributes, this, lb_sort_descending)
				CASE "list"
...
/////////////////////////////////////////////////////////////////////////////////////////////
//
// Mark 11/8/06 Generating the script on the invisible window does seem to be faster
// than generating it on a displayed window, however the gain is more than lost in the
// delay of transferring the RTF to the displayed window with the "add_rtf()" command below
//
//// if this control is not flagged to process the script locally, then use the rtf control
//// on the object_window to process the controll
//if not process_local then
//	ls_text = object_window.ole_rtf.display_script_local( pl_display_script_id, &
//																			pstr_encounter, &
//																			pstr_assessment, &
//																			pstr_treatment, &
//																			width, &
...
//
//	add_rtf(ls_text)
//	first_display_script_id = pl_display_script_id
//	return ""
//end if
//
/////////////////////////////////////////////////////////////////////////////////////////////
...
for i = 1 to ll_count
	...
	CHOOSE CASE lower(ps_assessment_status)
		CASE "open"
			...
			if lstra_assessments[i].close_encounter_id = pstr_encounter.encounter_id and lstra_assessments[i].end_date < f_datetime_add_seconds(pstr_encounter.discharge_date , 86400)  then
				continue
			end if
		CASE "closed"
...
////	if li_sts <= 0 then
////		log.log(this, "objectclicked", "Error writing rendered signature to file", 4)
////		return
////	end if
////	
