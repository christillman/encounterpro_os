HA$PBExportHeader$u_list_data.sru
forward
...
public function string config_object_description (string ps_config_object_id)
end prototypes
...
if pl_row > 0 then
	...
	lstr_config_object_type.object_component_id = c_config_object_type.object.object_component_id[pl_row]
else
...
public function string config_object_description (string ps_config_object_id);string ls_null
string ls_description
