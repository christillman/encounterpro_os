HA$PBExportHeader$u_room_status_tab_xxx.sru
forward
global type u_room_status_tab_xxx from u_main_tabpage_base
end type
type cb_checkin from commandbutton within u_room_status_tab_xxx
end type
type cb_cleaned from commandbutton within u_room_status_tab_xxx
end type
type st_empty from statictext within u_room_status_tab_xxx
end type
type cb_get_patient from commandbutton within u_room_status_tab_xxx
end type
type uo_room from u_room_status within u_room_status_tab_xxx
end type
end forward
...
global u_room_status_tab_xxx u_room_status_tab_xxx
...
on u_room_status_tab_xxx.create
int iCurrent
call super::create
...
on u_room_status_tab_xxx.destroy
call super::destroy
