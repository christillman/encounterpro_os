HA$PBExportHeader$u_st_radio_default_list.sru
forward
global type u_st_radio_default_list from statictext
end type
end forward

shared variables

u_st_radio_default_list last_button
end variables
...
global u_st_radio_default_list u_st_radio_default_list
