HA$PBExportHeader$u_param_xml_creator_script.sru
forward
global type u_param_xml_creator_script from u_param_base
end type
type st_popup_values from statictext within u_param_xml_creator_script
end type
type cb_edit_display_script from commandbutton within u_param_xml_creator_script
end type
end forward
...
global u_param_xml_creator_script u_param_xml_creator_script
...
on u_param_xml_creator_script.create
int iCurrent
call super::create
...
on u_param_xml_creator_script.destroy
call super::destroy
destroy(this.st_popup_values)
destroy(this.cb_edit_display_script)
end on

type st_preference from u_param_base`st_preference within u_param_xml_creator_script
end type

type st_preference_title from u_param_base`st_preference_title within u_param_xml_creator_script
end type

type cb_clear from u_param_base`cb_clear within u_param_xml_creator_script
end type
...
type st_required from u_param_base`st_required within u_param_xml_creator_script
integer x = 1358
integer y = 536
end type

type st_helptext from u_param_base`st_helptext within u_param_xml_creator_script
end type

type st_title from u_param_base`st_title within u_param_xml_creator_script
integer x = 46
integer y = 616
integer height = 76
end type
