HA$PBExportHeader$u_st_radio_duration_type.sru
forward
global type u_st_radio_duration_type from statictext
end type
end forward
...
u_st_radio_duration_type last_button
end variables
...
global u_st_radio_duration_type u_st_radio_duration_type
