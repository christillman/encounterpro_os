HA$PBExportHeader$u_getopenfilename.sru
$PBExportComments$GetOpenFileName WinAPI call (with multi-select)
forward
global type u_getopenfilename from nonvisualobject
end type
type openfilename from structure within u_getopenfilename
end type
end forward
...
global type u_getopenfilename from nonvisualobject autoinstantiate
end type
...
public function integer of_getopenfilename (long al_hwnd, string as_title, ref string as_pathname[], ref string as_filename[], string as_filter)
...
on u_getopenfilename.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_getopenfilename.destroy
