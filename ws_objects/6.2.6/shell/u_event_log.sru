HA$PBExportHeader$u_event_log.sru
forward
...
if li_sts <= 0 then
	log.log(this, "file_copy()", "Invalid target (" + ps_fileto + ")", 4)
end if
...
if li_sts <= 0 then
	if li_sts = -1 then
		log.log(this, "file_copy()", "Error opening source (" + ps_filefrom + ")", 4)
	elseif li_sts = -2 then
		log.log(this, "file_copy()", "Error writing target (" + ps_fileto + ")", 4)
	end if
...
if isnull(ps_file) then
	log.log(this, "file_read()", "Null file path", 4)
	return -1
end if
...
CATCH (throwable lt_error)
	log.log(this, "file_read()", "Error reading file (" + ps_file + "): " + lt_error.text, 4)
	return -1
END TRY
...
if isnull(ps_file) then
	log.log(this, "file_write()", "Null file path", 4)
	return -1
end if

if isnull(pblb_file) then
	log.log(this, "file_write()", "Null file blob", 4)
	return -1
end if
...
CATCH (throwable lt_error)
	log.log(this, "file_write()", "Error writing file (" + ps_file + ") : " + lt_error.text, 4)
	return -1
END TRY
