HA$PBExportHeader$u_tab_treatment_type.sru
forward
...
type tabpage_dashboard from u_tabpage_treatment_type_dashboard within u_tab_treatment_type
end type
type tabpage_dashboard from u_tabpage_treatment_type_dashboard within u_tab_treatment_type
end type
...
this.Control[iCurrent+3]=this.tabpage_services
this.Control[iCurrent+4]=this.tabpage_modes
this.Control[iCurrent+5]=this.tabpage_default_modes
this.Control[iCurrent+6]=this.tabpage_default_workplan
end on
