HA$PBExportHeader$n_cst_user32.sru
forward
...
Function boolean GetWindowRect (ulong hWnd, ref tagRECT lpRect) Library "USER32.DLL" alias for "GetWindowRect;Ansi"
...
constant int COLOR_DESKTOP           = this.COLOR_BACKGROUND
...
// SetWindowPos
constant uint HWND_TOP = 0
constant uint HWND_BOTTOM = 1
constant uint HWND_TOPMOST = -1
constant uint HWND_NOTOPMOST = -2
constant uint SWP_NOSIZE = 1  //0x00000001
constant uint SWP_NOMOVE = 2  //0x00000002
constant uint SWP_NOACTIVATE = 16  //0x00000010
constant uint SWP_SHOWWINDOW = 64 //0x00000040
...
forward prototypes
public subroutine send_to_back (window pw_window)
end prototypes

public subroutine send_to_back (window pw_window);unsignedlong lul_hwnd
unsignedlong lul_main_window_handle
integer li_x
integer li_y
integer li_cx
integer li_cy
unsignedlong lul_flags
tagrect lstr_tagrect

lul_hwnd = handle(pw_window)
lul_main_window_handle = handle(main_window)

lul_flags = SWP_NOMOVE + SWP_NOSIZE

setwindowpos(lul_hwnd, lul_main_window_handle, li_x, li_y, li_cx, li_cy, lul_flags)
