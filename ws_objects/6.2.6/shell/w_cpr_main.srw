HA$PBExportHeader$w_cpr_main.srw
forward
...
if isnull(current_service) or not isvalid(current_service) then
	log.log(this, "open", "Current service not valid", 4)
	closewithreturn(this, popup_return)
	return
end if
...
log.log(this, "open", "Initializing w_cpr_main...", 1)
initialize()

log.log(this, "open", "Initializing tab_cpr...", 1)
tab_cpr.initialize()
...
log.log(this, "open", "calling refresh_screen()...", 1)
refresh_screen()

if isvalid(tab_cpr.wait_window) then tab_cpr.wait_window.bump_progress()

log.log(this, "open", "calling tab_cpr.select_default_tab()", 1)
