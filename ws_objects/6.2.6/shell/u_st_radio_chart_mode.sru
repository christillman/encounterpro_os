HA$PBExportHeader$u_st_radio_chart_mode.sru
forward
global type u_st_radio_chart_mode from statictext
end type
end forward
...
u_st_radio_chart_mode last_button
end variables
...
global u_st_radio_chart_mode u_st_radio_chart_mode
