HA$PBExportHeader$w_assessment_history.srw
forward
...
type st_major from u_st_icd9_part within w_assessment_history
end type
type st_icd9 from statictext within w_assessment_history
end type
type st_minor_1 from u_st_icd9_part within w_assessment_history
end type
end forward
...
this.Control[iCurrent+5]=this.st_icd9
