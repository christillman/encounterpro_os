HA$PBExportHeader$u_ds_observation_results.sru
forward
...
public function integer display_grid_date (string ps_result_type, string ps_abnormal_flag, str_rtf_table_attributes pstr_table_attributes, u_rich_text_edit puo_rtf, boolean pb_sort_descending)
end prototypes
...
public function integer display_grid_date (string ps_result_type, string ps_abnormal_flag, str_rtf_table_attributes pstr_table_attributes, u_rich_text_edit puo_rtf, boolean pb_sort_descending);string ls_root_find
long ll_root_row
long ll_column_row
string ls_column_find
long ll_rows
...
f_sort_grid_by_date(lstr_grid, pb_sort_descending)
