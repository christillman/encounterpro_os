HA$PBExportHeader$u_st_radio_user_role.sru
forward
global type u_st_radio_user_role from statictext
end type
end forward
...
u_st_radio_user_role last_button
end variables
...
global u_st_radio_user_role u_st_radio_user_role
