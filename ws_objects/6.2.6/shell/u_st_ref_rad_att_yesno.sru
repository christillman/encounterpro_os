HA$PBExportHeader$u_st_ref_rad_att_yesno.sru
forward
global type u_st_ref_rad_att_yesno from statictext
end type
end forward
...
u_st_ref_rad_att_yesno last_button
end variables
...
global u_st_ref_rad_att_yesno u_st_ref_rad_att_yesno
...
on clicked;if isvalid(last_button) and not isnull(last_button) then last_button.unselect_button()
select_button()
