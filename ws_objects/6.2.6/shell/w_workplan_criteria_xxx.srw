HA$PBExportHeader$w_workplan_criteria_xxx.srw
forward
global type w_workplan_criteria_xxx from w_window_base
end type
type st_title from statictext within w_workplan_criteria_xxx
end type
type st_new_flag_title from statictext within w_workplan_criteria_xxx
end type
type st_sex_title from statictext within w_workplan_criteria_xxx
end type
type st_stage_title from statictext within w_workplan_criteria_xxx
end type
type st_new_flag from statictext within w_workplan_criteria_xxx
end type
type st_sex from statictext within w_workplan_criteria_xxx
end type
type st_age_range from statictext within w_workplan_criteria_xxx
end type
type sle_modes from singlelineedit within w_workplan_criteria_xxx
end type
type st_modes_title from statictext within w_workplan_criteria_xxx
end type
type cb_clear_age_range from commandbutton within w_workplan_criteria_xxx
end type
type st_workplan_owner_title from statictext within w_workplan_criteria_xxx
end type
type st_workplan_owner from statictext within w_workplan_criteria_xxx
end type
type cb_clear_workplan_owner from commandbutton within w_workplan_criteria_xxx
end type
type cb_ok from commandbutton within w_workplan_criteria_xxx
end type
type cb_cancel from commandbutton within w_workplan_criteria_xxx
end type
type st_abnormal_flag_title from statictext within w_workplan_criteria_xxx
end type
type st_abnormal_flag from statictext within w_workplan_criteria_xxx
end type
type st_severity_title from statictext within w_workplan_criteria_xxx
end type
type st_severity from statictext within w_workplan_criteria_xxx
end type
type st_authority_title from statictext within w_workplan_criteria_xxx
end type
type st_authority from statictext within w_workplan_criteria_xxx
end type
type cb_clear_authority from commandbutton within w_workplan_criteria_xxx
end type
type st_authority_category_title from statictext within w_workplan_criteria_xxx
end type
type st_authority_category from statictext within w_workplan_criteria_xxx
end type
type cb_clear_authority_category from commandbutton within w_workplan_criteria_xxx
end type
end forward
...
cb_clear_authority cb_clear_authority
st_authority_category_title st_authority_category_title
st_authority_category st_authority_category
cb_clear_authority_category cb_clear_authority_category
end type
global w_workplan_criteria_xxx w_workplan_criteria_xxx
...
on w_workplan_criteria_xxx.create
int iCurrent
call super::create
...
this.cb_clear_authority=create cb_clear_authority
this.st_authority_category_title=create st_authority_category_title
this.st_authority_category=create st_authority_category
this.cb_clear_authority_category=create cb_clear_authority_category
...
this.Control[iCurrent+20]=this.st_authority_title
this.Control[iCurrent+21]=this.st_authority
this.Control[iCurrent+22]=this.cb_clear_authority
this.Control[iCurrent+23]=this.st_authority_category_title
this.Control[iCurrent+24]=this.st_authority_category
this.Control[iCurrent+25]=this.cb_clear_authority_category
end on

on w_workplan_criteria_xxx.destroy
call super::destroy
...
destroy(this.cb_clear_authority)
destroy(this.st_authority_category_title)
destroy(this.st_authority_category)
destroy(this.cb_clear_authority_category)
end on
...
if isnull(criteria.authority_id) then
	st_authority.text = "<Any>"
	cb_clear_authority.visible = false
else
	st_authority.text = "<Any>"
end if

if isnull(criteria.authority_category) then
	st_authority_category.text = "<Any>"
	cb_clear_authority_category.visible = false
else
	st_authority_category.text = criteria.authority_category
end if
...
type pb_epro_help from w_window_base`pb_epro_help within w_workplan_criteria_xxx
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_workplan_criteria_xxx
integer x = 50
integer y = 1848
end type
...
event clicked;setnull(criteria.authority_id)
st_authority.text = "<Any>"
visible = false
...
long backcolor = 33538240
boolean enabled = false
string text = "Primary Payer Category:"
alignment alignment = right!
boolean focusrectangle = false
end type
...
event clicked;setnull(criteria.authority_category)
st_authority_category.text = "<Any>"
visible = false
