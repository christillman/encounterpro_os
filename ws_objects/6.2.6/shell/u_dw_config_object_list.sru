HA$PBExportHeader$u_dw_config_object_list.sru
forward
...
if li_sts <= 0 then
	log.log(this, "config_object_menu()", "error getting config object info (" + ls_config_object_id + ")", 4)
...
//		manage_config_object(ls_config_object_id)
	CASE "INSTALL"
		...
		if li_sts <= 0 then
			log.log(this, "f_config_obejct_upgrade_version()", "Error installing config object version (" + ls_config_object_id + ", " + string(ll_version) + ")", 4)
			return
		end if
	CASE "REINSTALL"
