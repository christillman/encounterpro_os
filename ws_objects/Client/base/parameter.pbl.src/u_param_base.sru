$PBExportHeader$u_param_base.sru
forward
...
//If ll_rows < 0 Then 
//	log.log(This,"u_param_base.load_query_data:0031","Unable to load values to prepare popup list..",4)
//	DESTROY query_data
//	setnull(query_data)
//	Return -1
//End If
//If ll_rows = 0 Then
//	log.log(This,"u_param_base.load_query_data:0037","Popup query returned no rows",3)
//	DESTROY query_data
//	setnull(query_data)
//	Return 0
//End If
...
End If
If ll_rows = 0 Then
//	log.log(This,"u_param_base.get_popup_selections:0036","Popup query returned no rows",3)
	DESTROY luo_data
	Return popup
End If
