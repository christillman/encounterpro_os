$PBExportHeader$u_tab_treatment_review.sru
forward
global type u_tab_treatment_review from u_tab_manager
end type
type tabpage_treatment from u_treatment_results within u_tab_treatment_review
end type
type tabpage_treatment from u_treatment_results within u_tab_treatment_review
end type
...
this.Control[iCurrent+1]=this.tabpage_treatment
