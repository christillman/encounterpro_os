...
if popup.data_row_count = 0 then
	log.log(this, "w_user_definition:open", "No User ID", 4)
	...
	if isnull(user) then
		log.log(this, "w_user_definition:open", "User not found (" + popup.items[1] + ")", 4)
		closewithreturn(this, popup_return)
		return
	end if
	...
	if li_sts < 0 then
		log.log(this, "w_user_definition:open", "Error getting user addresses (" + user.user_id + ")", 4)
		closewithreturn(this, popup_return)
		return
	end if
	...
	if li_sts < 0 then
		log.log(this, "w_user_definition:open", "Error getting user communications (" + user.user_id + ")", 4)
		closewithreturn(this, popup_return)
		return
	end if
end if
...
if li_first_tab <= 0 then
	log.log(this, "w_user_definition:open", "Error initializing user (" + user.user_id + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
