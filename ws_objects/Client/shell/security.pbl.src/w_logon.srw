...
if not isnull(current_user) and isvalid(current_user) then current_user.logoff()

setnull(viewed_room)

w_main.title = "EncounterPRO Logon"
...
ole_browser.height = height - ole_browser.height
...
this.Control[iCurrent+9]=this.st_copyright
this.Control[iCurrent+10]=this.st_build_number
this.Control[iCurrent+11]=this.ole_browser
this.Control[iCurrent+12]=this.p_agpl
end on
...
event close;call super::close;if isnull(current_user) and not minimizing then
...
event clicked;main_window.windowstate = Minimized!
minimizing = true
close(parent)
...
boolean enabled = false
string text = "Copyright 2010 The EncounterPRO Foundation, Inc.  Click ~"About EncounterPRO-OS~" for More Information."
...
0Cw_logon.bin 

