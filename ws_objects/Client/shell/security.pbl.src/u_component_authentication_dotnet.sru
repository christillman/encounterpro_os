...
CATCH (throwable lt_error)
	log.log(this, "u_component_authentication_dotnet.xx_initialize.0007", "Error disconnecting ConnectClass (" + lt_error.text + ")", 4)
	return -1
END TRY
...
CATCH (throwable lt_error)
	log.log(this, "u_component_authentication_dotnet.x_changepassword.0009", "Error Calling CheckUsername (" + lt_error.text + ")", 4)
	return -1
END TRY
...
//CATCH (throwable lt_error)
//	log.log(this, "u_component_authentication_dotnet.x_changepassword.0009", "Error Calling ConfigureSecurity (" + lt_error.text + ")", 4)
//	return -1
//END TRY
