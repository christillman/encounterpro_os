...
CATCH (throwable lt_error)
	log.log(this, "u_component_security_jmj_secure.xx_shutdown:0005", "Error disconnecting ConnectClass (" + lt_error.text + ")", 4)
	return -1
END TRY
...
CATCH (throwable lt_error)
	log.log(this, "u_component_security_jmj_secure.x_check_username:0009", "Error Calling CheckUsername (" + lt_error.text + ")", 4)
	return -1
END TRY
...
//CATCH (throwable lt_error)
//	log.log(this, "u_component_security_jmj_secure.x_configure_security:0009", "Error Calling ConfigureSecurity (" + lt_error.text + ")", 4)
//	return -1
//END TRY
