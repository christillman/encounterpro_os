...
if popup.data_row_count <> 4 then
	log.log(this, "w_em_component_rules:open", "Invalid Parameters", 4)
...
if not tf_check() then
	log.log(this, "w_em_component_rules:open", "Error getting documentation guide", 4)
	closewithreturn(this, popup_return)
	return
end if
...
if li_sts < 0 then
	log.log(this, "w_em_component_rules:open", "Error setting type levels", 4)
	closewithreturn(this, popup_return)
	return
end if
