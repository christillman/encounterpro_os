...
log.log(this, "u_mmserver.uncompress_file:0012", ps_compressed_file, 1)
...
if not fileexists(ps_uncompressed_file) then
	log.log(this, "u_mmserver.uncompress_file:0027", "Error uncompressing file", 3)
	return -1
end if
...
log.log(this, "u_mmserver:exte", "ERROR (" + string(error_code) + ") - " + error_text, 4)
