...
type pb_cancel from u_picture_button within w_review_material
end type
type ole_1 from olecontrol within w_review_material
end type
type st_category from statictext within w_review_material
end type
type st_cat from statictext within w_review_material
end type
type sle_title from singlelineedit within w_review_material
end type
type st_2 from statictext within w_review_material
end type
type pb_ok from u_picture_button within w_review_material
end type
end forward
...
global w_review_material w_review_material
...
material_id = Message.doubleparm
...
string binarykey = "w_review_material.win"
...
If result < 0 Then
	log.log(this,"w_review_material.ole_1.clicked:0014","Ole Error: "+String(result)+". Unable to "+&
