$PBExportHeader$u_component_service_db_maintenance.sru
forward
...
if not mydb.is_dbo then
	log.log(this, "u_component_service_db_maintenance.xx_do_service:0019", "This user is not connected as a DBO (" + logon_id + ")", 4)
	mydb.dbdisconnect()
	return -1
end if	
...
if lb_sync_database_scripts then
	...
	if li_sts <= 0 then
		log.log(this, "u_component_service_db_maintenance.xx_do_service:0034", "Error syncing database scripts", 4)
...
if lb_sync_content then
	li_sts = sync_content()
	if li_sts <= 0 then
		log.log(this, "u_component_service_db_maintenance.xx_do_service:0044", "Error syncing content", 4)
	end if
end if
...
if lb_run_hotfixes then
	li_sts = run_hotfixes()
	if li_sts <= 0 then
		log.log(this, "u_component_service_db_maintenance.xx_do_service:0051", "Error running hotfixes", 4)
	end if
end if
...
if lb_maintenance_frequent then
	...
	if li_sts <= 0 then
		log.log(this, "u_component_service_db_maintenance.xx_do_service:0058", "Error running hotfixes", 4)
	end if
end if
...
if lb_maintenance_infrequent then
	...
	if li_sts <= 0 then
		log.log(this, "u_component_service_db_maintenance.xx_do_service:0065", "Error running hotfixes", 4)
	end if
end if
...
if li_sts <= 0 then
	log.log(this, "u_component_service_db_maintenance.run_hotfixes:0005", "Error running hotfixes", 4)
	return -1
end if
...
if not mydb.check() then
	log.log(this, "u_component_service_db_maintenance.run_maintenance_frequent:0017", "Error running sp_maintenance_frequent", 4)
	return -1
end if
...
if not mydb.check() then
	log.log(this, "u_component_service_db_maintenance.run_maintenance_infrequent:0005", "Error running sp_maintenance_frequent", 4)
	return -1
end if
