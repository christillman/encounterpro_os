...
if popup.data_row_count <> 1 then
	log.log(this, "w_workplan_definition:open", "Invalid parameters", 4)
	close(this)
	return
end if
...
if isnull(workplan_id) then
	log.log(this, "w_workplan_definition:open", "Null workplan_id", 4)
	close(this)
	return
end if
...
if li_sts <= 0 then
	log.log(this, "w_workplan_definition:post", "Error loading workplan (" + string(workplan_id) + ")", 4)
	close(this)
	return
end if
