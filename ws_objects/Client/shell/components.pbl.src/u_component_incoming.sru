...
if isnull(message_type) then
	log.log(this, "u_component_incoming.start_receiving:0022", "Null Message Type", 4)
	return -1
end if
...
USING cprdb;
if not cprdb.check() then return -1
mylog.log(this, "u_component_incoming.log_message:0051",ps_file + ": read into blob", 1)
...
USING cprdb;
if not cprdb.check() then return -1
mylog.log(this, "u_component_incoming.log_message:0058",ps_file + ": read into blob and updated to o_message_log for "+string(ll_message_id), 1)
