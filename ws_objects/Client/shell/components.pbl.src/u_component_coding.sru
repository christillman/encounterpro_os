...
if ll_count < 0 and upper(ls_encounter_bill_flag) = "Y" then
	mylog.log(this, "u_component_coding.encounter_procedure:0107", "Error getting appointment procedure", 4)
	return -1
elseif ll_count = 0 and upper(ls_encounter_bill_flag) = "Y" then
	mylog.log(this, "u_component_coding.encounter_procedure:0110", "No appointment procedure found (" + ps_cpr_id + ", " + string(pl_encounter_id) + ")", 3)
	return -1
end if
