$PBExportHeader$u_reports_edit.sru
forward
...
If Not Isnull(ls_component_id) Or Len(ls_component_id) > 0 Then
	...
	Else
		log.log(This, "u_reports_edit.setup_report:0038", "Invalid report id ("+ps_report_id+")", 4)
		Return -1
	End If
End If
Return 1
...
If Not Isnull(ls_component_id) Or Len(ls_component_id) > 0 Then
	luo_report = component_manager.get_component(ls_component_id)
	If Isnull(luo_report) Then
		log.log(This, "u_reports_edit.dw_report_list.post_click:0012", "Error getting report component (" + &
					ls_component_id + ")", 4)
		Return 
	End If
	...
	Else
		log.log(This, "u_reports_edit.dw_report_list.post_click:0019", "Invalid report id ("+ls_report_id+")", 4)
	End If
component_manager.destroy_component(luo_report)
End If
