$PBExportHeader$w_pick_top_20_multiline.srw
forward
...
Else
	log.log(this, "w_pick_top_20_multiline:open", "Invalid Parameters", 4)
...
if li_sts < 0 then
	log.log(this, "w_pick_top_20_multiline:open", "Error loading pick list", 4)
	closewithreturn(this, popup_return)
	return
end if
