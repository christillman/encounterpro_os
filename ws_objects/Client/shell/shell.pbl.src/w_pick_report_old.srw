$PBExportHeader$w_pick_report_old.srw
forward
...
if f_is_context_object(ls_context_object) then
	...
	if ll_count <= 0 then
		log.log(this, "w_pick_report_old:open", "Error getting compatible context objects", 4)
	...
	if ll_count <= 0 then
		log.log(this, "w_pick_report_old:open", "Error getting context objects", 4)
		closewithreturn(this, popup_return)
		return
	end if
	ll_row = 1
