$PBExportHeader$u_tabpage_treatment_type_services.sru
forward
...
if isnull(ls_service_id) then
	log.log(this, "u_tabpage_treatment_type_services.configure_service:0024", "Service not found (" + ls_service + ")", 4)
	return -1
end if
...
if li_sts < 0 then
	log.log(this, "u_tabpage_treatment_type_services.configure_service:0057", "Error updating attributes", 4)
	return -1
end if
