...
// Error
if ll_count < 0 then
	log.log(this, "w_post_attachment_workplan:open", "Error getting folder workplans (" + attachment_context.folder + ")", 4)
...
if not tf_check() then
	log.log(this, "w_post_attachment_workplan:open", "Error folder record (" + attachment_context.folder + ")", 4)
	attachment_context.workplan_id = -1
	closewithreturn(this, attachment_context)
	return
end if
if sqlca.sqlcode = 100 then
	log.log(this, "w_post_attachment_workplan:open", "folder record not found (" + attachment_context.folder + ")", 4)
	attachment_context.workplan_id = -1
	closewithreturn(this, attachment_context)
	return
end if
