$PBExportHeader$u_prior_meds_small.sru
forward
global type u_prior_meds_small from userobject
end type
type st_meds_title from statictext within u_prior_meds_small
end type
type st_meds from statictext within u_prior_meds_small
end type
type st_more_meds from statictext within u_prior_meds_small
end type
end forward
...
global u_prior_meds_small u_prior_meds_small
...
if ls_meds = "" then ls_meds = "<No Prior Meds>"
