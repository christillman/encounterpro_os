...
if popup.data_row_count <> 3 then
	log.log(this, "w_standard_exams:open", "Invalid Parameters", 4)
	closewithreturn(this, popup_return)
	return
end if
...
if isnull(ls_description) then
	log.log(this, "w_standard_exams:open", "Invalid Root Observation Id (" + root_observation_id + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
...
if isnull(ls_description) then
	log.log(this, "w_standard_exams:open", "Invalid Treatment Type (" + treatment_type + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
