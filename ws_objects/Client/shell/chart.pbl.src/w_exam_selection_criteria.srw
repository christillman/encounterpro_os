$PBExportHeader$w_exam_selection_criteria.srw
forward
...
if popup.data_row_count <> 3 then
	log.log(this, "w_exam_selection_criteria:open", "Invalid Parameters", 4)
	close(this)
	return
end if
...
if isnull(age_range_id) then
	...
	if not tf_check() then
		log.log(this, "w_exam_selection_criteria:open", "Error getting stage description", 4)
		close(this)
		return
	end if
end if
