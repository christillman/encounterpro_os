$PBExportHeader$nvo_attachmentwrapper.sru
forward
global type nvo_attachmentwrapper from dotnetobject
end type
end forward
...
global nvo_attachmentwrapper nvo_attachmentwrapper
...
String is_classname = "EncounterPRO.OS.Component.AttachmentWrapper"
...
public function boolean of_is_displayable(string as_extension)
public function boolean of_is_editable(string as_extension)
public function long of_display(blob ablo_attachment,string as_extension)
public function blob of_edit(blob ablo_attachment,string as_extension)
public function blob of_render(blob ablo_attachment,string as_extension,long al_width,long al_height,ref string as_filetype)
...
Try
	...
	lbln_result = This.is_displayable(as_extension)
	Return lbln_result
...
Try
	...
	/* Trigger the dotnet function */
	lbln_result = This.is_editable(as_extension)
	Return lbln_result
Catch(runtimeerror re_error)
...
public function long of_display(blob ablo_attachment,string as_extension);
//*-----------------------------------------------------------------*/
//*  .NET function : Display
//*   Argument:
//*              Blob ablo_attachment
//*              String as_extension
//*   Return : Long
//*-----------------------------------------------------------------*/
/* .NET  function name */
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.display(ablo_attachment,as_extension)
	Return ll_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	lbyt_result = This.edit(ablo_attachment,as_extension)
	Return lbyt_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	lbyt_result = This.render(ablo_attachment,as_extension,al_width,al_height,ref as_filetype)
	Return lbyt_result
Catch(runtimeerror re_error)
...
on nvo_attachmentwrapper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_attachmentwrapper.destroy
