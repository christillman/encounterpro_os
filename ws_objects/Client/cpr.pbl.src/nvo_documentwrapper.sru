$PBExportHeader$nvo_documentwrapper.sru
forward
global type nvo_documentwrapper from dotnetobject
end type
end forward
...
global nvo_documentwrapper nvo_documentwrapper
...
String is_classname = "EncounterPRO.OS.Component.DocumentWrapper"
...
public function string of_createdocument()
public function string of_createdocument2(string as_xmldocument)
public function string of_configuredocument(string as_xmldocument)
public function string of_getdocumentelements(string as_xmldocument)
...
public function string of_createdocument2(string as_xmldocument);
//*-----------------------------------------------------------------*/
//*  .NET function : CreateDocument2
//*   Argument:
//*              String as_xmldocument
//*   Return : String
//*-----------------------------------------------------------------*/
/* .NET  function name */
String ls_function
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.createdocument2(as_xmldocument)
	Return ls_result
Catch(runtimeerror re_error)
...
public function string of_configuredocument(string as_xmldocument);
//*-----------------------------------------------------------------*/
//*  .NET function : ConfigureDocument
//*   Argument:
//*              String as_xmldocument
//*   Return : String
//*-----------------------------------------------------------------*/
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.configuredocument(as_xmldocument)
	Return ls_result
Catch(runtimeerror re_error)
...
public function string of_getdocumentelements(string as_xmldocument);
//*-----------------------------------------------------------------*/
//*  .NET function : GetDocumentElements
//*   Argument:
//*              String as_xmldocument
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Set the dotnet function name */
ls_function = "GetDocumentElements"
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.getdocumentelements(as_xmldocument)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_documentwrapper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_documentwrapper.destroy
