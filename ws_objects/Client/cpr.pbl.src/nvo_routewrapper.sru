$PBExportHeader$nvo_routewrapper.sru
forward
global type nvo_routewrapper from dotnetobject
end type
end forward
...
global nvo_routewrapper nvo_routewrapper
...
String is_classname = "EncounterPRO.OS.Component.RouteWrapper"
...
public function string of_senddocument(string as_xmldocument)
...
Try
	...
	ls_result = This.senddocument(as_xmldocument)
	Return ls_result
...
on nvo_routewrapper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_routewrapper.destroy
