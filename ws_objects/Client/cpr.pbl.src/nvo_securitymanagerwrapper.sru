$PBExportHeader$nvo_securitymanagerwrapper.sru
forward
global type nvo_securitymanagerwrapper from dotnetobject
end type
end forward
...
global nvo_securitymanagerwrapper nvo_securitymanagerwrapper
...
String is_classname = "EncounterPRO.OS.Component.SecurityManagerWrapper"
...
public function string of_challenge(string as_challenge)
public function string of_authenticate()
public function long of_reauthenticate(string as_username)
public function long of_changepassword(string as_username)
public function long of_resetpassword(string as_adminusername,string as_resetusername)
public function string of_establishcredentials(string as_userid)
public subroutine  of_connectclass(string as_assembly,string as_type,string as_componentattributes,string as_credentialattributes,string as_clinicalcontext)
end prototypes
...
Try
	...
	ls_result = This.challenge(as_challenge)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.reauthenticate(as_username)
	Return ll_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.changepassword(as_username)
	Return ll_result
Catch(runtimeerror re_error)
...
public function long of_resetpassword(string as_adminusername,string as_resetusername);
//*-----------------------------------------------------------------*/
//*  .NET function : ResetPassword
//*   Argument:
//*              String as_adminusername
//*              String as_resetusername
//*   Return : Long
//*-----------------------------------------------------------------*/
/* .NET  function name */
String ls_function
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.resetpassword(as_adminusername,as_resetusername)
	Return ll_result
Catch(runtimeerror re_error)
...
public function string of_establishcredentials(string as_userid);
//*-----------------------------------------------------------------*/
//*  .NET function : EstablishCredentials
//*   Argument:
//*              String as_userid
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Set the dotnet function name */
ls_function = "EstablishCredentials"
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.establishcredentials(as_userid)
	Return ls_result
Catch(runtimeerror re_error)
...
public subroutine  of_connectclass(string as_assembly,string as_type,string as_componentattributes,string as_credentialattributes,string as_clinicalcontext);
//*-----------------------------------------------------------------*/
//*  .NET function : ConnectClass
//*   Argument:
//*              String as_assembly
//*              String as_type
//*              String as_componentattributes
//*              String as_credentialattributes
//*              String as_clinicalcontext
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* .NET  function name */
String ls_function
...
Try
	...
	/* Trigger the dotnet function */
	This.connectclass(as_assembly,as_type,as_componentattributes,as_credentialattributes,as_clinicalcontext)
Catch(runtimeerror re_error)
...
on nvo_securitymanagerwrapper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_securitymanagerwrapper.destroy
