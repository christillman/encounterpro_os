$PBExportHeader$nvo_servicewrapper.sru
forward
global type nvo_servicewrapper from dotnetobject
end type
end forward
...
global nvo_servicewrapper nvo_servicewrapper
...
public function string of_doservice(string as_xmldocument)
public function string of_configureservice(string as_xmldocument)
...
Try
	...
	ls_result = This.doservice(as_xmldocument)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.configureservice(as_xmldocument)
	Return ls_result
Catch(runtimeerror re_error)
