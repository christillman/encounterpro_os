$PBExportHeader$nvo_win32.sru
forward
global type nvo_win32 from dotnetobject
end type
end forward
...
public function long of_sendmessage(long al_hwnd,ulong aul_msg,long al_wparam,long al_lparam)
end prototypes
...
Try
	...
	ll_result = This.sendmessage(al_hwnd,aul_msg,al_wparam,al_lparam)
	Return ll_result
