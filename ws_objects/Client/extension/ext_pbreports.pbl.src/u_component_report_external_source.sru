...
if li_sts <= 0 then
	...
	log.log(this, "u_component_report_external_source.xx_printreport.0019", ls_message, 4)
	return -1
end if
...
if isnull(luo_external_source) then
	log.log(this, "u_component_report_external_source.xx_printreport.0019", "error getting component (" + ls_component_id + ")", 4)
	return -1
end if

li_sts = luo_external_source.do_source()
if li_sts < 0 then
	log.log(this, "u_component_report_external_source.xx_printreport.0019", "Error calling external source (" + ls_external_source + ")", 4)
	return -1
end if
...
for i = 1 to luo_external_source.observation_count
	...
	for j = 1 to luo_external_source.observations[i].attachment_list.attachment_count
		if lb_found then
			...
			log.log(this, "u_component_report_external_source.xx_printreport.0019", ls_message, 3)
		else
