...
CATCH (oleruntimeerror lt_error)
	...
	log.log(this, "u_component_document_dotnet.xx_do_source:0057", "Error calling com source:~r~n" + ls_message, 4)
...
if debug_mode then
	log.log(this, "u_component_document_dotnet.xx_initialize:0006", "Debug Mode", 2)
end if
...
CATCH (throwable lt_error)
	log.log(this, "u_component_document_dotnet.xx_shutdown:0005", "Error disconnecting ConnectClass (" + lt_error.text + ")", 4)
	return -1
END TRY
...
CATCH (throwable lt_error)
	log.log(this, "u_component_document_dotnet.xx_configure_document:0044", "Error calling com source (" + lt_error.text + ")", 4)
	dotnet_create_test_case()
	return -1
END TRY
if debug_mode then
...
dotnet_xml_data = lo_document.xml_string
if isnull(dotnet_xml_data) then
	log.log(this, "u_component_document_dotnet.xx_get_document_elements:0037", "Error getting xml data", 4)
	return ""
end if
...
CATCH (throwable lt_error)
	log.log(this, "u_component_document_dotnet.xx_get_document_elements:0044", "Error calling com source (" + lt_error.text + ")", 4)
	dotnet_create_test_case()
	return ""
END TRY
if debug_mode then
