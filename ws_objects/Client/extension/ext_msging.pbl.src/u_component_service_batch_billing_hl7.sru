...
FOR i = 1 to ll_count
	...
	if isnull(ll_pos) or ll_pos = 0 then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0106", "message type not found ", 4)	
		return -1
	end if
	...
	ll_pos = POS(ls_message,ls_line_break)
	if isnull(ll_pos) or ll_pos = 0 then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0114", "message count not found ", 4)	
		return -1
	end if

	ls_msg_count = Mid(ls_message,1,ll_pos - 1)
	if not isnumber(ls_msg_count) then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0120", "message count not numeric", 3)	
		return -1
	end if
	...
	ls_message = Mid(ls_message,ll_pos + 1)
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0127", "billing message string2: "+ls_message, 1)	
	if (ls_msg_type = "HL7DFTP03") Then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0129", "message count "+string(ll_msg_count), 1)	
		...
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0132", "billing message string3: "+ls_message , 1)	
	else
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0134", "message type not known " + ls_msg_type, 4)	
		return -1
	end if
...
if isnull(ls_batch) or len(ls_batch) = 0 then 
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0144", "Billing Failed:batch is null or empty", 4)	
	return -1 // error 
end if
...
if isnull(ls_batch_message) or len(ls_batch_message) = 0 then 
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0184", "Billing Failed:batch message is null or empty", 4)	
	return -1 // error 
end if
...
if mylog.file_write(lblb_bill,ls_filename) < 0 then
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0202", "Error writing the report into a file", 4)
end if
...
if fileexists(ls_filename) then
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0211", "Error getting next file number", 4)
	return -1
end if
lblb_text = f_string_to_blob(ls_text, TextEncoding)
if mylog.file_write(lblb_text,ls_filename) < 0 then
	mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0216", "Error writing the report into a file", 4)
end if
...
if not isnull(hold_outgoing) then
	...
	if fileexists(ls_filename) then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0227", "Error getting next file number", 4)
		return -1
	end if

	if mylog.file_write(lblb_bill,ls_filename) < 0 then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0232", "Error writing the report into a file", 4)
	end if

	ls_filename = ls_path + "SU" + string(today(),"mmddyy") + ".TXT"
	if fileexists(ls_filename) then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0237", "Error getting next file number", 4)
		return -1
	end if
	if mylog.file_write(lblb_text,ls_filename) < 0 then
		mylog.log(this, "u_component_service_batch_billing_hl7.xx_do_service:0241", "Error writing the report into a file", 4)
	end if
...
IF isnull(procedurecodeidentifier) or procedurecodeidentifier = "" then 
	mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0158", "MessageId: "+string(pl_message_id)+":No Procedure, Billing message( " + ls_temp + "), Posting failed", 4)	
	ls_error = "NO PROCEDURE"
	GOTO Error
END IF

IF Isnull(ls_facility) OR ls_facility = "" then 
	mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0164", "No facility, assuming default " + ps_message, 3)
	...
	if isnull(ls_facility) or ls_facility = "" then 
		mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0172", "MessageId: "+string(pl_message_id)+":NO Default facility,Billing message( " + ls_temp + "), Posting failed", 4)	
...
SELECT 	supervisor_user_id,
	...
	if not cprdb.check() OR cprdb.sqlcode = 100 then
		mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0218", "MessageId: "+string(pl_message_id)+":Billing failed.Invalid Provider " + ls_provider, 4)	
...
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0278", "message header "+ls_msh, 1)	
...
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0285", "event header "+ls_evn, 1)	
/**********
...
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0324", "patient identification header "+ls_pid, 1)	
...
ls_pv1 += "|"
ls_pv1 += "|||||||||||"
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0339", "encounterpro visitnumber. " + ls_visitnumber_id , 2)
...
//discharge date time
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0350", "patient visit " + ls_pv1, 1)
...
IF li_diagnosis_count > 0 THEN
	...
	ls_ft += "|"
Else
	mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0380", "no diagnosis attached to cpt "+procedurecodeidentifier + ls_pv1, 3)
	ls_ft += "|"
End If	
...
ls_ft += ls_zft
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0427", "FT1/ZFT(1) " + ls_ft, 1)
...
IF il_msg_count > 1 THEN
	...
	FOR m = 2 TO il_msg_count
		...
		IF li_diagnosis_count > 0 THEN
			...
			ls_ft += "|"
		Else
			mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0497", "no diagnosis attached to cpt "+procedurecodeidentifier + ls_pv1, 3)
			ls_ft += "|"
		End If	
		...
		**********************/
		...
		ls_ft += ls_zft
		mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0543", "FT1/ZFT("+ls_count+") " + ls_ft, 1)
...
mylog.log(this, "u_component_service_batch_billing_hl7.get_shands_hl7:0550", "Charge message ("+string(pl_message_id)+") " + ls_hl7, 1)
