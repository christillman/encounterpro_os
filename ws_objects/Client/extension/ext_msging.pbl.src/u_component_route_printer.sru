$PBExportHeader$u_component_route_printer.sru
forward
...
if li_sts <= 0 then
	log.log(this, "u_component_route_printer.xx_send_document:0041", "Error printing document" + string(puo_document.patient_workplan_item_id) + ")", 4)
