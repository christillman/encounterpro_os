...
If len(hold_bills_address) > 0 and hold_outgoing Then
	...
	Else
		mylog.log(this, "u_component_outgoing_filecopy.xx_send_file:0045", "Saving a copy of outgoing file failed. Directory ("+hold_bills_address+") not found.", 3)
	End If
End If
...
If len(hold_bills_address) = 0 Then 
	log.log(this,"u_component_outgoing_filecopy.xx_initialize:0016","WARNING: Saving outgoing message not enabled; To enable set Attribute = 'hold_outgoing_directory' Value = '<enter valid dir>' FOR Component = 'trn_out_filecopy'.",3)
	Setnull(hold_bills_address)
Else
	if right(hold_bills_address,1) <> "\" Then hold_bills_address += "\"
	log.log(this,"u_component_outgoing_filecopy.xx_initialize:0020","save outgoing at "+hold_bills_address,1)
End If
...
//If ll_count > 0 Then
//	For i = 1 to ll_count
//		mylog.log(this,"u_component_outgoing_filecopy.timer_ding:0013","sending charges begin ",1)
//
...
//
//		mylog.log(this, "u_component_outgoing_filecopy.timer_ding:0019", "Retrying message #" + string(ll_message_id), 1)
//		
//		li_sts = send_file(ll_message_id)
//		IF li_sts <= 0 THEN
//			log.log(this, "u_component_outgoing_filecopy.timer_ding:0023", "Error sending (" + string(ll_message_id) + ")", 4)
//		END IF
//	NEXT
//	li_rtn = 2
//Else
