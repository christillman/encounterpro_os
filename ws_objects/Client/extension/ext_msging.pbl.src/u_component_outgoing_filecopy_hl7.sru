...
mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0092", "billing message string1: "+flatwire, 1)	
ll_pos = POS(flatwire,ls_line_break)
if isnull(ll_pos) or ll_pos = 0 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0095", "message type not found ", 4)	
	return -1
end if
...
ll_pos = POS(flatwire,ls_line_break)
if isnull(ll_pos) or ll_pos = 0 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0103", "message count not found ", 4)	
	return -1
end if

msg_count = Mid(flatwire,1,ll_pos - 1)
if not IsNumber(msg_count) then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0109", "message count not numeric ", 4)	
	return -1
end if
is_msg_count = integer(msg_count)
if is_msg_count < 1 then return -1
flatwire = Mid(flatwire,ll_pos + 1)
mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0115", "billing message string2: "+flatwire, 1)	
if (msg_type = "HL7DFTP03") OR (msg_type = "HL7ORMO01") then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0117", "message count "+string(is_msg_count), 1)	
	if left(flatwire,1) = "~013" then	flatwire = Mid(flatwire,ll_pos + 1) // ugly fix..somehow extra linebreak is included for few cases
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0119", "billing message string3: "+flatwire, 1)	
else
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_send_file:0121", "message type not known " + msg_type, 4)	
	return -1
end if	
...
if isnull(dcom_app_dest) or dcom_app_dest = '' then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_initialize:0031", "no object destination.", 4)
	return -1
end if	
...
if dcom_app_port > 0 Then
	if isnull(dcom_app_address) then
		mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_initialize:0049", "no destination computer address.", 4)
		return -1
	end if	
End If
...
if isnull(recv_app_path) and (bs_system = "PRACTICEPOINT" or bs_system='MCKESSON') Then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.xx_initialize:0125", "missing component attribute <recv_app_path>; this holds valid path name to write the charge message", 4)
	return -1
end if
...
mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0010", "connecting to AHCMessager.", 1)
...
mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0019", "connection to AHCMessager success", 1)

// Connect to AHC Messanger and returns AHC Message Manager
mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0022", "connection to IHCMessageManager object.", 1)
omsgman = oAHC.Connect(dcom_source)
If isnull(omsgman) Then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0025", "ERROR: connection to IHCMessageManager object failed.", 4)
	DESTROY oMsgMan
	oAHC.Disconnect()
	DESTROY oAHC
	setnull(oMsgMan)
...
mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0033", "connection to IHCMessageManager object successful.", 1)

ib_dcom_activ = true
il_count = 0
mylog.log(this, "u_component_outgoing_filecopy_hl7.ahc_connect:0037", "ahc_connect() - Successful", 1)
...
IF isnull(oenv) THEN
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0066", "error in creating message envelope object ", 4)	
	RETURN -1
END IF
...
IF isnull(hl7dftp03) THEN
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0074", "error in getting message type object from message envelope ", 4)	
	RETURN -1
END IF
...
IF ll_len = 0  OR ps_message = "" THEN
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0085","MessageId: "+string(message_id)+":No charge message",3)
...
If ll_len < 27 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0110", "MessageId: "+string(message_id)+":Invalid Billing message count, message( "+string(ll_len)+"," + ls_temp + "), Posting failed", 4)	
...
IF isnull(procedurecodeidentifier) or procedurecodeidentifier = "" then 
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0168", "MessageId: "+string(message_id)+":No Procedure, Billing message( " + ls_temp + "), Posting failed", 4)	
...
if not cprdb.check() OR cprdb.sqlcode = 100 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0229", "MessageId: "+string(message_id)+":Billing failed.Invalid Provider " + ls_provider, 4)	
...
if isnull(ls_supervisor) or ls_supervisor = "" or ls_supervisor = ls_provider_check then
	...
	If not cprdb.check() or cprdb.sqlcode = 100 or isnull(ls_supervisor_code) then 
		mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0283", "MessageId: "+string(message_id)+"Invalid supervisor user id " + ls_provider+". Assuming the attending doc ("+ls_provider+" is billable", 4)	
		lb_same_id = true
	End if
end if
END IF	
...
Else
	if not isnull(ls_supervisor_code) then
		...
		if upper(bs_system) = 'MEDIC' then
			...
			mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0435", "MessageId: "+string(message_id)+"Billable Provider(PASupervisor): " + ls_billable_provider, 2)	
			...
			mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0439", "MessageId: "+string(message_id)+"Billable Provider: " + ls_supervisor_code, 2)	
		end if
	end if	
...
End If
mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg:0461", "encounterpro visitnumber. " + ls_visitnumber_id , 2)
...
IF IsNull(ls_uuid) then
	...
	li_rtn = -1
ELSE
	mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg:0736","message " + string(message_id) + "sent to " + dcom_app_dest,1)
END IF
...
if ib_hold_outgoing then 
	...
	IF IsNull(ls_uuid) then
		mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg:0743","error with send to destination EPROHOLDMESSAGES" ,4)
		li_rtn = -1
	ELSE
		mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg:0746","message " + string(message_id) + "sent to EPROHOLDMESSAGES" ,1)
	END IF
end if
...
mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg:0774","message sent to destinations, returning",1)
Return li_rtn
end function
...
oEnv = omsgman.CreateMessage(omsgtype)
if isnull(oenv) then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0063", "Error in getting message evnvelope object", 4)	
	return -1
end if
...
HL7DFTP03 = oEnv.Content
if isnull(hl7dftp03) then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0072", "Error in getting message type object from message envelope", 4)	
	return -1
end if
...
END IF
IF ll_len = 0  OR ps_message = "" THEN
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0083","MessageId: "+string(message_id)+":No charge message",3)
	return f_posting_failed(message_id,"NO CHARGE")
END IF
...
ll_len = upperbound(ls_fields)
If ll_len < 27 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0108", "MessageId: "+string(message_id)+":Invalid Billing message count, message( "+string(ll_len)+"," + ls_temp + "), Posting failed", 4)	
	return f_posting_failed(message_id,"BAD LEN")
End If
...
mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0146", "facility id" + ls_facility, 1)	
...
if isnull(procedurecodeidentifier) or procedurecodeidentifier = "" then 
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0169", "MessageId: "+string(message_id)+":No Procedure, Billing message( " + ls_temp + "), Posting failed", 4)	
	return f_posting_failed(message_id,"NO PROCEDURE")
end if	
...
USING cprdb;
if not cprdb.check() OR cprdb.sqlcode = 100 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0231", "MessageId: "+string(message_id)+":Billing failed.Invalid Provider " + ls_provider, 4)	
	return f_posting_failed(message_id,"NO PROVIDER")
end if	
...
if isnull(ls_supervisor) or ls_supervisor = "" or ls_supervisor = ls_provider_check then
	...
	If not cprdb.check() or cprdb.sqlcode = 100 or isnull(ls_supervisor_id) then 
		mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0285", "MessageId: "+string(message_id)+"Invalid supervisor user id " + ls_provider+". Assuming the attending doc ("+ls_provider+" is billable", 4)	
		lb_same_id = true
	End if
end if
...
mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mpm:0307", "message construct:facility id" + ls_facility, 1)	
...
if IsNull(ls_uuid) then
	...
	mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg_mpm:0647","message " + string(message_id) + "sent to " + dcom_app_dest,1)
end if
...
if ib_hold_outgoing then 
	...
	IF IsNull(ls_uuid) then
		...
		li_rtn = -1
	ELSE
		mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg_mpm:0657","message " + string(message_id) + "sent to EPROHOLDMESSAGES" ,1)
	END IF
end if
...
mylog.log(this,"u_component_outgoing_filecopy_hl7.chrg_mpm:0682","message sent to destinations,returning", 1)
GarbageCollectSetTimeLimit(0)
GarbageCollect()
...
If ll_pending > 0 Then
	...
	For i = 1 to ll_pending
	   coll = omsgMan.PollForMessage(1, count)
		ll_count = Coll.Count
   	// get messages
		mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0023", "Polling Count (" + string(count) + ")", 1)
		...
		FOR j = 0 to ll_count - 1
			...
			mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0031", "Collection Count (" + string(j) + ") message type ( "+ls_message_type+")", 1)
			If upper(trim(ls_message_type)) = "ACK" Then
   			omsg = coll.Item(j)
				...
				If cprdb.sqlcode = 100 Then
					...
					mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0068", "No records found for message ID (" + ls_ack_message_id2 + ")", 3)
					continue
				End If
				mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0071", "Ack message ( "+ls_ack_type + " ) for message id (" + ls_ack_message_id + ")", 1)
				...
				If ls_ack_type = "AA" or ls_ack_type = "AL" or ls_ack_type = 'CA' then // bill Accepted
					...
					mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0081", "Acknowledge received for message ID (" + ls_ack_message_id + ")", 2)
				Elseif ls_ack_type = "AE" then
					...
					mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0091", "Ack Reject received for message ID (" + ls_ack_message_id + "), Error: "+ls_error, 4)	
				...
				Else
					...
					mylog.log(this, "u_component_outgoing_filecopy_hl7.timer_ding:0102", "NonAcknowledge received for message ID (" + ls_ack_message_id + ")" , 2)	
				End if	
...
public function integer ahc_disconnect ();if not isnull(oAHC) and isvalid(oAHC) Then
	...
	FINALLY
		...
		Setnull(oAHC)
	END TRY
	mylog.log(this,"u_component_outgoing_filecopy_hl7.ahc_disconnect:0012","disconnected from AHC Interface",1)
End If
...
END IF
IF ll_len = 0  OR ps_message = "" THEN
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0055","MessageId: "+string(message_id)+":No charge message",3)
	return f_posting_failed(message_id,"NO CHARGE")
END IF
...
ll_len = upperbound(ls_fields)
If ll_len < 27 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0080", "MessageId: "+string(message_id)+":Invalid Billing message count, message( "+string(ll_len)+"," + ls_temp + "), Posting failed", 4)	
	return f_posting_failed(message_id,"BAD LEN")
End If
ls_thisdatetime = string(today(),"yyyy/mm/dd hh:mm:ss")
ld_thisdate = Date(left(ls_thisdatetime,10))
...
IF isnull(procedurecodeidentifier) or procedurecodeidentifier = "" then 
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0139", "MessageId: "+string(message_id)+":No Procedure, Billing message( " + ls_temp + "), Posting failed", 4)	
	return f_posting_failed(message_id,"NO PROCEDURE")
END IF
...
USING cprdb;
if not cprdb.check() OR cprdb.sqlcode = 100 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0172", "MessageId: "+string(message_id)+":Billing failed.Invalid Provider " + ls_provider, 4)	
	return f_posting_failed(message_id,"NO PROVIDER")
end if	
...
if isnull(ls_supervisor) or ls_supervisor = "" or ls_supervisor = ls_provider_check then
	...
	USING cprdb;
	If not cprdb.check() or cprdb.sqlcode = 100 or isnull(ls_supervisor_code) then 
		mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0226", "MessageId: "+string(message_id)+"Invalid supervisor user id " + ls_provider+". Assuming the attending doc ("+ls_provider+" is billable", 4)	
		lb_same_id = true
	End if
end if
...
if lb_same_id then
	...
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0292", "MessageId: "+string(message_id)+"Billable Provider: " + ls_provider, 2)	
else
	...
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0303", "MessageId: "+string(message_id)+"Billable Provider: " + ls_supervisor_code, 2)	
End If
mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0305", "encounterpro visitnumber. " + ls_visitnumber_id , 2)
...
if mylog.file_write(lblb_bill,ls_filename) < 0 then
	mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0501", "Error writing the report into a file", 4)
	return -1
end if
...
if not isnull(hold_outgoing) then
	...
	if fileexists(ls_filename) then
		mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0513", "Error getting next file number", 4)
		return -1
	end if

	if mylog.file_write(lblb_bill,ls_filename) < 0 then
		mylog.log(this, "u_component_outgoing_filecopy_hl7.chrg_mckesson:0518", "Error writing the report into a file", 4)
	end if
end if
