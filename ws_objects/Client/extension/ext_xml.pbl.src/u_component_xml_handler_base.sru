...
if ll_root_observation_sequence <= 0 then
	log.log(this, "u_component_xml_handler_base.add_results_treatment:0062", "Error creating result root observation (" + luo_treatment.treatment_description + ")", 4)
	return -1
end if
...
if not isnull(pstr_result.location) then
	...
	if li_result_sequence > 0 then
		...
		log.log(this, "u_component_xml_handler_base.add_results_treatment:0099", "Error creating result result (" + pstr_result.location + ")", 4)
		return -1
	end if
end if
...
if not isnull(pstr_result.position) then
	...
	if li_result_sequence > 0 then
		...
		log.log(this, "u_component_xml_handler_base.add_results_treatment:0133", "Error creating result result (" + pstr_result.location + ")", 4)
		return -1
	end if
end if
...
if not isnull(pstr_result.method) then
	...
	if li_result_sequence > 0 then
		...
		log.log(this, "u_component_xml_handler_base.add_results_treatment:0167", "Error creating result result (" + pstr_result.location + ")", 4)
		return -1
	end if
end if
...
for i = 1 to upperbound(pstr_result.test)
	...
	if li_result_sequence > 0 then
		...
		log.log(this, "u_component_xml_handler_base.add_results_treatment:0230", "Error creating result result (" + pstr_result.location + ")", 4)
		return -1
	end if
next
...
if isnull(lstr_actor.actor_id) then
	CHOOSE CASE lower(lstr_actor.actorclass)
		CASE "user"
			...
			log.log(this, "u_component_xml_handler_base.get_actor_type:0240", "User not mapped (" + lstr_actor.name + ")" , 3)
		CASE "office"
			// If we don't already have a user_id then we have an error
			log.log(this, "u_component_xml_handler_base.get_actor_type:0243", "Office not mapped (" + lstr_actor.name + ")" , 3)
		CASE "person", "patient"
