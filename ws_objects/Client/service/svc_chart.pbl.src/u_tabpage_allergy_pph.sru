$PBExportHeader$u_tabpage_allergy_pph.sru
forward
global type u_tabpage_allergy_pph from u_tabpage
end type
type dw_results from u_dw_pick_list within u_tabpage_allergy_pph
end type
end forward
...
global u_tabpage_allergy_pph u_tabpage_allergy_pph
...
if isnull(parent_tab.service) then
	log.log(this, "u_tabpage_allergy_pph.initialize:0006", "No service context", 4)
	return -1
end if

if isnull(parent_tab.service.treatment) then
	log.log(this, "u_tabpage_allergy_pph.initialize:0011", "No treatment context", 4)
	return -1
end if
...
if treatment.problem_count < 1 then
	...
	dw_results.dataobject = "dw_sp_highlighted_rslts_for_assmnt_small"
	dw_results.settransobject(sqlca)
...
on u_tabpage_allergy_pph.create
int iCurrent
call super::create
...
on u_tabpage_allergy_pph.destroy
call super::destroy
...
integer width = 905
integer taborder = 10
string dataobject = "dw_sp_selected_history_for_assmnt_small"
end type
