...
if isnull(user_id) then
	log.log(this, "w_svc_show_actor:open", "No user_id", 4)
...
if not tf_check() then
	log.log(this, "w_svc_show_actor:open", "Error getting actor", 4)
	closewithreturn(this, popup_return)
	return
end if
if sqlca.sqlcode = 100 then
	log.log(this, "w_svc_show_actor:open", "Actor not found (" + user_id + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
