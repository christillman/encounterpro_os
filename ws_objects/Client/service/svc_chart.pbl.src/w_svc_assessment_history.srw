...
if isnull(service.problem_id) then
	log.log(this, "w_svc_assessment_history:open", "Null problem_id", 4)
...
if li_sts <= 0 then
	log.log(this, "w_svc_assessment_history:open", "Error getting assessment object (" + string(service.problem_id) + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
...
if isnull(assessment_id) then
	log.log(this, "w_svc_assessment_history:open", "Null assessment_id", 4)
	close(this)
	return
end if
