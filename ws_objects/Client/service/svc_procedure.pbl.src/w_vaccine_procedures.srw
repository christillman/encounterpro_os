...
if popup.data_row_count <> 1 then
	log.log(this, "w_vaccine_procedures:open", "Invalid Parameters", 4)
...
if isnull(vaccine_id) or trim(vaccine_id) = "" then
	log.log(this, "w_vaccine_procedures:open", "Invalid Vaccine_id", 4)
	closewithreturn(this, popup_return)
	return
end if
...
if sqlca.sqlcode = 100 then
	log.log(this, "w_vaccine_procedures:open", "Vaccine_id not found (" + vaccine_id + ")", 4)
	closewithreturn(this, popup_return)
	return
end if
