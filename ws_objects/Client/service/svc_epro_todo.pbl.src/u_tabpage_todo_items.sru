$PBExportHeader$u_tabpage_todo_items.sru
forward
...
if isnull(ls_service) then
	log.log(this, "u_tabpage_todo_items.do_todo:0036", "Service is null for todo item (" + string(ll_patient_workplan_item_id) + ")", 4)
	return
end if

luo_service = service_list.get_service_component(ls_service)
if isnull(luo_service) then
	log.log(this, "u_tabpage_todo_items.do_todo:0042", "Service not found (" + ls_service + ")", 4)
	return
end if
