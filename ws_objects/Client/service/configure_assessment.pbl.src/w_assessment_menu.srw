...
if popup.data_row_count <> 5 then
	log.log(this, "w_assessment_menu:open", "invalid parameters", 4)
...
if not tf_check() then
	log.log(this, "w_assessment_menu:open", "Error selecting assessment", 4)
	closewithreturn(this, ls_null)
	return
end if
if sqlca.sqlcode = 100 then
	log.log(this, "w_assessment_menu:open", "Assessment not found (" + assessment_id + ")", 4)
	closewithreturn(this, ls_null)
	return
end if
