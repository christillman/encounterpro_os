...
if isnull(ls_root_procedure_id) and isnull(ls_procedure_list) and isnull(ls_sql_query) then
	log.log(this, "w_svc_billing_code_pick:open", "This service requires either a root_procedure_id, sql_query or procedure_list param", 4)
...
elseif len(ls_sql_query) > 0 then
	...
	if ll_procedure_count < 0 then
		log.log(this, "w_svc_billing_code_pick:open", "Error running SQL", 4)
		closewithreturn(this, popup_return)
		return
	end if
	...
	if ll_procedure_count < 0 then
		log.log(this, "w_svc_billing_code_pick:open", "Error loading extra charges", 4)
		closewithreturn(this, popup_return)
		return
	end if
...
if ll_procedure_count = 0 then
	log.log(this, "w_svc_billing_code_pick:open", "No procedures found", 3)
