$PBExportHeader$u_tabpage_patient_relations.sru
forward
global type u_tabpage_patient_relations from u_tabpage
end type
type cb_find_relation from commandbutton within u_tabpage_patient_relations
end type
type st_other_carrier from statictext within u_tabpage_patient_relations
end type
type dw_relations from u_dw_pick_list within u_tabpage_patient_relations
end type
type st_cpr_id from statictext within u_tabpage_patient_relations
end type
end forward
...
global u_tabpage_patient_relations u_tabpage_patient_relations
...
if isnull(current_patient) then
	log.log(this, "u_tabpage_patient_relations.initialize:0005", "No current patient", 4)
	return -1
else
...
on u_tabpage_patient_relations.create
int iCurrent
call super::create
...
on u_tabpage_patient_relations.destroy
call super::destroy
...
sqlca.jmj_add_patient_relation(current_patient.cpr_id, ls_relation_cpr_id, ls_relationship, current_scribe.user_id)
