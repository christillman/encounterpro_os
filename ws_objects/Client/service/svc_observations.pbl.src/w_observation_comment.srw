$PBExportHeader$w_observation_comment.srw
forward
...
if popup.data_row_count <> 3 then
	log.log(this, "w_observation_comment:open", "Invalid parameters", 4)
	close(this)
	return
end if
...
if displayed_comment <= 0 then
	log.log(this, "w_observation_comment:open", "Nothing to display", 3)
	close(this)
	return
