...
if isnull(ll_version) then
	log.log(this, "w_component_manage_trials.upgrade_component:0026", "Component Version not found (" + ps_component_id + ", " + ps_version_name + ")", 4)
	return -1
end if
...
if not tf_check() then return -1
if isnull(ll_version) then
	log.log(this, "w_component_manage_trials.stop_trial:0026", "Component Version not found (" + ps_component_id + ", " + ps_version_name + ")", 4)
	return -1
end if
