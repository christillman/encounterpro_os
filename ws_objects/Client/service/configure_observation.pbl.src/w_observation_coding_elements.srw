$PBExportHeader$w_observation_coding_elements.srw
forward
...
if popup.data_row_count <> 1 then
	log.log(this, "w_observation_coding_elements:open", "Invalid Parameters", 4)
	close(this)
	return
end if
...
if ll_rows < 0 then
	log.log(this, "w_observation_coding_elements:open", "Error getting observation elements", 4)
	close(this)
	return
end if
