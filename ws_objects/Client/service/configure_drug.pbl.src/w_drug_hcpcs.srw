...
elseif popup.data_row_count = 1 then
	...
	if li_sts = 0 then
		...
		log.log(this, "w_drug_hcpcs:open", "No valid admin units for this drug (" + drug_id + ")", 4)
		closewithreturn(this, popup_return)
		return
	elseif li_sts < 0 then
		log.log(this, "w_drug_hcpcs:open", "Error retrieving default admin unit", 4)
		closewithreturn(this, popup_return)
		return
	end if
	hcpcs_procedure.postevent("clicked")
else
	log.log(this, "w_drug_hcpcs:open", "Invalid Parameters", 4)
	closewithreturn(this, popup_return)
	return
end if
