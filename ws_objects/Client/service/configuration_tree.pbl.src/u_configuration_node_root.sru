$PBExportHeader$u_configuration_node_root.sru
forward
...
if isnull(luo_practice) then
	log.log(this, "u_configuration_node_root.get_children:0015", "practice_user_id not found (" + common_thread.practice_user_id + ")", 4)
	return lstr_nodes
end if
