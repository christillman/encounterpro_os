$PBExportHeader$u_encounter_type_edit.sru
forward
...
if i >= 100 then
	log.log(this, "u_encounter_type_edit.pb_new_observation.clicked:0041", "Unable to generate new encounter_type key (" + ls_description + ")", 4)
	return
end if
