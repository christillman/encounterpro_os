...
if isnull(luo_practice) then
	log.log(this, "u_tv_practice_config.display_practice:0019", "practice_user_id not found (" + common_thread.practice_user_id + ")", 4)
	return -1
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.office_menu:0027", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.common_menu:0012", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.offices_menu:0031", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.location_menu:0030", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.locations_menu:0032", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.interface_menu:0030", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.interfaces_menu:0028", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.interface_transport_menu:0033", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.refresh_description:0015", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.purpose_workplan_menu:0031", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
if not tf_check() then return -1
if sqlca.sqlnrows = 0 then
	log.log(this, "u_tv_practice_config.configure_local_interface_transport:0045", "interface service id not found (" + string(pl_interfaceserviceid) + ")", 4)
	return -1
end if
...
if isnull(pl_interfaceserviceid) then
	log.log(this, "u_tv_practice_config.new_interface_transport_old:0023", "NULL interface service id", 4)
	return -1
end if
...
if not tf_check() then return -1
if sqlca.sqlnrows = 0 then
	log.log(this, "u_tv_practice_config.new_interface_transport_old:0035", "interface service id not found (" + string(pl_interfaceserviceid) + ")", 4)
	return -1
end if
...
if isnull(pl_interfaceserviceid) then
	...
	if not tf_check() then return -1
	if sqlca.sqlnrows = 0 then
		log.log(this, "u_tv_practice_config.configure_local_interface:0044", "interface service id not found (" + string(pl_interfaceserviceid) + ")", 4)
		return -1
	end if
...
if isnull(pl_interfaceserviceid) then
	log.log(this, "u_tv_practice_config.configure_interface_transport_actors:0022", "NULL interface service id", 4)
	return -1
end if

if isnull(pl_transportsequence) then
	log.log(this, "u_tv_practice_config.configure_interface_transport_actors:0027", "NULL transport sequence", 4)
	return -1
end if
...
if not tf_check() then return -1
if sqlca.sqlnrows = 0 then
	log.log(this, "u_tv_practice_config.configure_interface_transport_actors:0038", "interface service id not found (" + string(pl_interfaceserviceid) + ")", 4)
	return -1
end if
...
if not tf_check() then return -1
if sqlca.sqlnrows = 0 then
	log.log(this, "u_tv_practice_config.configure_interface_transport_actors:0049", "interface service id not found (" + string(pl_interfaceserviceid) + ")", 4)
	return -1
end if
...
if not tf_check() then return -1
if sqlca.sqlnrows = 0 then
	log.log(this, "u_tv_practice_config.configure_interface_transport_actors:0065", "document_route not found (" + ls_document_route + ")", 4)
	return -1
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.menu_sysadmins:0031", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.menu_sysadmin:0031", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.menu_group:0035", "Error getting new treeview item (" + string(pl_handle) + ")", 4)
	return
end if
...
li_sts = getitem(pl_handle, ltvi_item)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.menu_room:0035", "Error getting treeview item (" + string(pl_handle) + ")", 4)
	return
end if

ll_parent_handle = finditem(ParentTreeItem!, pl_handle)
if ll_parent_handle <= 0 then
	log.log(this, "u_tv_practice_config.menu_room:0041", "Error finding parent treeview item (" + string(pl_handle) + ")", 4)
	return
end if

li_sts = getitem(ll_parent_handle, ltvi_item_parent)
if li_sts <= 0 then
	log.log(this, "u_tv_practice_config.menu_room:0047", "Error getting parent treeview item (" + string(ll_parent_handle) + ")", 4)
	return
end if
