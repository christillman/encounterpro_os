HA$PBExportHeader$u_component_observation_jmj_attachments.sru
forward
global type u_component_observation_jmj_attachments from u_component_observation
end type
end forward

global type u_component_observation_jmj_attachments from u_component_observation
end type
global u_component_observation_jmj_attachments u_component_observation_jmj_attachments
...
on u_component_observation_jmj_attachments.create
call super::create
end on

on u_component_observation_jmj_attachments.destroy
call super::destroy
end on
