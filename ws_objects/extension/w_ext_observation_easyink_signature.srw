HA$PBExportHeader$w_ext_observation_easyink_signature.srw
forward
...
if not fileexists(ls_rendered_temp_file) then
	log.log(this, "clicked", "An error occured saving this signature.  Please try again.", 4)
...
if li_sts <= 0 then
	log.log(this, "clicked", "An error occured while saving this signature.  Please try again.", 4)
	ole_signature.object.clear()
	return
end if
