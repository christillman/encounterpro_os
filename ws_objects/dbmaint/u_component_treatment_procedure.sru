HA$PBExportHeader$u_component_treatment_procedure.sru
//
...
forward
global type u_component_treatment_procedure from u_component_treatment
end type
end forward

global type u_component_treatment_procedure from u_component_treatment
end type
global u_component_treatment_procedure u_component_treatment_procedure
...
on u_component_treatment_procedure.create
call super::create
end on

on u_component_treatment_procedure.destroy
call super::destroy
end on
