HA$PBExportHeader$u_tabpage_assessment_attachments.sru
forward
global type u_tabpage_assessment_attachments from u_tabpage
end type
type uo_attachments from u_attachments within u_tabpage_assessment_attachments
end type
end forward
...
global u_tabpage_assessment_attachments u_tabpage_assessment_attachments
...
ll_count = sqlca.fn_count_attachments(current_patient.cpr_id, "Assessment", parent_tab.service.problem_id)
if ll_count > 0 then
...
on u_tabpage_assessment_attachments.create
int iCurrent
call super::create
...
on u_tabpage_assessment_attachments.destroy
call super::destroy
