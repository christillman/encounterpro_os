HA$PBExportHeader$w_svc_patient_workplan.srw
forward
global type w_svc_patient_workplan from w_window_base
end type
type st_workplan_type_title from statictext within w_svc_patient_workplan
end type
type st_workplan_status_title from statictext within w_svc_patient_workplan
end type
type st_workplan_type from statictext within w_svc_patient_workplan
end type
type st_workplan_status from statictext within w_svc_patient_workplan
end type
type cb_dispatch_workplan from commandbutton within w_svc_patient_workplan
end type
type cb_cancel_workplan from commandbutton within w_svc_patient_workplan
end type
type dw_workplans from u_dw_pick_list within w_svc_patient_workplan
end type
type pb_down from picturebutton within w_svc_patient_workplan
end type
type pb_up from picturebutton within w_svc_patient_workplan
end type
type st_1 from statictext within w_svc_patient_workplan
end type
type st_2 from statictext within w_svc_patient_workplan
end type
type dw_workplan_content from u_dw_pick_list within w_svc_patient_workplan
end type
type st_page from statictext within w_svc_patient_workplan
end type
type pb_content_down from picturebutton within w_svc_patient_workplan
end type
type pb_content_up from picturebutton within w_svc_patient_workplan
end type
type st_content_title from statictext within w_svc_patient_workplan
end type
type st_content_page from statictext within w_svc_patient_workplan
end type
type st_4 from statictext within w_svc_patient_workplan
end type
type st_3 from statictext within w_svc_patient_workplan
end type
type cb_finished from commandbutton within w_svc_patient_workplan
end type
type cb_be_back from commandbutton within w_svc_patient_workplan
end type
type dw_workplan_display from u_dw_patient_object_workplan within w_svc_patient_workplan
end type
end forward
...
dw_workplan_display dw_workplan_display
end type
global w_svc_patient_workplan w_svc_patient_workplan
...
on w_svc_patient_workplan.create
int iCurrent
call super::create
...
this.dw_workplan_display=create dw_workplan_display
...
this.Control[iCurrent+22]=this.dw_workplan_display
end on

on w_svc_patient_workplan.destroy
call super::destroy
...
destroy(this.dw_workplan_display)
end on
...
type pb_epro_help from w_window_base`pb_epro_help within w_svc_patient_workplan
boolean visible = true
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_svc_patient_workplan
end type
...
dw_workplan_display.display_workplan(ll_patient_workplan_id)
