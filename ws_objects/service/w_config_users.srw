HA$PBExportHeader$w_config_users.srw
forward
global type w_config_users from w_window_base
end type
end forward
...
global w_config_users w_config_users
...
on w_config_users.create
call super::create
end on

on w_config_users.destroy
call super::destroy
end on
...
if isnull(lstr_pick_users.actor_class) or lower(lstr_pick_users.actor_class) = "user" then
...
type pb_epro_help from w_window_base`pb_epro_help within w_config_users
end type

type st_config_mode_menu from w_window_base`st_config_mode_menu within w_config_users
end type
