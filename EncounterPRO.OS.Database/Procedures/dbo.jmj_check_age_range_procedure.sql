...
-- Drop Procedure [dbo].[jmj_check_age_range_procedure]
Print 'Drop Procedure [dbo].[jmj_check_age_range_procedure]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_check_age_range_procedure]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_check_age_range_procedure]
GO

-- Create Procedure [dbo].[jmj_check_age_range_procedure]
Print 'Create Procedure [dbo].[jmj_check_age_range_procedure]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_check_age_range_procedure]
	TO [cprsystem]
GO
