...
-- Drop Procedure [dbo].[jmj_modify_age_range_references]
Print 'Drop Procedure [dbo].[jmj_modify_age_range_references]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_modify_age_range_references]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_modify_age_range_references]
GO

-- Create Procedure [dbo].[jmj_modify_age_range_references]
Print 'Create Procedure [dbo].[jmj_modify_age_range_references]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_modify_age_range_references]
	TO [cprsystem]
GO
