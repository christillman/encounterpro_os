...
-- Drop Procedure [dbo].[jmjrpt_Orderedby_OpenLabs]
Print 'Drop Procedure [dbo].[jmjrpt_Orderedby_OpenLabs]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_Orderedby_OpenLabs]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_Orderedby_OpenLabs]
GO

-- Create Procedure [dbo].[jmjrpt_Orderedby_OpenLabs]
Print 'Create Procedure [dbo].[jmjrpt_Orderedby_OpenLabs]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_Orderedby_OpenLabs]
	TO [cprsystem]
GO
