...
-- Drop Procedure [dbo].[jmjrpt_encounter_asthma_action]
Print 'Drop Procedure [dbo].[jmjrpt_encounter_asthma_action]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_encounter_asthma_action]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_encounter_asthma_action]
GO

-- Create Procedure [dbo].[jmjrpt_encounter_asthma_action]
Print 'Create Procedure [dbo].[jmjrpt_encounter_asthma_action]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_encounter_asthma_action]
	TO [cprsystem]
GO
