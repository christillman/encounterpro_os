...
-- Drop Procedure [dbo].[jmj_copy_report]
Print 'Drop Procedure [dbo].[jmj_copy_report]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_copy_report]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_copy_report]
GO

-- Create Procedure [dbo].[jmj_copy_report]
Print 'Create Procedure [dbo].[jmj_copy_report]'
GO
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER OFF
GO
CREATE PROCEDURE jmj_copy_report (
