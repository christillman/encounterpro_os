...
-- Drop Procedure [dbo].[sp_pick_service]
Print 'Drop Procedure [dbo].[sp_pick_service]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_pick_service]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_pick_service]
GO

-- Create Procedure [dbo].[sp_pick_service]
Print 'Create Procedure [dbo].[sp_pick_service]'
GO
SET ANSI_NULLS ON
