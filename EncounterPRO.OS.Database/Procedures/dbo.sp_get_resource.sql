...
-- Drop Procedure [dbo].[sp_get_resource]
Print 'Drop Procedure [dbo].[sp_get_resource]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_resource]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_resource]
GO

-- Create Procedure [dbo].[sp_get_resource]
Print 'Create Procedure [dbo].[sp_get_resource]'
GO
SET ANSI_NULLS OFF
