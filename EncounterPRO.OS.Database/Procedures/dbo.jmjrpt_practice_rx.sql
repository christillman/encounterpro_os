...
-- Drop Procedure [dbo].[jmjrpt_practice_rx]
Print 'Drop Procedure [dbo].[jmjrpt_practice_rx]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_practice_rx]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_practice_rx]
GO

-- Create Procedure [dbo].[jmjrpt_practice_rx]
Print 'Create Procedure [dbo].[jmjrpt_practice_rx]'
GO
SET ANSI_NULLS ON
