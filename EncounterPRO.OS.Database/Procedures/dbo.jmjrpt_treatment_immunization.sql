...
-- Drop Procedure [dbo].[jmjrpt_treatment_immunization]
Print 'Drop Procedure [dbo].[jmjrpt_treatment_immunization]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_treatment_immunization]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_treatment_immunization]
GO

-- Create Procedure [dbo].[jmjrpt_treatment_immunization]
Print 'Create Procedure [dbo].[jmjrpt_treatment_immunization]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_treatment_immunization]
	TO [cprsystem]
GO
