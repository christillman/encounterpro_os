...
-- Drop Procedure [dbo].[jmjrpt_patient_meds2]
Print 'Drop Procedure [dbo].[jmjrpt_patient_meds2]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_meds2]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_meds2]
GO

-- Create Procedure [dbo].[jmjrpt_patient_meds2]
Print 'Create Procedure [dbo].[jmjrpt_patient_meds2]'
GO
SET ANSI_NULLS ON
