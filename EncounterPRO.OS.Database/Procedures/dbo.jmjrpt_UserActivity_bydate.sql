...
-- Drop Procedure [dbo].[jmjrpt_UserActivity_bydate]
Print 'Drop Procedure [dbo].[jmjrpt_UserActivity_bydate]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_UserActivity_bydate]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_UserActivity_bydate]
GO

-- Create Procedure [dbo].[jmjrpt_UserActivity_bydate]
Print 'Create Procedure [dbo].[jmjrpt_UserActivity_bydate]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_UserActivity_bydate]
	TO [cprsystem]
GO
