...
-- Drop Procedure [dbo].[jmj_uncancel_encounter]
Print 'Drop Procedure [dbo].[jmj_uncancel_encounter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_uncancel_encounter]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_uncancel_encounter]
GO

-- Create Procedure [dbo].[jmj_uncancel_encounter]
Print 'Create Procedure [dbo].[jmj_uncancel_encounter]'
GO
SET ANSI_NULLS ON
