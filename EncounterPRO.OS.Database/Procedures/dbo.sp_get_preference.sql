...
-- Drop Procedure [dbo].[sp_get_preference]
Print 'Drop Procedure [dbo].[sp_get_preference]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_preference]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_preference]
GO

-- Create Procedure [dbo].[sp_get_preference]
Print 'Create Procedure [dbo].[sp_get_preference]'
GO
SET ANSI_NULLS ON
