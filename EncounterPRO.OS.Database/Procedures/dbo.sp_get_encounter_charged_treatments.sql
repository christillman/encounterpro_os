...
-- Drop Procedure [dbo].[sp_get_encounter_charged_treatments]
Print 'Drop Procedure [dbo].[sp_get_encounter_charged_treatments]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_encounter_charged_treatments]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_encounter_charged_treatments]
GO

-- Create Procedure [dbo].[sp_get_encounter_charged_treatments]
Print 'Create Procedure [dbo].[sp_get_encounter_charged_treatments]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_get_encounter_charged_treatments]
	TO [cprsystem]
GO
