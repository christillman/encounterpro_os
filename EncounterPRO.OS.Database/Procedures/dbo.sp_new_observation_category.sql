...
-- Drop Procedure [dbo].[sp_new_observation_category]
Print 'Drop Procedure [dbo].[sp_new_observation_category]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_observation_category]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_observation_category]
GO

-- Create Procedure [dbo].[sp_new_observation_category]
Print 'Create Procedure [dbo].[sp_new_observation_category]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_new_observation_category]
	TO [cprsystem]
GO
