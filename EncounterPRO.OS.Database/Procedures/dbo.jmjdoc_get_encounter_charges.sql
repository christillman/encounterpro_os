...
-- Drop Procedure [dbo].[jmjdoc_get_encounter_charges]
Print 'Drop Procedure [dbo].[jmjdoc_get_encounter_charges]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjdoc_get_encounter_charges]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjdoc_get_encounter_charges]
GO

-- Create Procedure [dbo].[jmjdoc_get_encounter_charges]
Print 'Create Procedure [dbo].[jmjdoc_get_encounter_charges]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjdoc_get_encounter_charges]
	TO [cprsystem]
GO
