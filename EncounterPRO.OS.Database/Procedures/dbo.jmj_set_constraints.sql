...
-- Drop Procedure [dbo].[jmj_set_constraints]
Print 'Drop Procedure [dbo].[jmj_set_constraints]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_set_constraints]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_set_constraints]
GO

-- Create Procedure [dbo].[jmj_set_constraints]
Print 'Create Procedure [dbo].[jmj_set_constraints]'
GO
SET ANSI_NULLS ON
