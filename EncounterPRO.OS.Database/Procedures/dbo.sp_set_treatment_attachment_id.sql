...
-- Drop Procedure [dbo].[sp_set_treatment_attachment_id]
Print 'Drop Procedure [dbo].[sp_set_treatment_attachment_id]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_set_treatment_attachment_id]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_set_treatment_attachment_id]
GO

-- Create Procedure [dbo].[sp_set_treatment_attachment_id]
Print 'Create Procedure [dbo].[sp_set_treatment_attachment_id]'
GO
SET ANSI_NULLS OFF
...
GO
GRANT EXECUTE
	ON [dbo].[sp_set_treatment_attachment_id]
	TO [cprsystem]
GO
