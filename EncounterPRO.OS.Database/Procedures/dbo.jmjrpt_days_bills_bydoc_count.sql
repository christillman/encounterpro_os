...
-- Drop Procedure [dbo].[jmjrpt_days_bills_bydoc_count]
Print 'Drop Procedure [dbo].[jmjrpt_days_bills_bydoc_count]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_days_bills_bydoc_count]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_days_bills_bydoc_count]
GO

-- Create Procedure [dbo].[jmjrpt_days_bills_bydoc_count]
Print 'Create Procedure [dbo].[jmjrpt_days_bills_bydoc_count]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_days_bills_bydoc_count]
	TO [cprsystem]
GO
