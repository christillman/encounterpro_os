...
-- Drop Procedure [dbo].[sp_new_drug_administration]
Print 'Drop Procedure [dbo].[sp_new_drug_administration]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_drug_administration]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_drug_administration]
GO

-- Create Procedure [dbo].[sp_new_drug_administration]
Print 'Create Procedure [dbo].[sp_new_drug_administration]'
GO
SET ANSI_NULLS OFF
