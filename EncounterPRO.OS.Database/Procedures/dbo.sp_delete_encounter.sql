...
-- Drop Procedure [dbo].[sp_delete_encounter]
Print 'Drop Procedure [dbo].[sp_delete_encounter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_encounter]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_encounter]
GO

-- Create Procedure [dbo].[sp_delete_encounter]
Print 'Create Procedure [dbo].[sp_delete_encounter]'
GO
SET ANSI_NULLS OFF
