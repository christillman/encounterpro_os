...
-- Drop Procedure [dbo].[jmj_archive_workplan_batch]
Print 'Drop Procedure [dbo].[jmj_archive_workplan_batch]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_archive_workplan_batch]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_archive_workplan_batch]
GO

-- Create Procedure [dbo].[jmj_archive_workplan_batch]
Print 'Create Procedure [dbo].[jmj_archive_workplan_batch]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_archive_workplan_batch]
	TO [cprsystem]
GO
