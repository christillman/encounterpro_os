...
-- Drop Procedure [dbo].[sp_get_last_result]
Print 'Drop Procedure [dbo].[sp_get_last_result]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_last_result]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_last_result]
GO

-- Create Procedure [dbo].[sp_get_last_result]
Print 'Create Procedure [dbo].[sp_get_last_result]'
GO
SET ANSI_NULLS ON
