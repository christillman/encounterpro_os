...
-- are not are not 'created', 'closed', 'reviewed', or 'Refill%' progress types
-- The excluded records are largely meaningless and there is a problem with the RTF "xxx progress" command that
