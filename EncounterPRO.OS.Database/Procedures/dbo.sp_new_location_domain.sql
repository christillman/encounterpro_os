...
-- Drop Procedure [dbo].[sp_new_location_domain]
Print 'Drop Procedure [dbo].[sp_new_location_domain]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_location_domain]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_location_domain]
GO

-- Create Procedure [dbo].[sp_new_location_domain]
Print 'Create Procedure [dbo].[sp_new_location_domain]'
GO
SET ANSI_NULLS OFF
