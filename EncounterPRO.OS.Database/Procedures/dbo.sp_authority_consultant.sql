...
-- Drop Procedure [dbo].[sp_authority_consultant]
Print 'Drop Procedure [dbo].[sp_authority_consultant]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_authority_consultant]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_authority_consultant]
GO

-- Create Procedure [dbo].[sp_authority_consultant]
Print 'Create Procedure [dbo].[sp_authority_consultant]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_authority_consultant]
	TO [cprsystem]
GO
