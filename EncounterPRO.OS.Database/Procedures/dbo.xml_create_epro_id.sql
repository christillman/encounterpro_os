...
-- Drop Procedure [dbo].[xml_create_epro_id]
Print 'Drop Procedure [dbo].[xml_create_epro_id]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[xml_create_epro_id]') AND [type]='P'))
DROP PROCEDURE [dbo].[xml_create_epro_id]
GO

-- Create Procedure [dbo].[xml_create_epro_id]
Print 'Create Procedure [dbo].[xml_create_epro_id]'
GO
SET ANSI_NULLS ON
