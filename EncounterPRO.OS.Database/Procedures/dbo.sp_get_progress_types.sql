...
-- Drop Procedure [dbo].[sp_get_progress_types]
Print 'Drop Procedure [dbo].[sp_get_progress_types]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_progress_types]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_progress_types]
GO

-- Create Procedure [dbo].[sp_get_progress_types]
Print 'Create Procedure [dbo].[sp_get_progress_types]'
GO
SET ANSI_NULLS ON
