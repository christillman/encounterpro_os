...
-- Drop Procedure [dbo].[sp_new_drug]
Print 'Drop Procedure [dbo].[sp_new_drug]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_drug]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_drug]
GO

-- Create Procedure [dbo].[sp_new_drug]
Print 'Create Procedure [dbo].[sp_new_drug]'
GO
SET ANSI_NULLS ON
