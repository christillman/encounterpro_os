...
-- Drop Procedure [dbo].[sp_new_observation]
Print 'Drop Procedure [dbo].[sp_new_observation]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_observation]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_observation]
GO

-- Create Procedure [dbo].[sp_new_observation]
Print 'Create Procedure [dbo].[sp_new_observation]'
GO
SET ANSI_NULLS ON
