...
-- Drop Procedure [dbo].[sp_material_search]
Print 'Drop Procedure [dbo].[sp_material_search]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_material_search]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_material_search]
GO

-- Create Procedure [dbo].[sp_material_search]
Print 'Create Procedure [dbo].[sp_material_search]'
GO
SET ANSI_NULLS ON
