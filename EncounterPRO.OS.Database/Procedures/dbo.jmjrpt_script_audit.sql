...
-- Drop Procedure [dbo].[jmjrpt_script_audit]
Print 'Drop Procedure [dbo].[jmjrpt_script_audit]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_script_audit]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_script_audit]
GO

-- Create Procedure [dbo].[jmjrpt_script_audit]
Print 'Create Procedure [dbo].[jmjrpt_script_audit]'
GO
SET ANSI_NULLS ON
