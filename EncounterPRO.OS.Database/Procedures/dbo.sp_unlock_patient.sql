...
-- Drop Procedure [dbo].[sp_unlock_patient]
Print 'Drop Procedure [dbo].[sp_unlock_patient]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_unlock_patient]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_unlock_patient]
GO

-- Create Procedure [dbo].[sp_unlock_patient]
Print 'Create Procedure [dbo].[sp_unlock_patient]'
GO
SET ANSI_NULLS OFF
