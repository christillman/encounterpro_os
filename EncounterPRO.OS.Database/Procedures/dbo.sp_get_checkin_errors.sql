...
-- Drop Procedure [dbo].[sp_get_checkin_errors]
Print 'Drop Procedure [dbo].[sp_get_checkin_errors]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_checkin_errors]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_checkin_errors]
GO

-- Create Procedure [dbo].[sp_get_checkin_errors]
Print 'Create Procedure [dbo].[sp_get_checkin_errors]'
GO
SET ANSI_NULLS ON
