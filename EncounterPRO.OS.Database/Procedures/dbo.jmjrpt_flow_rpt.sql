...
-- Drop Procedure [dbo].[jmjrpt_flow_rpt]
Print 'Drop Procedure [dbo].[jmjrpt_flow_rpt]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_flow_rpt]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_flow_rpt]
GO

-- Create Procedure [dbo].[jmjrpt_flow_rpt]
Print 'Create Procedure [dbo].[jmjrpt_flow_rpt]'
GO
SET ANSI_NULLS ON
