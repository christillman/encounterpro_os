...
PRINT 'Special Sync Starting: ' + @ls_disease_tablename + '   ' + CAST(getdate() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_disease_tablename + '   ' + CAST(getdate() AS varchar(20))
