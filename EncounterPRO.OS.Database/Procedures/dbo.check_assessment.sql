...
--INSERT INTO #results SELECT 'c_Recommended_Observation.assessment_id', count(*) FROM c_Recommended_Observation WHERE assessment_id = @ps_assessment_id
...
INSERT INTO #results SELECT 'c_Workplan_Item_Attribute.value', count(*) FROM c_Workplan_Item_Attribute WHERE attribute = 'assessment_id' AND value = @ps_assessment_id
...
INSERT INTO #results SELECT 'u_top_20.item_id', count(*) FROM u_top_20 WHERE item_id = @ps_assessment_id AND top_20_code like '%assess%'
