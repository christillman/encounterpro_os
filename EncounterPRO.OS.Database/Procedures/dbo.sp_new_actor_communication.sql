...
-- Drop Procedure [dbo].[sp_new_actor_communication]
Print 'Drop Procedure [dbo].[sp_new_actor_communication]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_actor_communication]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_actor_communication]
GO

-- Create Procedure [dbo].[sp_new_actor_communication]
Print 'Create Procedure [dbo].[sp_new_actor_communication]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_new_actor_communication]
	TO [cprsystem]
GO
