...
-- Drop Procedure [dbo].[jmjrpt_patient_waits]
Print 'Drop Procedure [dbo].[jmjrpt_patient_waits]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_waits]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_waits]
GO

-- Create Procedure [dbo].[jmjrpt_patient_waits]
Print 'Create Procedure [dbo].[jmjrpt_patient_waits]'
GO
SET ANSI_NULLS ON
