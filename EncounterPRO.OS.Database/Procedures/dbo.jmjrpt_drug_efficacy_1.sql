...
-- Drop Procedure [dbo].[jmjrpt_drug_efficacy_1]
Print 'Drop Procedure [dbo].[jmjrpt_drug_efficacy_1]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_drug_efficacy_1]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_drug_efficacy_1]
GO

-- Create Procedure [dbo].[jmjrpt_drug_efficacy_1]
Print 'Create Procedure [dbo].[jmjrpt_drug_efficacy_1]'
GO
SET ANSI_NULLS ON
