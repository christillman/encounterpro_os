...
-- Drop Procedure [dbo].[sp_folder_workplan]
Print 'Drop Procedure [dbo].[sp_folder_workplan]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_folder_workplan]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_folder_workplan]
GO

-- Create Procedure [dbo].[sp_folder_workplan]
Print 'Create Procedure [dbo].[sp_folder_workplan]'
GO
SET ANSI_NULLS ON
