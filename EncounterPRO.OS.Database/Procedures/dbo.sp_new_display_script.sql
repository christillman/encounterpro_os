...
-- Drop Procedure [dbo].[sp_new_display_script]
Print 'Drop Procedure [dbo].[sp_new_display_script]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_display_script]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_display_script]
GO

-- Create Procedure [dbo].[sp_new_display_script]
Print 'Create Procedure [dbo].[sp_new_display_script]'
GO
SET ANSI_NULLS ON
