...
-- Drop Procedure [dbo].[sp_set_encounter_posted]
Print 'Drop Procedure [dbo].[sp_set_encounter_posted]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_set_encounter_posted]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_set_encounter_posted]
GO

-- Create Procedure [dbo].[sp_set_encounter_posted]
Print 'Create Procedure [dbo].[sp_set_encounter_posted]'
GO
SET ANSI_NULLS OFF
...
GO
GRANT EXECUTE
	ON [dbo].[sp_set_encounter_posted]
	TO [cprsystem]
GO
