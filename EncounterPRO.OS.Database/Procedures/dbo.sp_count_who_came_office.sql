...
-- Drop Procedure [dbo].[sp_count_who_came_office]
Print 'Drop Procedure [dbo].[sp_count_who_came_office]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_count_who_came_office]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_count_who_came_office]
GO

-- Create Procedure [dbo].[sp_count_who_came_office]
Print 'Create Procedure [dbo].[sp_count_who_came_office]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_count_who_came_office]
	TO [cprsystem]
GO
