...
-- Drop Procedure [dbo].[jmj_new_room]
Print 'Drop Procedure [dbo].[jmj_new_room]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_new_room]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_new_room]
GO

-- Create Procedure [dbo].[jmj_new_room]
Print 'Create Procedure [dbo].[jmj_new_room]'
GO
SET ANSI_NULLS ON
