...
-- Drop Procedure [dbo].[jmjrpt_test_sum_usage_by_super]
Print 'Drop Procedure [dbo].[jmjrpt_test_sum_usage_by_super]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_test_sum_usage_by_super]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_test_sum_usage_by_super]
GO

-- Create Procedure [dbo].[jmjrpt_test_sum_usage_by_super]
Print 'Create Procedure [dbo].[jmjrpt_test_sum_usage_by_super]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_test_sum_usage_by_super]
	TO [cprsystem]
GO
