...
-- Drop Procedure [dbo].[jmjrpt_officemeds_byprc]
Print 'Drop Procedure [dbo].[jmjrpt_officemeds_byprc]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_officemeds_byprc]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_officemeds_byprc]
GO

-- Create Procedure [dbo].[jmjrpt_officemeds_byprc]
Print 'Create Procedure [dbo].[jmjrpt_officemeds_byprc]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_officemeds_byprc]
	TO [cprsystem]
GO
