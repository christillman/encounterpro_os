...
-- Drop Procedure [dbo].[jmj_copy_assessment_treatment_lists]
Print 'Drop Procedure [dbo].[jmj_copy_assessment_treatment_lists]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_copy_assessment_treatment_lists]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_copy_assessment_treatment_lists]
GO

-- Create Procedure [dbo].[jmj_copy_assessment_treatment_lists]
Print 'Create Procedure [dbo].[jmj_copy_assessment_treatment_lists]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_copy_assessment_treatment_lists]
	TO [cprsystem]
GO
