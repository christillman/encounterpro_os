...
-- Drop Procedure [dbo].[jmj_hm_set_class_metric]
Print 'Drop Procedure [dbo].[jmj_hm_set_class_metric]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_hm_set_class_metric]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_hm_set_class_metric]
GO

-- Create Procedure [dbo].[jmj_hm_set_class_metric]
Print 'Create Procedure [dbo].[jmj_hm_set_class_metric]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_hm_set_class_metric]
	TO [cprsystem]
GO
