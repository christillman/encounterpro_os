...
-- Drop Procedure [dbo].[sp_delete_test_treatment_items]
Print 'Drop Procedure [dbo].[sp_delete_test_treatment_items]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_test_treatment_items]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_test_treatment_items]
GO

-- Create Procedure [dbo].[sp_delete_test_treatment_items]
Print 'Create Procedure [dbo].[sp_delete_test_treatment_items]'
GO
SET ANSI_NULLS OFF
...
GO
GRANT EXECUTE
	ON [dbo].[sp_delete_test_treatment_items]
	TO [cprsystem]
GO
