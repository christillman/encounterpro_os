...
-- Drop Procedure [dbo].[sp_add_charge]
Print 'Drop Procedure [dbo].[sp_add_charge]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_add_charge]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_add_charge]
GO

-- Create Procedure [dbo].[sp_add_charge]
Print 'Create Procedure [dbo].[sp_add_charge]'
GO
SET ANSI_NULLS ON
