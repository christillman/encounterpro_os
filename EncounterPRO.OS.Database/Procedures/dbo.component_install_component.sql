...
Print 'Drop Procedure [dbo].[component_install_component]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[component_install_component]') AND [type]='P'))
DROP PROCEDURE [dbo].[component_install_component]
GO

-- Create Procedure [dbo].[component_install_component]
Print 'Create Procedure [dbo].[component_install_component]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[component_install_component]
	TO [cprsystem]
GO
