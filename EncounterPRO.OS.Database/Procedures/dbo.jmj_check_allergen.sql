...
-- Drop Procedure [dbo].[jmj_check_allergen]
Print 'Drop Procedure [dbo].[jmj_check_allergen]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_check_allergen]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_check_allergen]
GO

-- Create Procedure [dbo].[jmj_check_allergen]
Print 'Create Procedure [dbo].[jmj_check_allergen]'
GO
SET ANSI_NULLS ON
