...
-- Drop Procedure [dbo].[sp_close_box]
Print 'Drop Procedure [dbo].[sp_close_box]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_close_box]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_close_box]
GO

-- Create Procedure [dbo].[sp_close_box]
Print 'Create Procedure [dbo].[sp_close_box]'
GO
SET ANSI_NULLS OFF
