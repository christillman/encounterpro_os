...
-- Drop Procedure [dbo].[jmjdoc_get_altofficeids]
Print 'Drop Procedure [dbo].[jmjdoc_get_altofficeids]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjdoc_get_altofficeids]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjdoc_get_altofficeids]
GO

-- Create Procedure [dbo].[jmjdoc_get_altofficeids]
Print 'Create Procedure [dbo].[jmjdoc_get_altofficeids]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjdoc_get_altofficeids]
	TO [cprsystem]
GO
