...
-- Drop Procedure [dbo].[jmj_config_object_library_search]
Print 'Drop Procedure [dbo].[jmj_config_object_library_search]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_config_object_library_search]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_config_object_library_search]
GO

-- Create Procedure [dbo].[jmj_config_object_library_search]
Print 'Create Procedure [dbo].[jmj_config_object_library_search]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_config_object_library_search]
	TO [cprsystem]
GO
