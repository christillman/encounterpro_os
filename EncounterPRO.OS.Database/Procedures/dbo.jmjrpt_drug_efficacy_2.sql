...
-- Drop Procedure [dbo].[jmjrpt_drug_efficacy_2]
Print 'Drop Procedure [dbo].[jmjrpt_drug_efficacy_2]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_drug_efficacy_2]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_drug_efficacy_2]
GO

-- Create Procedure [dbo].[jmjrpt_drug_efficacy_2]
Print 'Create Procedure [dbo].[jmjrpt_drug_efficacy_2]'
GO
SET ANSI_NULLS ON
