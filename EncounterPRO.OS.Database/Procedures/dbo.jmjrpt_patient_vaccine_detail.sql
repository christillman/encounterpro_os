...
-- Drop Procedure [dbo].[jmjrpt_patient_vaccine_detail]
Print 'Drop Procedure [dbo].[jmjrpt_patient_vaccine_detail]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_vaccine_detail]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_vaccine_detail]
GO

-- Create Procedure [dbo].[jmjrpt_patient_vaccine_detail]
Print 'Create Procedure [dbo].[jmjrpt_patient_vaccine_detail]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_patient_vaccine_detail]
	TO [cprsystem]
GO
