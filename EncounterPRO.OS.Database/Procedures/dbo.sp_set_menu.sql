...
-- Drop Procedure [dbo].[sp_set_menu]
Print 'Drop Procedure [dbo].[sp_set_menu]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_set_menu]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_set_menu]
GO

-- Create Procedure [dbo].[sp_set_menu]
Print 'Create Procedure [dbo].[sp_set_menu]'
GO
SET ANSI_NULLS ON
