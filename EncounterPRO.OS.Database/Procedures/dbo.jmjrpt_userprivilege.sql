...
-- Drop Procedure [dbo].[jmjrpt_userprivilege]
Print 'Drop Procedure [dbo].[jmjrpt_userprivilege]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_userprivilege]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_userprivilege]
GO

-- Create Procedure [dbo].[jmjrpt_userprivilege]
Print 'Create Procedure [dbo].[jmjrpt_userprivilege]'
GO
SET ANSI_NULLS ON
