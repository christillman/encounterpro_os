...
-- Drop Procedure [dbo].[jmjrpt_Type_OpenTreatments]
Print 'Drop Procedure [dbo].[jmjrpt_Type_OpenTreatments]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_Type_OpenTreatments]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_Type_OpenTreatments]
GO

-- Create Procedure [dbo].[jmjrpt_Type_OpenTreatments]
Print 'Create Procedure [dbo].[jmjrpt_Type_OpenTreatments]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_Type_OpenTreatments]
	TO [cprsystem]
GO
