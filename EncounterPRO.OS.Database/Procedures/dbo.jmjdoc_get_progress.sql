...
-- Drop Procedure [dbo].[jmjdoc_get_progress]
Print 'Drop Procedure [dbo].[jmjdoc_get_progress]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjdoc_get_progress]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjdoc_get_progress]
GO

-- Create Procedure [dbo].[jmjdoc_get_progress]
Print 'Create Procedure [dbo].[jmjdoc_get_progress]'
GO
SET ANSI_NULLS ON
