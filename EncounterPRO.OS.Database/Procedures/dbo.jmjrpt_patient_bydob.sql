...
-- Drop Procedure [dbo].[jmjrpt_patient_bydob]
Print 'Drop Procedure [dbo].[jmjrpt_patient_bydob]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_bydob]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_bydob]
GO

-- Create Procedure [dbo].[jmjrpt_patient_bydob]
Print 'Create Procedure [dbo].[jmjrpt_patient_bydob]'
GO
SET ANSI_NULLS ON
