...
-- Drop Procedure [dbo].[jmjdoc_get_actor_ids]
Print 'Drop Procedure [dbo].[jmjdoc_get_actor_ids]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjdoc_get_actor_ids]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjdoc_get_actor_ids]
GO

-- Create Procedure [dbo].[jmjdoc_get_actor_ids]
Print 'Create Procedure [dbo].[jmjdoc_get_actor_ids]'
GO
SET ANSI_NULLS ON
