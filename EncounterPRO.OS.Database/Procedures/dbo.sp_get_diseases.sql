...
-- Drop Procedure [dbo].[sp_get_diseases]
Print 'Drop Procedure [dbo].[sp_get_diseases]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_diseases]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_diseases]
GO

-- Create Procedure [dbo].[sp_get_diseases]
Print 'Create Procedure [dbo].[sp_get_diseases]'
GO
SET ANSI_NULLS OFF
