...
Print 'Drop Procedure [dbo].[sp_get_groups]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_groups]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_groups]
GO

-- Create Procedure [dbo].[sp_get_groups]
Print 'Create Procedure [dbo].[sp_get_groups]'
GO
SET ANSI_NULLS ON
