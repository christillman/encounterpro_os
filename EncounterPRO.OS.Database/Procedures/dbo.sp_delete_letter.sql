...
-- Drop Procedure [dbo].[sp_delete_letter]
Print 'Drop Procedure [dbo].[sp_delete_letter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_letter]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_letter]
GO

-- Create Procedure [dbo].[sp_delete_letter]
Print 'Create Procedure [dbo].[sp_delete_letter]'
GO
SET ANSI_NULLS OFF
