...
-- Drop Procedure [dbo].[xml_remove_mapping]
Print 'Drop Procedure [dbo].[xml_remove_mapping]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[xml_remove_mapping]') AND [type]='P'))
DROP PROCEDURE [dbo].[xml_remove_mapping]
GO

-- Create Procedure [dbo].[xml_remove_mapping]
Print 'Create Procedure [dbo].[xml_remove_mapping]'
GO
SET ANSI_NULLS ON
