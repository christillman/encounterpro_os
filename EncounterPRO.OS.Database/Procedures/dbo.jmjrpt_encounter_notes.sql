...
-- Drop Procedure [dbo].[jmjrpt_encounter_notes]
Print 'Drop Procedure [dbo].[jmjrpt_encounter_notes]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_encounter_notes]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_encounter_notes]
GO

-- Create Procedure [dbo].[jmjrpt_encounter_notes]
Print 'Create Procedure [dbo].[jmjrpt_encounter_notes]'
GO
SET ANSI_NULLS ON
