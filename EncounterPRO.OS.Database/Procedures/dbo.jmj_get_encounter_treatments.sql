...
-- Drop Procedure [dbo].[jmj_get_encounter_treatments]
Print 'Drop Procedure [dbo].[jmj_get_encounter_treatments]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_get_encounter_treatments]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_get_encounter_treatments]
GO

-- Create Procedure [dbo].[jmj_get_encounter_treatments]
Print 'Create Procedure [dbo].[jmj_get_encounter_treatments]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmj_get_encounter_treatments]
	TO [cprsystem]
GO
