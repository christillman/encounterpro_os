...
-- Drop Procedure [dbo].[sp_new_drug_result_set]
Print 'Drop Procedure [dbo].[sp_new_drug_result_set]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_drug_result_set]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_drug_result_set]
GO

-- Create Procedure [dbo].[sp_new_drug_result_set]
Print 'Create Procedure [dbo].[sp_new_drug_result_set]'
GO
SET ANSI_NULLS ON
