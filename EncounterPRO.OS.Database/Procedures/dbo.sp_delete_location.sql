...
-- Drop Procedure [dbo].[sp_delete_location]
Print 'Drop Procedure [dbo].[sp_delete_location]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_location]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_location]
GO

-- Create Procedure [dbo].[sp_delete_location]
Print 'Create Procedure [dbo].[sp_delete_location]'
GO
SET ANSI_NULLS OFF
