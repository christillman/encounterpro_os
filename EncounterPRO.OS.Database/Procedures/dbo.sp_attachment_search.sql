...
-- Drop Procedure [dbo].[sp_attachment_search]
Print 'Drop Procedure [dbo].[sp_attachment_search]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_attachment_search]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_attachment_search]
GO

-- Create Procedure [dbo].[sp_attachment_search]
Print 'Create Procedure [dbo].[sp_attachment_search]'
GO
SET ANSI_NULLS ON
