...
-- Drop Procedure [dbo].[sp_copy_treatment_to_personal]
Print 'Drop Procedure [dbo].[sp_copy_treatment_to_personal]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_copy_treatment_to_personal]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_copy_treatment_to_personal]
GO

-- Create Procedure [dbo].[sp_copy_treatment_to_personal]
Print 'Create Procedure [dbo].[sp_copy_treatment_to_personal]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_copy_treatment_to_personal]
	TO [cprsystem]
GO
