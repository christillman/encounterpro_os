...
-- Drop Procedure [dbo].[jmjrpt_rx_meds_bydoc]
Print 'Drop Procedure [dbo].[jmjrpt_rx_meds_bydoc]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_rx_meds_bydoc]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_rx_meds_bydoc]
GO

-- Create Procedure [dbo].[jmjrpt_rx_meds_bydoc]
Print 'Create Procedure [dbo].[jmjrpt_rx_meds_bydoc]'
GO
SET ANSI_NULLS ON
...
CREATE PROCEDURE jmjrpt_rx_meds_bydoc
