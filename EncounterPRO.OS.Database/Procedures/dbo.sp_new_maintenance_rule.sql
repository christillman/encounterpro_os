...
-- Drop Procedure [dbo].[sp_new_maintenance_rule]
Print 'Drop Procedure [dbo].[sp_new_maintenance_rule]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_maintenance_rule]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_maintenance_rule]
GO

-- Create Procedure [dbo].[sp_new_maintenance_rule]
Print 'Create Procedure [dbo].[sp_new_maintenance_rule]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_new_maintenance_rule]
	TO [cprsystem]
GO
