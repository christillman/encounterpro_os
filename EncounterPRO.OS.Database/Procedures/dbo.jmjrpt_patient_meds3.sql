...
-- Drop Procedure [dbo].[jmjrpt_patient_meds3]
Print 'Drop Procedure [dbo].[jmjrpt_patient_meds3]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_meds3]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_meds3]
GO

-- Create Procedure [dbo].[jmjrpt_patient_meds3]
Print 'Create Procedure [dbo].[jmjrpt_patient_meds3]'
GO
SET ANSI_NULLS ON
