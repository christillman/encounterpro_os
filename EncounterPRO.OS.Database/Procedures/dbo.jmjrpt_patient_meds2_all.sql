...
-- Drop Procedure [dbo].[jmjrpt_patient_meds2_all]
Print 'Drop Procedure [dbo].[jmjrpt_patient_meds2_all]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_meds2_all]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_meds2_all]
GO

-- Create Procedure [dbo].[jmjrpt_patient_meds2_all]
Print 'Create Procedure [dbo].[jmjrpt_patient_meds2_all]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_patient_meds2_all]
	TO [cprsystem]
GO
