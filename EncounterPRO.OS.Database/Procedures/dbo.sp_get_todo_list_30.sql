...
-- Drop Procedure [dbo].[sp_get_todo_list_30]
Print 'Drop Procedure [dbo].[sp_get_todo_list_30]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_todo_list_30]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_todo_list_30]
GO

-- Create Procedure [dbo].[sp_get_todo_list_30]
Print 'Create Procedure [dbo].[sp_get_todo_list_30]'
GO
SET ANSI_NULLS ON
