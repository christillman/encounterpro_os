...
-- Drop Procedure [dbo].[sp_Set_User_Progress]
Print 'Drop Procedure [dbo].[sp_Set_User_Progress]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_Set_User_Progress]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_Set_User_Progress]
GO

-- Create Procedure [dbo].[sp_Set_User_Progress]
Print 'Create Procedure [dbo].[sp_Set_User_Progress]'
GO
SET ANSI_NULLS ON
