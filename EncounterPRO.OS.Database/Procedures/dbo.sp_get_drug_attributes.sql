...
-- Drop Procedure [dbo].[sp_get_drug_attributes]
Print 'Drop Procedure [dbo].[sp_get_drug_attributes]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_drug_attributes]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_drug_attributes]
GO

-- Create Procedure [dbo].[sp_get_drug_attributes]
Print 'Create Procedure [dbo].[sp_get_drug_attributes]'
GO
SET ANSI_NULLS OFF
