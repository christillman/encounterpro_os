...
-- Drop Procedure [dbo].[jmj_latest_scripts]
Print 'Drop Procedure [dbo].[jmj_latest_scripts]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_latest_scripts]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_latest_scripts]
GO

-- Create Procedure [dbo].[jmj_latest_scripts]
Print 'Create Procedure [dbo].[jmj_latest_scripts]'
GO
SET ANSI_NULLS ON
