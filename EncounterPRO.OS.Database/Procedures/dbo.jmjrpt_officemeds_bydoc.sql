...
-- Drop Procedure [dbo].[jmjrpt_officemeds_bydoc]
Print 'Drop Procedure [dbo].[jmjrpt_officemeds_bydoc]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_officemeds_bydoc]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_officemeds_bydoc]
GO

-- Create Procedure [dbo].[jmjrpt_officemeds_bydoc]
Print 'Create Procedure [dbo].[jmjrpt_officemeds_bydoc]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_officemeds_bydoc]
	TO [cprsystem]
GO
