...
-- Drop Procedure [dbo].[sp_delete_patient_material]
Print 'Drop Procedure [dbo].[sp_delete_patient_material]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_patient_material]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_patient_material]
GO

-- Create Procedure [dbo].[sp_delete_patient_material]
Print 'Create Procedure [dbo].[sp_delete_patient_material]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_delete_patient_material]
	TO [cprsystem]
GO
