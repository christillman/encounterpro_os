...
-- Drop Procedure [dbo].[z_sp_patient_object_progress_current]
Print 'Drop Procedure [dbo].[z_sp_patient_object_progress_current]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[z_sp_patient_object_progress_current]') AND [type]='P'))
DROP PROCEDURE [dbo].[z_sp_patient_object_progress_current]
GO

-- Create Procedure [dbo].[z_sp_patient_object_progress_current]
Print 'Create Procedure [dbo].[z_sp_patient_object_progress_current]'
GO
SET ANSI_NULLS ON
