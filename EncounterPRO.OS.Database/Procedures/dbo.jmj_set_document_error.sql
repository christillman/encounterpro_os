...
-- Drop Procedure [dbo].[jmj_set_document_error]
Print 'Drop Procedure [dbo].[jmj_set_document_error]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_set_document_error]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_set_document_error]
GO

-- Create Procedure [dbo].[jmj_set_document_error]
Print 'Create Procedure [dbo].[jmj_set_document_error]'
GO
SET ANSI_NULLS ON
