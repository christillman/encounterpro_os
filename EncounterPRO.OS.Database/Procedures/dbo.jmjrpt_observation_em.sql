...
-- Drop Procedure [dbo].[jmjrpt_observation_em]
Print 'Drop Procedure [dbo].[jmjrpt_observation_em]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_observation_em]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_observation_em]
GO

-- Create Procedure [dbo].[jmjrpt_observation_em]
Print 'Create Procedure [dbo].[jmjrpt_observation_em]'
GO
SET ANSI_NULLS ON
