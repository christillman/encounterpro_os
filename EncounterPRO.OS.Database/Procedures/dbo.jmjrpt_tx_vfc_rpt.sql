...
JOIN p_patient with (NOLOCK) ON p_treatment_item.cpr_id = p_patient.cpr_id
...
If @mycount > 0
 ...
 INSERT INTO #jmc_tx_vfc (myvacc)
	values
('DTAP'), ('DT'), ('Td'), ('HIB'), ('IPV'), ('MMR'), ('MEASLES'), ('VARICELLA'), 
('PCV 7'), ('HEPATITIS A'), ('HEPATITIS B'), ('INFLUENZA'), ('PNEUMO'), ('PEDIARIX')												, ('COMVAX')	
