...
-- Drop Procedure [dbo].[jmjrpt_audit_todo]
Print 'Drop Procedure [dbo].[jmjrpt_audit_todo]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_audit_todo]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_audit_todo]
GO

-- Create Procedure [dbo].[jmjrpt_audit_todo]
Print 'Create Procedure [dbo].[jmjrpt_audit_todo]'
GO
SET ANSI_NULLS ON
