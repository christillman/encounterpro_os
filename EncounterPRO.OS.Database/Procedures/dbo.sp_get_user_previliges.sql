...
-- Drop Procedure [dbo].[sp_get_user_previliges]
Print 'Drop Procedure [dbo].[sp_get_user_previliges]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_user_previliges]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_user_previliges]
GO

-- Create Procedure [dbo].[sp_get_user_previliges]
Print 'Create Procedure [dbo].[sp_get_user_previliges]'
GO
SET ANSI_NULLS ON
