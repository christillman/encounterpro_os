...
-- Drop Procedure [dbo].[xml_lookup_code]
Print 'Drop Procedure [dbo].[xml_lookup_code]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[xml_lookup_code]') AND [type]='P'))
DROP PROCEDURE [dbo].[xml_lookup_code]
GO

-- Create Procedure [dbo].[xml_lookup_code]
Print 'Create Procedure [dbo].[xml_lookup_code]'
GO
SET ANSI_NULLS ON
