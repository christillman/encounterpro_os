...
-- Drop Procedure [dbo].[jmj_new_report_ds]
Print 'Drop Procedure [dbo].[jmj_new_report_ds]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_new_report_ds]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_new_report_ds]
GO

-- Create Procedure [dbo].[jmj_new_report_ds]
Print 'Create Procedure [dbo].[jmj_new_report_ds]'
GO
SET ANSI_NULLS ON
