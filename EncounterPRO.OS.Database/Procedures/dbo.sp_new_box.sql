...
-- Drop Procedure [dbo].[sp_new_box]
Print 'Drop Procedure [dbo].[sp_new_box]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_box]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_box]
GO

-- Create Procedure [dbo].[sp_new_box]
Print 'Create Procedure [dbo].[sp_new_box]'
GO
SET ANSI_NULLS OFF
