...
-- Drop Procedure [dbo].[sp_new_treatment_def]
Print 'Drop Procedure [dbo].[sp_new_treatment_def]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_new_treatment_def]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_new_treatment_def]
GO

-- Create Procedure [dbo].[sp_new_treatment_def]
Print 'Create Procedure [dbo].[sp_new_treatment_def]'
GO
SET ANSI_NULLS ON
