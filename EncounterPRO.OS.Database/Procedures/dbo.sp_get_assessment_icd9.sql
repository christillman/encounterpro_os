...
-- Drop Procedure [dbo].[sp_get_assessment_icd9]
Print 'Drop Procedure [dbo].[sp_get_assessment_icd9]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_assessment_icd9]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_assessment_icd9]
GO

-- Create Procedure [dbo].[sp_get_assessment_icd9]
Print 'Create Procedure [dbo].[sp_get_assessment_icd9]'
GO
SET ANSI_NULLS ON
