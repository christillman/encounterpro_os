...
-- Drop Procedure [dbo].[sp_get_drug_admins]
Print 'Drop Procedure [dbo].[sp_get_drug_admins]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_drug_admins]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_drug_admins]
GO

-- Create Procedure [dbo].[sp_get_drug_admins]
Print 'Create Procedure [dbo].[sp_get_drug_admins]'
GO
SET ANSI_NULLS OFF
