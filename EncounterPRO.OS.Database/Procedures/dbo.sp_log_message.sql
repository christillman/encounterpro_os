...
-- Drop Procedure [dbo].[sp_log_message]
Print 'Drop Procedure [dbo].[sp_log_message]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_log_message]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_log_message]
GO

-- Create Procedure [dbo].[sp_log_message]
Print 'Create Procedure [dbo].[sp_log_message]'
GO
SET ANSI_NULLS OFF
