...
-- Drop Procedure [dbo].[sp_Get_Component_Class]
Print 'Drop Procedure [dbo].[sp_Get_Component_Class]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_Get_Component_Class]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_Get_Component_Class]
GO

-- Create Procedure [dbo].[sp_Get_Component_Class]
Print 'Create Procedure [dbo].[sp_Get_Component_Class]'
GO
SET ANSI_NULLS ON
