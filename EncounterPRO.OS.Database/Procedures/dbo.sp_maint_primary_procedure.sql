...
-- Drop Procedure [dbo].[sp_maint_primary_procedure]
Print 'Drop Procedure [dbo].[sp_maint_primary_procedure]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_maint_primary_procedure]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_maint_primary_procedure]
GO

-- Create Procedure [dbo].[sp_maint_primary_procedure]
Print 'Create Procedure [dbo].[sp_maint_primary_procedure]'
GO
SET ANSI_NULLS OFF
...
GO
GRANT EXECUTE
	ON [dbo].[sp_maint_primary_procedure]
	TO [cprsystem]
GO
