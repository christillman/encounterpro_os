...
-- Drop Procedure [dbo].[sp_dont_bill_treatment]
Print 'Drop Procedure [dbo].[sp_dont_bill_treatment]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_dont_bill_treatment]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_dont_bill_treatment]
GO

-- Create Procedure [dbo].[sp_dont_bill_treatment]
Print 'Create Procedure [dbo].[sp_dont_bill_treatment]'
GO
SET ANSI_NULLS OFF
