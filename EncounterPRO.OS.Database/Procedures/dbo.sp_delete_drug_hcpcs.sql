...
-- Drop Procedure [dbo].[sp_delete_drug_hcpcs]
Print 'Drop Procedure [dbo].[sp_delete_drug_hcpcs]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_drug_hcpcs]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_drug_hcpcs]
GO

-- Create Procedure [dbo].[sp_delete_drug_hcpcs]
Print 'Create Procedure [dbo].[sp_delete_drug_hcpcs]'
GO
SET ANSI_NULLS OFF
