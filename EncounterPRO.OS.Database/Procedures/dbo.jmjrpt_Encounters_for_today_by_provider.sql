...
-- Drop Procedure [dbo].[jmjrpt_Encounters_for_today_by_provider]
Print 'Drop Procedure [dbo].[jmjrpt_Encounters_for_today_by_provider]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_Encounters_for_today_by_provider]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_Encounters_for_today_by_provider]
GO

-- Create Procedure [dbo].[jmjrpt_Encounters_for_today_by_provider]
Print 'Create Procedure [dbo].[jmjrpt_Encounters_for_today_by_provider]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_Encounters_for_today_by_provider]
	TO [cprsystem]
GO
