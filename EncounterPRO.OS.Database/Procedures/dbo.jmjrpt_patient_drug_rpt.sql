...
-- Drop Procedure [dbo].[jmjrpt_patient_drug_rpt]
Print 'Drop Procedure [dbo].[jmjrpt_patient_drug_rpt]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_drug_rpt]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_drug_rpt]
GO

-- Create Procedure [dbo].[jmjrpt_patient_drug_rpt]
Print 'Create Procedure [dbo].[jmjrpt_patient_drug_rpt]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[jmjrpt_patient_drug_rpt]
	TO [cprsystem]
GO
