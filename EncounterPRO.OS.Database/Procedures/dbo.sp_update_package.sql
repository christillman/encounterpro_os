...
-- Drop Procedure [dbo].[sp_update_package]
Print 'Drop Procedure [dbo].[sp_update_package]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_update_package]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_update_package]
GO

-- Create Procedure [dbo].[sp_update_package]
Print 'Create Procedure [dbo].[sp_update_package]'
GO
SET ANSI_NULLS OFF
