...
-- Drop Procedure [dbo].[sp_close_treatment]
Print 'Drop Procedure [dbo].[sp_close_treatment]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_close_treatment]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_close_treatment]
GO

-- Create Procedure [dbo].[sp_close_treatment]
Print 'Create Procedure [dbo].[sp_close_treatment]'
GO
SET ANSI_NULLS OFF
