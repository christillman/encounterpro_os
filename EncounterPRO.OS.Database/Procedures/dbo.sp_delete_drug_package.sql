...
-- Drop Procedure [dbo].[sp_delete_drug_package]
Print 'Drop Procedure [dbo].[sp_delete_drug_package]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_delete_drug_package]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_delete_drug_package]
GO

-- Create Procedure [dbo].[sp_delete_drug_package]
Print 'Create Procedure [dbo].[sp_delete_drug_package]'
GO
SET ANSI_NULLS OFF
