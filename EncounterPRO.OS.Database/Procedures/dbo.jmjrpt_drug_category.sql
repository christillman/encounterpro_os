...
-- Drop Procedure [dbo].[jmjrpt_drug_category]
Print 'Drop Procedure [dbo].[jmjrpt_drug_category]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_drug_category]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_drug_category]
GO

-- Create Procedure [dbo].[jmjrpt_drug_category]
Print 'Create Procedure [dbo].[jmjrpt_drug_category]'
GO
SET ANSI_NULLS ON
