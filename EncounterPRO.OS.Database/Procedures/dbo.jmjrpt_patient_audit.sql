...
-- Drop Procedure [dbo].[jmjrpt_patient_audit]
Print 'Drop Procedure [dbo].[jmjrpt_patient_audit]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjrpt_patient_audit]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmjrpt_patient_audit]
GO

-- Create Procedure [dbo].[jmjrpt_patient_audit]
Print 'Create Procedure [dbo].[jmjrpt_patient_audit]'
GO
SET ANSI_NULLS ON
