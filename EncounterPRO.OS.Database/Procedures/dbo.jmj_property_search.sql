...
-- Drop Procedure [dbo].[jmj_property_search]
Print 'Drop Procedure [dbo].[jmj_property_search]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmj_property_search]') AND [type]='P'))
DROP PROCEDURE [dbo].[jmj_property_search]
GO

-- Create Procedure [dbo].[jmj_property_search]
Print 'Create Procedure [dbo].[jmj_property_search]'
GO
SET ANSI_NULLS ON
