...
-- Drop Procedure [dbo].[sp_get_letter_count]
Print 'Drop Procedure [dbo].[sp_get_letter_count]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_letter_count]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_letter_count]
GO

-- Create Procedure [dbo].[sp_get_letter_count]
Print 'Create Procedure [dbo].[sp_get_letter_count]'
GO
SET ANSI_NULLS ON
