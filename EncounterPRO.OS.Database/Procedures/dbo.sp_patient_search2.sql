...
-- Drop Procedure [dbo].[sp_patient_search2]
Print 'Drop Procedure [dbo].[sp_patient_search2]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_patient_search2]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_patient_search2]
GO

-- Create Procedure [dbo].[sp_patient_search2]
Print 'Create Procedure [dbo].[sp_patient_search2]'
GO
SET ANSI_NULLS ON
