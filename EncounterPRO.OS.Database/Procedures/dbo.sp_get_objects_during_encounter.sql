...
-- Drop Procedure [dbo].[sp_get_objects_during_encounter]
Print 'Drop Procedure [dbo].[sp_get_objects_during_encounter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_get_objects_during_encounter]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_get_objects_during_encounter]
GO

-- Create Procedure [dbo].[sp_get_objects_during_encounter]
Print 'Create Procedure [dbo].[sp_get_objects_during_encounter]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[sp_get_objects_during_encounter]
	TO [cprsystem]
GO
