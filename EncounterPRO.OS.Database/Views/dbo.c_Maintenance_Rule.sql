...
-- Drop View [dbo].[c_Maintenance_Rule]
Print 'Drop View [dbo].[c_Maintenance_Rule]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Rule]') AND [type]='V'))
DROP VIEW [dbo].[c_Maintenance_Rule]
GO
-- Create View [dbo].[c_Maintenance_Rule]
Print 'Create View [dbo].[c_Maintenance_Rule]'
GO
SET ANSI_NULLS OFF
