...
-- Drop View [dbo].[v_Compatible_Context_Object]
Print 'Drop View [dbo].[v_Compatible_Context_Object]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[v_Compatible_Context_Object]') AND [type]='V'))
DROP VIEW [dbo].[v_Compatible_Context_Object]
GO
-- Create View [dbo].[v_Compatible_Context_Object]
Print 'Create View [dbo].[v_Compatible_Context_Object]'
GO
SET ANSI_NULLS ON
