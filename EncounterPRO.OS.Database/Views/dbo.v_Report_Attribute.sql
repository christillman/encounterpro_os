...
-- Drop View [dbo].[v_Report_Attribute]
Print 'Drop View [dbo].[v_Report_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[v_Report_Attribute]') AND [type]='V'))
DROP VIEW [dbo].[v_Report_Attribute]
GO
-- Create View [dbo].[v_Report_Attribute]
Print 'Create View [dbo].[v_Report_Attribute]'
GO
SET ANSI_NULLS ON
