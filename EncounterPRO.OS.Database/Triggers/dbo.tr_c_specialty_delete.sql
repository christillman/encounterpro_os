...
-- Drop Trigger [dbo].[tr_c_specialty_delete]
Print 'Drop Trigger [dbo].[tr_c_specialty_delete]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_c_specialty_delete]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_c_specialty_delete]
GO

-- Create Trigger [dbo].[tr_c_specialty_delete]
Print 'Create Trigger [dbo].[tr_c_specialty_delete]'
GO
SET ANSI_NULLS ON
