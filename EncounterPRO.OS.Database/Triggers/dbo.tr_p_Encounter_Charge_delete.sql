...
-- Drop Trigger [dbo].[tr_p_Encounter_Charge_delete]
Print 'Drop Trigger [dbo].[tr_p_Encounter_Charge_delete]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_p_Encounter_Charge_delete]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_p_Encounter_Charge_delete]
GO

-- Create Trigger [dbo].[tr_p_Encounter_Charge_delete]
Print 'Create Trigger [dbo].[tr_p_Encounter_Charge_delete]'
GO
SET ANSI_NULLS ON
