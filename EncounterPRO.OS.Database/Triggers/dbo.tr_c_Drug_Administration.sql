...
-- Drop Trigger [dbo].[tr_c_Drug_Administration]
Print 'Drop Trigger [dbo].[tr_c_Drug_Administration]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_c_Drug_Administration]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_c_Drug_Administration]
GO

-- Create Trigger [dbo].[tr_c_Drug_Administration]
Print 'Create Trigger [dbo].[tr_c_Drug_Administration]'
GO
SET ANSI_NULLS ON
