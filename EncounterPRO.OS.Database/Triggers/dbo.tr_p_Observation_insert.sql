...
-- Drop Trigger [dbo].[tr_p_Observation_insert]
Print 'Drop Trigger [dbo].[tr_p_Observation_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_p_Observation_insert]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_p_Observation_insert]
GO

-- Create Trigger [dbo].[tr_p_Observation_insert]
Print 'Create Trigger [dbo].[tr_p_Observation_insert]'
GO
SET ANSI_NULLS ON
