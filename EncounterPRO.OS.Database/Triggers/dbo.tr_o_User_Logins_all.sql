...
-- Drop Trigger [dbo].[tr_o_User_Logins_all]
Print 'Drop Trigger [dbo].[tr_o_User_Logins_all]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_o_User_Logins_all]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_o_User_Logins_all]
GO

-- Create Trigger [dbo].[tr_o_User_Logins_all]
Print 'Create Trigger [dbo].[tr_o_User_Logins_all]'
GO
SET ANSI_NULLS ON
