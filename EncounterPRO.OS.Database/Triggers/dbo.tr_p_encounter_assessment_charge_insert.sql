...
-- Drop Trigger [dbo].[tr_p_encounter_assessment_charge_insert]
Print 'Drop Trigger [dbo].[tr_p_encounter_assessment_charge_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_p_encounter_assessment_charge_insert]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_p_encounter_assessment_charge_insert]
GO

-- Create Trigger [dbo].[tr_p_encounter_assessment_charge_insert]
Print 'Create Trigger [dbo].[tr_p_encounter_assessment_charge_insert]'
GO
SET ANSI_NULLS ON
