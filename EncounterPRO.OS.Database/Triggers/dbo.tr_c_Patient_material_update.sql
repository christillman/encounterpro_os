...
-- Drop Trigger [dbo].[tr_c_Patient_material_update]
Print 'Drop Trigger [dbo].[tr_c_Patient_material_update]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_c_Patient_material_update]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_c_Patient_material_update]
GO

-- Create Trigger [dbo].[tr_c_Patient_material_update]
Print 'Create Trigger [dbo].[tr_c_Patient_material_update]'
GO
SET ANSI_NULLS ON
