...
-- Drop Trigger [dbo].[tr_p_assessment_treatment_delete]
Print 'Drop Trigger [dbo].[tr_p_assessment_treatment_delete]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_p_assessment_treatment_delete]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_p_assessment_treatment_delete]
GO

-- Create Trigger [dbo].[tr_p_assessment_treatment_delete]
Print 'Create Trigger [dbo].[tr_p_assessment_treatment_delete]'
GO
SET ANSI_NULLS ON
