...
-- Drop Trigger [dbo].[b_Appointment_Type_insert_update]
Print 'Drop Trigger [dbo].[b_Appointment_Type_insert_update]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[b_Appointment_Type_insert_update]') AND [type]='TR'))
DROP TRIGGER [dbo].[b_Appointment_Type_insert_update]
GO

-- Create Trigger [dbo].[b_Appointment_Type_insert_update]
Print 'Create Trigger [dbo].[b_Appointment_Type_insert_update]'
GO
SET ANSI_NULLS ON
