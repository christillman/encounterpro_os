...
-- Drop Trigger [dbo].[tr_o_computer_printer_insert]
Print 'Drop Trigger [dbo].[tr_o_computer_printer_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_o_computer_printer_insert]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_o_computer_printer_insert]
GO

-- Create Trigger [dbo].[tr_o_computer_printer_insert]
Print 'Create Trigger [dbo].[tr_o_computer_printer_insert]'
GO
SET ANSI_NULLS ON
