...
-- Drop Trigger [dbo].[tr_c_Database_Script_insert]
Print 'Drop Trigger [dbo].[tr_c_Database_Script_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_c_Database_Script_insert]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_c_Database_Script_insert]
GO

-- Create Trigger [dbo].[tr_c_Database_Script_insert]
Print 'Create Trigger [dbo].[tr_c_Database_Script_insert]'
GO
SET ANSI_NULLS ON
