...
-- Drop Trigger [dbo].[tr_u_Ass_treat_def_insert]
Print 'Drop Trigger [dbo].[tr_u_Ass_treat_def_insert]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[tr_u_Ass_treat_def_insert]') AND [type]='TR'))
DROP TRIGGER [dbo].[tr_u_Ass_treat_def_insert]
GO

-- Create Trigger [dbo].[tr_u_Ass_treat_def_insert]
Print 'Create Trigger [dbo].[tr_u_Ass_treat_def_insert]'
GO
SET ANSI_NULLS ON
