...
-- Drop Table [dbo].[r_Assessment_Treatment_Efficacy]
Print 'Drop Table [dbo].[r_Assessment_Treatment_Efficacy]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[r_Assessment_Treatment_Efficacy]') AND [type]='U'))
DROP TABLE [dbo].[r_Assessment_Treatment_Efficacy]
GO
-- Create Table [dbo].[r_Assessment_Treatment_Efficacy]
Print 'Create Table [dbo].[r_Assessment_Treatment_Efficacy]'
GO
SET ANSI_NULLS OFF
...
ALTER TABLE [dbo].[r_Assessment_Treatment_Efficacy]
	ADD
	CONSTRAINT [PK_r_Assessment_Treatment_efficacy]
	PRIMARY KEY
	CLUSTERED
	([assessment_id], [treatment_type], [treatment_key])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
