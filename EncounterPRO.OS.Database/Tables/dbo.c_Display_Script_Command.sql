...
-- Drop Table [dbo].[c_Display_Script_Command]
Print 'Drop Table [dbo].[c_Display_Script_Command]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Display_Script_Command]') AND [type]='U'))
DROP TABLE [dbo].[c_Display_Script_Command]
GO
-- Create Table [dbo].[c_Display_Script_Command]
Print 'Create Table [dbo].[c_Display_Script_Command]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Display_Script_Command]
	ADD
	CONSTRAINT [PK_c_Display_Script_Command]
	PRIMARY KEY
	CLUSTERED
	([display_script_id], [display_command_id])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Display_Script_Command]
	ADD
	CONSTRAINT [DF_c_Display_Script_cmd_id]
