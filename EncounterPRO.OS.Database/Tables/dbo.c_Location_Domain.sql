...
-- Drop Table [dbo].[c_Location_Domain]
Print 'Drop Table [dbo].[c_Location_Domain]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Location_Domain]') AND [type]='U'))
DROP TABLE [dbo].[c_Location_Domain]
GO
-- Create Table [dbo].[c_Location_Domain]
Print 'Create Table [dbo].[c_Location_Domain]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Location_Domain]
	ADD
	CONSTRAINT [PK_c_Location_Domain_1__10]
	PRIMARY KEY
	CLUSTERED
	([location_domain])
	WITH FILLFACTOR=90
...
ALTER TABLE [dbo].[c_Location_Domain]
	ADD
	CONSTRAINT [DF__c_Locatio__owner__542718FA]
	DEFAULT ((-1)) FOR [owner_id]
GO
ALTER TABLE [dbo].[c_Location_Domain]
	ADD
	CONSTRAINT [DF__c_Locatio__statu__6FCF336F]
