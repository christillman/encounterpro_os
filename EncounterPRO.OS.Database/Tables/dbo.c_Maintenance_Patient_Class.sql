...
-- Drop Table [dbo].[c_Maintenance_Patient_Class]
Print 'Drop Table [dbo].[c_Maintenance_Patient_Class]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Patient_Class]') AND [type]='U'))
DROP TABLE [dbo].[c_Maintenance_Patient_Class]
GO
-- Create Table [dbo].[c_Maintenance_Patient_Class]
Print 'Create Table [dbo].[c_Maintenance_Patient_Class]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Maintenance_Patient_Class]
	ADD
	CONSTRAINT [PK_c_Maintenance_Patient_Class_40]
	PRIMARY KEY
	CLUSTERED
	([maintenance_rule_id])
	WITH FILLFACTOR=80
...
ALTER TABLE [dbo].[c_Maintenance_Patient_Class]
	ADD
	CONSTRAINT [DF__c_Maint_Patient_Class_rule_type]
	DEFAULT ('Rule') FOR [maintenance_rule_type]
GO
ALTER TABLE [dbo].[c_Maintenance_Patient_Class]
	ADD
	CONSTRAINT [DF__c_Maintenance_Patient_Class_id_]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Maintenance_Patient_Class]
	ADD
	CONSTRAINT [DF__c_Maintenance_Patient_Class_last_upd_]
	DEFAULT (dbo.get_client_datetime()) FOR [last_updated]
GO
ALTER TABLE [dbo].[c_Maintenance_Patient_Class]
	ADD
	CONSTRAINT [DF__c_Maintenance_Patient_Class_owner_id_]
