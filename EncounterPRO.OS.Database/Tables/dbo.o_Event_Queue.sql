...
-- Drop Table [dbo].[o_Event_Queue]
Print 'Drop Table [dbo].[o_Event_Queue]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Event_Queue]') AND [type]='U'))
DROP TABLE [dbo].[o_Event_Queue]
GO
-- Create Table [dbo].[o_Event_Queue]
Print 'Create Table [dbo].[o_Event_Queue]'
GO
SET ANSI_NULLS ON
