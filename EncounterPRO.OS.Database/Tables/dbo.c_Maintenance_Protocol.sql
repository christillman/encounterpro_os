...
-- Drop Table [dbo].[c_Maintenance_Protocol]
Print 'Drop Table [dbo].[c_Maintenance_Protocol]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Protocol]') AND [type]='U'))
DROP TABLE [dbo].[c_Maintenance_Protocol]
GO
-- Create Table [dbo].[c_Maintenance_Protocol]
Print 'Create Table [dbo].[c_Maintenance_Protocol]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Maintenance_Protocol]
	ADD
	CONSTRAINT [PK_c_Maintenance_Protocol]
	PRIMARY KEY
	CLUSTERED
	([maintenance_rule_id], [protocol_sequence])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Maintenance_Protocol]
	ADD
