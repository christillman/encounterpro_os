...
-- Drop Table [dbo].[p_Patient_WP_Item_Attribute]
Print 'Drop Table [dbo].[p_Patient_WP_Item_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Patient_WP_Item_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[p_Patient_WP_Item_Attribute]
GO
-- Create Table [dbo].[p_Patient_WP_Item_Attribute]
Print 'Create Table [dbo].[p_Patient_WP_Item_Attribute]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_Patient_WP_Item_Attribute]
	ADD
	CONSTRAINT [PK_p_Patient_WP_Item_Attribute]
	PRIMARY KEY
	NONCLUSTERED
...
ALTER TABLE [dbo].[p_Patient_WP_Item_Attribute]
	ADD
	CONSTRAINT [DF__p_Patient_WP__id__3138400F]
...
CREATE NONCLUSTERED INDEX [idx_pt_wp_Item_ID_and_Attribute]
	...
	WITH ( PAD_INDEX = ON, FILLFACTOR = 85) ON [PRIMARY]
GO
