...
-- Drop Table [dbo].[c_Component_Log]
Print 'Drop Table [dbo].[c_Component_Log]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Component_Log]') AND [type]='U'))
DROP TABLE [dbo].[c_Component_Log]
GO
-- Create Table [dbo].[c_Component_Log]
Print 'Create Table [dbo].[c_Component_Log]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Component_Log]
	ADD
	CONSTRAINT [DF_c_Component_Log_created]
