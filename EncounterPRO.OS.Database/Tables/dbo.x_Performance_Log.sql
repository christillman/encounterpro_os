...
-- Drop Table [dbo].[x_Performance_Log]
Print 'Drop Table [dbo].[x_Performance_Log]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_Performance_Log]') AND [type]='U'))
DROP TABLE [dbo].[x_Performance_Log]
GO
-- Create Table [dbo].[x_Performance_Log]
Print 'Create Table [dbo].[x_Performance_Log]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_Performance_Log]
	ADD
	CONSTRAINT [PK_x_Performance_Log_21]
	PRIMARY KEY
	CLUSTERED
	([log_id])
	WITH FILLFACTOR=100
...
ALTER TABLE [dbo].[x_Performance_Log]
	ADD
	CONSTRAINT [DF__x_Performance_Log__id__6FD627B4]
