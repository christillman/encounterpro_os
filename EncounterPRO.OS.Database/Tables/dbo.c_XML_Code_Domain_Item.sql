...
-- Drop Table [dbo].[c_XML_Code_Domain_Item]
Print 'Drop Table [dbo].[c_XML_Code_Domain_Item]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_XML_Code_Domain_Item]') AND [type]='U'))
DROP TABLE [dbo].[c_XML_Code_Domain_Item]
GO
-- Create Table [dbo].[c_XML_Code_Domain_Item]
Print 'Create Table [dbo].[c_XML_Code_Domain_Item]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_XML_Code_Domain_Item]
	ADD
	CONSTRAINT [PK_c_XML_Code_Domain_Item_40]
	PRIMARY KEY
	NONCLUSTERED
	([owner_id], [code_domain], [code_domain_item_id])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_XML_Code_Domain_Item]
	ADD
	CONSTRAINT [DF_c_XML_Code_Domain_cdi_owner_id]
	DEFAULT ([dbo].[fn_customer_id]()) FOR [code_domain_item_owner_id]
GO
ALTER TABLE [dbo].[c_XML_Code_Domain_Item]
	ADD
...
ALTER TABLE [dbo].[c_XML_Code_Domain_Item]
	ADD
	CONSTRAINT [DF_c_XML_Code_Domain_Item_id]
