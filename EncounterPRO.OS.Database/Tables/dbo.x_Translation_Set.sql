...
-- Drop Table [dbo].[x_Translation_Set]
Print 'Drop Table [dbo].[x_Translation_Set]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_Translation_Set]') AND [type]='U'))
DROP TABLE [dbo].[x_Translation_Set]
GO
-- Create Table [dbo].[x_Translation_Set]
Print 'Create Table [dbo].[x_Translation_Set]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_Translation_Set]
	ADD
	CONSTRAINT [PK_x_Translation_Set_40]
	PRIMARY KEY
	NONCLUSTERED
	([translation_set])
	WITH FILLFACTOR=80
...
ALTER TABLE [dbo].[x_Translation_Set]
	ADD
	CONSTRAINT [DF_x_trans_set_created_40]
	DEFAULT (dbo.get_client_datetime()) FOR [created]
GO
ALTER TABLE [dbo].[x_Translation_Set]
	ADD
	CONSTRAINT [DF_x_Trans_set_id_40]
