...
-- Drop Table [dbo].[o_Event_Component_Trigger]
Print 'Drop Table [dbo].[o_Event_Component_Trigger]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Event_Component_Trigger]') AND [type]='U'))
DROP TABLE [dbo].[o_Event_Component_Trigger]
GO
-- Create Table [dbo].[o_Event_Component_Trigger]
Print 'Create Table [dbo].[o_Event_Component_Trigger]'
GO
SET ANSI_NULLS ON
