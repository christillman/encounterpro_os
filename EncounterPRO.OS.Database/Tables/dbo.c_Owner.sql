...
-- Drop Table [dbo].[c_Owner]
Print 'Drop Table [dbo].[c_Owner]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Owner]') AND [type]='U'))
DROP TABLE [dbo].[c_Owner]
GO
-- Create Table [dbo].[c_Owner]
Print 'Create Table [dbo].[c_Owner]'
GO
SET ANSI_NULLS ON
