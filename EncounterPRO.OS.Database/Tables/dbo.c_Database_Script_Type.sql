...
-- Drop Table [dbo].[c_Database_Script_Type]
Print 'Drop Table [dbo].[c_Database_Script_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Database_Script_Type]') AND [type]='U'))
DROP TABLE [dbo].[c_Database_Script_Type]
GO
-- Create Table [dbo].[c_Database_Script_Type]
Print 'Create Table [dbo].[c_Database_Script_Type]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Database_Script_Type]
	ADD
	CONSTRAINT [PK_c_Database_Script_Type]
	PRIMARY KEY
	CLUSTERED
	([script_type])
	ON [PRIMARY]
