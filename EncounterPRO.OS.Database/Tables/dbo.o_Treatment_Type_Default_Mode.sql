...
-- Drop Table [dbo].[o_Treatment_Type_Default_Mode]
Print 'Drop Table [dbo].[o_Treatment_Type_Default_Mode]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Treatment_Type_Default_Mode]') AND [type]='U'))
DROP TABLE [dbo].[o_Treatment_Type_Default_Mode]
GO
-- Create Table [dbo].[o_Treatment_Type_Default_Mode]
Print 'Create Table [dbo].[o_Treatment_Type_Default_Mode]'
GO
SET ANSI_NULLS OFF
...
ALTER TABLE [dbo].[o_Treatment_Type_Default_Mode]
	ADD
	CONSTRAINT [PK_o_Treatment_Type_Def_Mode]
	PRIMARY KEY
	CLUSTERED
	([treatment_type], [treatment_key], [office_id])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[o_Treatment_Type_Default_Mode]
