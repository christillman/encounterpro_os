...
-- Drop Table [dbo].[c_XML_Class]
Print 'Drop Table [dbo].[c_XML_Class]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_XML_Class]') AND [type]='U'))
DROP TABLE [dbo].[c_XML_Class]
GO
-- Create Table [dbo].[c_XML_Class]
Print 'Create Table [dbo].[c_XML_Class]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_XML_Class]
	ADD
	CONSTRAINT [DF_c_XML_Class_created]
	DEFAULT (dbo.get_client_datetime()) FOR [created]
GO
ALTER TABLE [dbo].[c_XML_Class]
	ADD
	CONSTRAINT [DF_c_XML_Class_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_XML_Class]
	ADD
	CONSTRAINT [DF_c_XML_Class_last_updated]
	DEFAULT (dbo.get_client_datetime()) FOR [last_updated]
GO
ALTER TABLE [dbo].[c_XML_Class]
	ADD
	CONSTRAINT [DF_c_XML_Class_owner_id]
	DEFAULT ([dbo].[fn_customer_id]()) FOR [owner_id]
GO
GRANT DELETE ON [dbo].[c_XML_Class] TO [cprsystem]
GO
GRANT INSERT ON [dbo].[c_XML_Class] TO [cprsystem]
GO
GRANT SELECT ON [dbo].[c_XML_Class] TO [cprsystem]
GO
GRANT UPDATE ON [dbo].[c_XML_Class] TO [cprsystem]
GO
ALTER TABLE [dbo].[c_XML_Class] SET (LOCK_ESCALATION = TABLE)
GO
