...
-- Drop Table [dbo].[c_Report_Attribute]
Print 'Drop Table [dbo].[c_Report_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Report_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[c_Report_Attribute]
GO
-- Create Table [dbo].[c_Report_Attribute]
Print 'Create Table [dbo].[c_Report_Attribute]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Report_Attribute]
	ADD
	CONSTRAINT [PK_c_Report_Attribute_40]
	PRIMARY KEY
	CLUSTERED
	([report_id], [attribute_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Report_Attribute]
	ADD
	CONSTRAINT [DF_c_Report_Attribute_component_attribute]
