...
-- Drop Table [dbo].[c_Procedure_Extra_Charge]
Print 'Drop Table [dbo].[c_Procedure_Extra_Charge]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Procedure_Extra_Charge]') AND [type]='U'))
DROP TABLE [dbo].[c_Procedure_Extra_Charge]
GO
-- Create Table [dbo].[c_Procedure_Extra_Charge]
Print 'Create Table [dbo].[c_Procedure_Extra_Charge]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Procedure_Extra_Charge]
	ADD
	CONSTRAINT [PK_c_Procedure_Extra_Charge_35]
	PRIMARY KEY
	CLUSTERED
	([procedure_id], [extra_procedure_sequence])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
GRANT DELETE
