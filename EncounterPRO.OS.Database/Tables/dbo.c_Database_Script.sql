...
-- Drop Table [dbo].[c_Database_Script]
Print 'Drop Table [dbo].[c_Database_Script]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Database_Script]') AND [type]='U'))
DROP TABLE [dbo].[c_Database_Script]
GO
-- Create Table [dbo].[c_Database_Script]
Print 'Create Table [dbo].[c_Database_Script]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Database_Script]
	ADD
	CONSTRAINT [PK_c_Database_Script]
	PRIMARY KEY
	CLUSTERED
	([script_id])
	WITH FILLFACTOR=100
...
ALTER TABLE [dbo].[c_Database_Script]
	ADD
	CONSTRAINT [DF_c_db_allow_users]
	DEFAULT ((1)) FOR [allow_users]
GO
ALTER TABLE [dbo].[c_Database_Script]
	ADD
	CONSTRAINT [DF_c_db_script_created]
	DEFAULT (dbo.get_client_datetime()) FOR [created]
GO
ALTER TABLE [dbo].[c_Database_Script]
	ADD
	CONSTRAINT [DF_c_db_script_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Database_Script]
	ADD
	CONSTRAINT [DF_c_db_script_status]
