...
-- Drop Table [dbo].[o_Rooms]
Print 'Drop Table [dbo].[o_Rooms]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Rooms]') AND [type]='U'))
DROP TABLE [dbo].[o_Rooms]
GO
-- Create Table [dbo].[o_Rooms]
Print 'Create Table [dbo].[o_Rooms]'
GO
SET ANSI_NULLS OFF
