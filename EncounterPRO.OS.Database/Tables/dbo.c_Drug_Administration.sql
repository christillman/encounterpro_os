...
ALTER TABLE [dbo].[c_Drug_Administration]
	ADD
	CONSTRAINT [DF_c_Drug_Administration_id]
	DEFAULT (newid()) FOR [id]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_drugadmin_id]
	ON [dbo].[c_Drug_Administration] ([id]) ON [PRIMARY]
GO
GRANT DELETE
	ON [dbo].[c_Drug_Administration]
	TO [cprsystem]
GO
GRANT INSERT
	ON [dbo].[c_Drug_Administration]
