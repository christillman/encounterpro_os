...
-- Drop Table [dbo].[c_Privilege]
Print 'Drop Table [dbo].[c_Privilege]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Privilege]') AND [type]='U'))
DROP TABLE [dbo].[c_Privilege]
GO
-- Create Table [dbo].[c_Privilege]
Print 'Create Table [dbo].[c_Privilege]'
GO
SET ANSI_NULLS OFF
