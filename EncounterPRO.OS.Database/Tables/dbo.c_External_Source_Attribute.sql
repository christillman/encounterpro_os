...
-- Drop Table [dbo].[c_External_Source_Attribute]
Print 'Drop Table [dbo].[c_External_Source_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_External_Source_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[c_External_Source_Attribute]
GO
-- Create Table [dbo].[c_External_Source_Attribute]
Print 'Create Table [dbo].[c_External_Source_Attribute]'
GO
SET ANSI_NULLS OFF
...
ALTER TABLE [dbo].[c_External_Source_Attribute]
	ADD
	CONSTRAINT [PK_c_Ext_Source_Attribute_40]
	PRIMARY KEY
	CLUSTERED
