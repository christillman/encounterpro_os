...
-- Drop Table [dbo].[p_Object_Security]
Print 'Drop Table [dbo].[p_Object_Security]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Object_Security]') AND [type]='U'))
DROP TABLE [dbo].[p_Object_Security]
GO
-- Create Table [dbo].[p_Object_Security]
Print 'Create Table [dbo].[p_Object_Security]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_Object_Security]
	ADD
	CONSTRAINT [PK_p_Object_Security_40]
	PRIMARY KEY
	CLUSTERED
	([cpr_id], [object_key], [context_object])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[p_Object_Security]
