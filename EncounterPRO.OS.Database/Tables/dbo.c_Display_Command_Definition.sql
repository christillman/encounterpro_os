...
-- Drop Table [dbo].[c_Display_Command_Definition]
Print 'Drop Table [dbo].[c_Display_Command_Definition]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Display_Command_Definition]') AND [type]='U'))
DROP TABLE [dbo].[c_Display_Command_Definition]
GO
-- Create Table [dbo].[c_Display_Command_Definition]
Print 'Create Table [dbo].[c_Display_Command_Definition]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Display_Command_Definition]
	ADD
	CONSTRAINT [PK_c_report_command_40]
	PRIMARY KEY
	CLUSTERED
	([script_type], [context_object], [display_command])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Display_Command_Definition]
	ADD
	CONSTRAINT [DF_c_Display_Script_cmd_def_id]
...
ALTER TABLE [dbo].[c_Display_Command_Definition]
	ADD
	CONSTRAINT [DF_c_Display_Script_cmd_script_type]
