...
-- Drop Table [dbo].[x_encounterpro_Arrived]
Print 'Drop Table [dbo].[x_encounterpro_Arrived]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_encounterpro_Arrived]') AND [type]='U'))
DROP TABLE [dbo].[x_encounterpro_Arrived]
GO
-- Create Table [dbo].[x_encounterpro_Arrived]
Print 'Create Table [dbo].[x_encounterpro_Arrived]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_encounterpro_Arrived]
	ADD
	CONSTRAINT [PK_x_encounterpro_Arrived]
	PRIMARY KEY
	CLUSTERED
	([message_id])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
GRANT DELETE ON [dbo].[x_encounterpro_Arrived] TO [cprsystem]
GO
GRANT INSERT ON [dbo].[x_encounterpro_Arrived] TO [cprsystem]
GO
GRANT REFERENCES ON [dbo].[x_encounterpro_Arrived] TO [cprsystem]
GO
GRANT SELECT ON [dbo].[x_encounterpro_Arrived] TO [cprsystem]
GO
GRANT UPDATE ON [dbo].[x_encounterpro_Arrived] TO [cprsystem]
GO
ALTER TABLE [dbo].[x_encounterpro_Arrived] SET (LOCK_ESCALATION = TABLE)
GO
