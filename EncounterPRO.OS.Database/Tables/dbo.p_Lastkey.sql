...
-- Drop Table [dbo].[p_Lastkey]
Print 'Drop Table [dbo].[p_Lastkey]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Lastkey]') AND [type]='U'))
DROP TABLE [dbo].[p_Lastkey]
GO
-- Create Table [dbo].[p_Lastkey]
Print 'Create Table [dbo].[p_Lastkey]'
GO
SET ANSI_NULLS ON
