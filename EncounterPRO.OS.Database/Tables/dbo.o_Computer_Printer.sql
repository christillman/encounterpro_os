...
-- Drop Table [dbo].[o_Computer_Printer]
Print 'Drop Table [dbo].[o_Computer_Printer]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Computer_Printer]') AND [type]='U'))
DROP TABLE [dbo].[o_Computer_Printer]
GO
-- Create Table [dbo].[o_Computer_Printer]
Print 'Create Table [dbo].[o_Computer_Printer]'
GO
SET ANSI_NULLS ON
...
CREATE TABLE [dbo].[o_Computer_Printer] (
		...
		[fax_flag]             [char](1) NOT NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[o_Computer_Printer]
	ADD
	CONSTRAINT [PK_o_Computer_Printer_40]
	PRIMARY KEY
	CLUSTERED
	([computer_id], [printer_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[o_Computer_Printer]
	ADD
	CONSTRAINT [DF__o_Compute__fax_f__65608AA7]
	DEFAULT ('N') FOR [fax_flag]
GO
ALTER TABLE [dbo].[o_Computer_Printer]
	ADD
