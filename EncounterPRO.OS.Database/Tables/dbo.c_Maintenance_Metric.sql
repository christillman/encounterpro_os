...
-- Drop Table [dbo].[c_Maintenance_Metric]
Print 'Drop Table [dbo].[c_Maintenance_Metric]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Metric]') AND [type]='U'))
DROP TABLE [dbo].[c_Maintenance_Metric]
GO
-- Create Table [dbo].[c_Maintenance_Metric]
Print 'Create Table [dbo].[c_Maintenance_Metric]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Maintenance_Metric]
	ADD
	CONSTRAINT [PK_c_Maintenance_Metric]
	PRIMARY KEY
	CLUSTERED
	([maintenance_rule_id], [metric_sequence])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Maintenance_Metric]
	ADD
