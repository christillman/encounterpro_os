...
-- Drop Table [dbo].[x_External_Application_Message]
Print 'Drop Table [dbo].[x_External_Application_Message]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_External_Application_Message]') AND [type]='U'))
DROP TABLE [dbo].[x_External_Application_Message]
GO
-- Create Table [dbo].[x_External_Application_Message]
Print 'Create Table [dbo].[x_External_Application_Message]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_External_Application_Message]
	ADD
	CONSTRAINT [PK_x_External_Application_Message_40]
	PRIMARY KEY
	CLUSTERED
	([external_application_id], [message_type])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[x_External_Application_Message]
...
ALTER TABLE [dbo].[x_External_Application_Message]
	ADD
	CONSTRAINT [DF_x_ext_appl_message_id_40]
