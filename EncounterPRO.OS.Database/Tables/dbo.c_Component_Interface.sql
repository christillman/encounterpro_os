...
-- Drop Table [dbo].[c_Component_Interface]
Print 'Drop Table [dbo].[c_Component_Interface]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Component_Interface]') AND [type]='U'))
DROP TABLE [dbo].[c_Component_Interface]
GO
-- Create Table [dbo].[c_Component_Interface]
Print 'Create Table [dbo].[c_Component_Interface]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Component_Interface]
	ADD
	CONSTRAINT [PK_c_component_interface]
	PRIMARY KEY
	CLUSTERED
	([interfaceServiceId])
	ON [PRIMARY]
...
ALTER TABLE [dbo].[c_Component_Interface]
	ADD
	CONSTRAINT [DF_c_Component_Interface_id]
