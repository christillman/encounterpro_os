...
Print 'Drop Table [dbo].[c_Config_Object_Version_Dependency]'
...
Print 'Create Table [dbo].[c_Config_Object_Version_Dependency]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Config_Object_Version_Dependency]
	ADD
	CONSTRAINT [PK_c_Config_Object_Version_Dependency]
	PRIMARY KEY
	CLUSTERED
...
ALTER TABLE [dbo].[c_Config_Object_Version_Dependency]
	ADD
	CONSTRAINT [DF_c_Config_Object_Version_Dep_or_later]
	DEFAULT ((1)) FOR [or_later]
GO
ALTER TABLE [dbo].[c_Config_Object_Version_Dependency]
	ADD
	CONSTRAINT [DF_c_Config_Object_Version_Dep_status]
	DEFAULT ('OK') FOR [status]
GO
ALTER TABLE [dbo].[c_Config_Object_Version_Dependency] SET (LOCK_ESCALATION = TABLE)
GO
