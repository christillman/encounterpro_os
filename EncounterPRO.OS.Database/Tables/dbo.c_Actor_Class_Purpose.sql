...
-- Drop Table [dbo].[c_Actor_Class_Purpose]
Print 'Drop Table [dbo].[c_Actor_Class_Purpose]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Actor_Class_Purpose]') AND [type]='U'))
DROP TABLE [dbo].[c_Actor_Class_Purpose]
GO
-- Create Table [dbo].[c_Actor_Class_Purpose]
Print 'Create Table [dbo].[c_Actor_Class_Purpose]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Actor_Class_Purpose]
	ADD
	CONSTRAINT [PK_c_Actor_Class_Purpose]
	PRIMARY KEY
	CLUSTERED
	([purpose], [actor_class])
	ON [PRIMARY]
