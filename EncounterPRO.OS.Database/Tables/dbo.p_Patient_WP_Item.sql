...
GRANT DELETE ON [dbo].[p_Patient_WP_Item] TO [cprsystem]
GO
GRANT INSERT ON [dbo].[p_Patient_WP_Item] TO [cprsystem]
GO
GRANT REFERENCES ON [dbo].[p_Patient_WP_Item] TO [cprsystem]
GO
GRANT SELECT ON [dbo].[p_Patient_WP_Item] TO [cprsystem]
GO
GRANT UPDATE ON [dbo].[p_Patient_WP_Item] TO [cprsystem]
GO
