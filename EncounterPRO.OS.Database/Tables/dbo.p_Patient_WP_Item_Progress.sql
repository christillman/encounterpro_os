...
-- Drop Table [dbo].[p_Patient_WP_Item_Progress]
Print 'Drop Table [dbo].[p_Patient_WP_Item_Progress]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Patient_WP_Item_Progress]') AND [type]='U'))
DROP TABLE [dbo].[p_Patient_WP_Item_Progress]
GO
-- Create Table [dbo].[p_Patient_WP_Item_Progress]
Print 'Create Table [dbo].[p_Patient_WP_Item_Progress]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_Patient_WP_Item_Progress]
	ADD
	CONSTRAINT [PK_p_Patient_WP_Item_Progress]
	PRIMARY KEY
	NONCLUSTERED
...
ALTER TABLE [dbo].[p_Patient_WP_Item_Progress]
	ADD
	CONSTRAINT [DF__p_Patient_WP__id__33208881]
