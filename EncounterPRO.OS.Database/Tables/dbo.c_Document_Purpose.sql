...
-- Drop Table [dbo].[c_Document_Purpose]
Print 'Drop Table [dbo].[c_Document_Purpose]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Document_Purpose]') AND [type]='U'))
DROP TABLE [dbo].[c_Document_Purpose]
GO
-- Create Table [dbo].[c_Document_Purpose]
Print 'Create Table [dbo].[c_Document_Purpose]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Document_Purpose]
	ADD
	CONSTRAINT [PK_c_Document_Purpose]
	PRIMARY KEY
	CLUSTERED
	([purpose])
	WITH FILLFACTOR=70
...
ALTER TABLE [dbo].[c_Document_Purpose]
	ADD
	CONSTRAINT [DF_c_Document_Purpose_created]
	DEFAULT (dbo.get_client_datetime()) FOR [created]
GO
ALTER TABLE [dbo].[c_Document_Purpose]
	ADD
	CONSTRAINT [DF_c_Document_Purpose_last_updated]
