...
-- Drop Table [dbo].[c_Risk_Factor]
Print 'Drop Table [dbo].[c_Risk_Factor]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Risk_Factor]') AND [type]='U'))
DROP TABLE [dbo].[c_Risk_Factor]
GO
-- Create Table [dbo].[c_Risk_Factor]
Print 'Create Table [dbo].[c_Risk_Factor]'
GO
SET ANSI_NULLS ON
