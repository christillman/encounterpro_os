...
-- Drop Table [dbo].[c_Qualifier]
Print 'Drop Table [dbo].[c_Qualifier]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Qualifier]') AND [type]='U'))
DROP TABLE [dbo].[c_Qualifier]
GO
-- Create Table [dbo].[c_Qualifier]
Print 'Create Table [dbo].[c_Qualifier]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Qualifier]
	ADD
	CONSTRAINT [PK_c_Qualifier_21]
	PRIMARY KEY
	CLUSTERED
	([qualifier_domain_id], [qualifier_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Qualifier]
