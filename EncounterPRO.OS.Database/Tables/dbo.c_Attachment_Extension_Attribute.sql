...
-- Drop Table [dbo].[c_Attachment_Extension_Attribute]
Print 'Drop Table [dbo].[c_Attachment_Extension_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Attachment_Extension_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[c_Attachment_Extension_Attribute]
GO
-- Create Table [dbo].[c_Attachment_Extension_Attribute]
Print 'Create Table [dbo].[c_Attachment_Extension_Attribute]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Attachment_Extension_Attribute]
	ADD
	CONSTRAINT [PK_c_Attachment_Extension_Attribute_40]
	PRIMARY KEY
	CLUSTERED
	([extension], [attribute_sequence])
	WITH FILLFACTOR=70
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Attachment_Extension_Attribute]
