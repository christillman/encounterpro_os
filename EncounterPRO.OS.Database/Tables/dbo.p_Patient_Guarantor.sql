...
-- Drop Table [dbo].[p_Patient_Guarantor]
Print 'Drop Table [dbo].[p_Patient_Guarantor]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Patient_Guarantor]') AND [type]='U'))
DROP TABLE [dbo].[p_Patient_Guarantor]
GO
-- Create Table [dbo].[p_Patient_Guarantor]
Print 'Create Table [dbo].[p_Patient_Guarantor]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_Patient_Guarantor]
	ADD
	CONSTRAINT [PK_p_Patient_Guarantor_21]
	PRIMARY KEY
	CLUSTERED
	([cpr_id], [guarantor_sequence])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[p_Patient_Guarantor]
...
ALTER TABLE [dbo].[p_Patient_Guarantor]
	ADD
	CONSTRAINT [DF__p_Patient__statu__4BA2E8DF]
