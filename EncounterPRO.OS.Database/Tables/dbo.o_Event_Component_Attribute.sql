...
-- Drop Table [dbo].[o_Event_Component_Attribute]
Print 'Drop Table [dbo].[o_Event_Component_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Event_Component_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[o_Event_Component_Attribute]
GO
-- Create Table [dbo].[o_Event_Component_Attribute]
Print 'Create Table [dbo].[o_Event_Component_Attribute]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[o_Event_Component_Attribute]
	ADD
	CONSTRAINT [PK___3__11]
	PRIMARY KEY
	CLUSTERED
	([event], [component_sequence], [attribute_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
