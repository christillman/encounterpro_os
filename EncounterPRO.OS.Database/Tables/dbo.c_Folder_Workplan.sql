...
-- Drop Table [dbo].[c_Folder_Workplan]
Print 'Drop Table [dbo].[c_Folder_Workplan]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Folder_Workplan]') AND [type]='U'))
DROP TABLE [dbo].[c_Folder_Workplan]
GO
-- Create Table [dbo].[c_Folder_Workplan]
Print 'Create Table [dbo].[c_Folder_Workplan]'
GO
SET ANSI_NULLS ON
