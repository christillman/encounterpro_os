...
-- Drop Table [dbo].[c_Maintenance_Procedure]
Print 'Drop Table [dbo].[c_Maintenance_Procedure]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Procedure]') AND [type]='U'))
DROP TABLE [dbo].[c_Maintenance_Procedure]
GO
-- Create Table [dbo].[c_Maintenance_Procedure]
Print 'Create Table [dbo].[c_Maintenance_Procedure]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Maintenance_Procedure]
	ADD
	CONSTRAINT [PK_c_Maintenance_Procedure_01]
	PRIMARY KEY
	CLUSTERED
	([maintenance_rule_id], [procedure_id])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Maintenance_Procedure]
