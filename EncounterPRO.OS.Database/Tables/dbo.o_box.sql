...
-- Drop Table [dbo].[o_box]
Print 'Drop Table [dbo].[o_box]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_box]') AND [type]='U'))
DROP TABLE [dbo].[o_box]
GO
-- Create Table [dbo].[o_box]
Print 'Create Table [dbo].[o_box]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[o_box]
	ADD
	CONSTRAINT [DF_o_box_box_open_date]
	DEFAULT (dbo.get_client_datetime()) FOR [box_open_date]
GO
ALTER TABLE [dbo].[o_box]
	ADD
	CONSTRAINT [DF_o_box_box_type]
	DEFAULT ('LETTERS') FOR [box_type]
GO
ALTER TABLE [dbo].[o_box]
	ADD
