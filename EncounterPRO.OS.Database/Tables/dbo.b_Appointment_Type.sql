...
-- Drop Table [dbo].[b_Appointment_Type]
Print 'Drop Table [dbo].[b_Appointment_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[b_Appointment_Type]') AND [type]='U'))
DROP TABLE [dbo].[b_Appointment_Type]
GO
-- Create Table [dbo].[b_Appointment_Type]
Print 'Create Table [dbo].[b_Appointment_Type]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[b_Appointment_Type]
	ADD
	CONSTRAINT [PK___1__17]
	PRIMARY KEY
	CLUSTERED
	([appointment_type], [billing_domain])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[b_Appointment_Type]
