...
-- Drop Table [dbo].[u_Exam_Definition]
Print 'Drop Table [dbo].[u_Exam_Definition]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[u_Exam_Definition]') AND [type]='U'))
DROP TABLE [dbo].[u_Exam_Definition]
GO
-- Create Table [dbo].[u_Exam_Definition]
Print 'Create Table [dbo].[u_Exam_Definition]'
GO
SET ANSI_NULLS OFF
