...
-- Drop Table [dbo].[c_Maintenance_Treatment]
Print 'Drop Table [dbo].[c_Maintenance_Treatment]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Maintenance_Treatment]') AND [type]='U'))
DROP TABLE [dbo].[c_Maintenance_Treatment]
GO
-- Create Table [dbo].[c_Maintenance_Treatment]
Print 'Create Table [dbo].[c_Maintenance_Treatment]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Maintenance_Treatment]
	ADD
	CONSTRAINT [PK_c_Maintenance_Treatment]
	PRIMARY KEY
	CLUSTERED
	([maintenance_rule_id], [maintenance_treatment_sequence])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Maintenance_Treatment]
	ADD
	CONSTRAINT [DF_c_mt_created]
