...
GO
ALTER TABLE [dbo].[c_Datawindow]
	ADD
	CONSTRAINT [PK_c_Datawindow]
	PRIMARY KEY
	CLUSTERED
	([config_object_id])
	WITH FILLFACTOR=70
...
ALTER TABLE [dbo].[c_Datawindow]
	ADD
	CONSTRAINT [DF_c_Datawindow_created]
	DEFAULT (getdate()) FOR [created]
GO
ALTER TABLE [dbo].[c_Datawindow]
	ADD
	CONSTRAINT [DF_c_Datawindow_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Datawindow]
	ADD
	CONSTRAINT [DF_c_Datawindow_status]
...
GRANT UPDATE
	...
	TO [cprsystem]
GO
ALTER TABLE [dbo].[c_Datawindow] SET (LOCK_ESCALATION = TABLE)
GO
