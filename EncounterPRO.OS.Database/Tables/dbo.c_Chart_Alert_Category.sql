...
-- Drop Table [dbo].[c_Chart_Alert_Category]
Print 'Drop Table [dbo].[c_Chart_Alert_Category]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Chart_Alert_Category]') AND [type]='U'))
DROP TABLE [dbo].[c_Chart_Alert_Category]
GO
-- Create Table [dbo].[c_Chart_Alert_Category]
Print 'Create Table [dbo].[c_Chart_Alert_Category]'
GO
SET ANSI_NULLS ON
...
GO
CREATE TABLE [dbo].[c_Chart_Alert_Category] (
		[alert_category_id]     [varchar](12) NOT NULL,
...
ALTER TABLE [dbo].[c_Chart_Alert_Category]
	ADD
	CONSTRAINT [PK_c_Chart_Alert_Category]
	PRIMARY KEY
	CLUSTERED
	([alert_category_id])
	WITH FILLFACTOR=100
