...
-- Drop Table [dbo].[o_Report_Printer]
Print 'Drop Table [dbo].[o_Report_Printer]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Report_Printer]') AND [type]='U'))
DROP TABLE [dbo].[o_Report_Printer]
GO
-- Create Table [dbo].[o_Report_Printer]
Print 'Create Table [dbo].[o_Report_Printer]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[o_Report_Printer]
	ADD
	CONSTRAINT [PK_o_Report_Printer]
	PRIMARY KEY
	CLUSTERED
