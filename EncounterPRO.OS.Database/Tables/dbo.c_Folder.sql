...
-- Drop Table [dbo].[c_Folder]
Print 'Drop Table [dbo].[c_Folder]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Folder]') AND [type]='U'))
DROP TABLE [dbo].[c_Folder]
GO
-- Create Table [dbo].[c_Folder]
Print 'Create Table [dbo].[c_Folder]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Folder]
	ADD
	CONSTRAINT [DF_c_folder_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Folder]
	ADD
	CONSTRAINT [DF_c_folder_status]
