...
-- Drop Table [dbo].[x_Integration_Operation]
Print 'Drop Table [dbo].[x_Integration_Operation]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_Integration_Operation]') AND [type]='U'))
DROP TABLE [dbo].[x_Integration_Operation]
GO
-- Create Table [dbo].[x_Integration_Operation]
Print 'Create Table [dbo].[x_Integration_Operation]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_Integration_Operation]
	ADD
	CONSTRAINT [PK_x_Integration_Operation_40]
	PRIMARY KEY
	CLUSTERED
...
ALTER TABLE [dbo].[x_Integration_Operation]
	ADD
	CONSTRAINT [DF__x_Integra__statu__0100B3B6]
