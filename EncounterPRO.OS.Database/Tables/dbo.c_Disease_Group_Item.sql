...
-- Drop Table [dbo].[c_Disease_Group_Item]
Print 'Drop Table [dbo].[c_Disease_Group_Item]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Disease_Group_Item]') AND [type]='U'))
DROP TABLE [dbo].[c_Disease_Group_Item]
GO
-- Create Table [dbo].[c_Disease_Group_Item]
Print 'Create Table [dbo].[c_Disease_Group_Item]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Disease_Group_Item]
	ADD
	CONSTRAINT [PK_c_Disease_Group_Item]
	PRIMARY KEY
	CLUSTERED
	([disease_group], [disease_id])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Disease_Group_Item]
	ADD
	CONSTRAINT [DF_c_Disease_Group_Item_id]
