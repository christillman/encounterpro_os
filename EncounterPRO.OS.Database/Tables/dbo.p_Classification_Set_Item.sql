...
-- Drop Table [dbo].[p_Classification_Set_Item]
Print 'Drop Table [dbo].[p_Classification_Set_Item]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Classification_Set_Item]') AND [type]='U'))
DROP TABLE [dbo].[p_Classification_Set_Item]
GO
-- Create Table [dbo].[p_Classification_Set_Item]
Print 'Create Table [dbo].[p_Classification_Set_Item]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_Classification_Set_Item]
	ADD
	CONSTRAINT [PK_p_Classification_Set_Item]
	PRIMARY KEY
	NONCLUSTERED
	([cpr_id], [classification_set_id], [item_sequence])
	WITH FILLFACTOR=70
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[p_Classification_Set_Item]
...
ALTER TABLE [dbo].[p_Classification_Set_Item]
	ADD
	CONSTRAINT [DF_p_Classification_Set_Item_id]
	DEFAULT (newid()) FOR [id]
GO
CREATE CLUSTERED INDEX [idx_p_Classification_Set_Item_name]
