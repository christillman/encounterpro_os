...
-- Drop Table [dbo].[u_assessment_treat_definition]
Print 'Drop Table [dbo].[u_assessment_treat_definition]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[u_assessment_treat_definition]') AND [type]='U'))
DROP TABLE [dbo].[u_assessment_treat_definition]
GO
-- Create Table [dbo].[u_assessment_treat_definition]
Print 'Create Table [dbo].[u_assessment_treat_definition]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[u_assessment_treat_definition]
	ADD
	CONSTRAINT [DF_u_assessment_treat_definition_care_plan_id]
	DEFAULT ((0)) FOR [care_plan_id]
GO
ALTER TABLE [dbo].[u_assessment_treat_definition]
	ADD
