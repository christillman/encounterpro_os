...
-- Drop Table [dbo].[c_Observation_Stage]
Print 'Drop Table [dbo].[c_Observation_Stage]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Observation_Stage]') AND [type]='U'))
DROP TABLE [dbo].[c_Observation_Stage]
GO
-- Create Table [dbo].[c_Observation_Stage]
Print 'Create Table [dbo].[c_Observation_Stage]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Observation_Stage]
	ADD
	CONSTRAINT [PK_c_Observation_Stage_40]
	PRIMARY KEY
	CLUSTERED
