...
-- Drop Table [dbo].[x_Integrations]
Print 'Drop Table [dbo].[x_Integrations]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_Integrations]') AND [type]='U'))
DROP TABLE [dbo].[x_Integrations]
GO
-- Create Table [dbo].[x_Integrations]
Print 'Create Table [dbo].[x_Integrations]'
GO
SET ANSI_NULLS ON
