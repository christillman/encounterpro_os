...
-- Drop Table [dbo].[c_Observation_Type]
Print 'Drop Table [dbo].[c_Observation_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Observation_Type]') AND [type]='U'))
DROP TABLE [dbo].[c_Observation_Type]
GO
-- Create Table [dbo].[c_Observation_Type]
Print 'Create Table [dbo].[c_Observation_Type]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Observation_Type]
	ADD
	CONSTRAINT [PK_c_Observation_Type_01]
	PRIMARY KEY
	CLUSTERED
	([observation_type])
	WITH FILLFACTOR=100
