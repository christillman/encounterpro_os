...
-- Drop Table [dbo].[c_Property_Type]
Print 'Drop Table [dbo].[c_Property_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Property_Type]') AND [type]='U'))
DROP TABLE [dbo].[c_Property_Type]
GO
-- Create Table [dbo].[c_Property_Type]
Print 'Create Table [dbo].[c_Property_Type]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Property_Type]
	ADD
	CONSTRAINT [PK_c_Property_type_1]
	PRIMARY KEY
	CLUSTERED
	([property_type])
	WITH FILLFACTOR=100
