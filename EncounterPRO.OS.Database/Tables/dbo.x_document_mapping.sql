...
-- Drop Table [dbo].[x_document_mapping]
Print 'Drop Table [dbo].[x_document_mapping]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_document_mapping]') AND [type]='U'))
DROP TABLE [dbo].[x_document_mapping]
GO
-- Create Table [dbo].[x_document_mapping]
Print 'Create Table [dbo].[x_document_mapping]'
GO
SET ANSI_NULLS ON
