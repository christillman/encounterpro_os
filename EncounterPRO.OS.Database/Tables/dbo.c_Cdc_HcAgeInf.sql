...
ALTER TABLE [dbo].[c_Cdc_HcAgeInf]
	...
	ON [PRIMARY]
GO
GRANT DELETE ON [dbo].[c_Cdc_HcAgeInf] TO [cprsystem]
GO
GRANT INSERT ON [dbo].[c_Cdc_HcAgeInf] TO [cprsystem]
GO
GRANT REFERENCES ON [dbo].[c_Cdc_HcAgeInf] TO [cprsystem]
GO
GRANT SELECT ON [dbo].[c_Cdc_HcAgeInf] TO [cprsystem]
GO
GRANT UPDATE ON [dbo].[c_Cdc_HcAgeInf] TO [cprsystem]
GO
