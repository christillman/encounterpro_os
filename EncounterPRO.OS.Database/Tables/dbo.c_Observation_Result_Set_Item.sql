...
-- Drop Table [dbo].[c_Observation_Result_Set_Item]
Print 'Drop Table [dbo].[c_Observation_Result_Set_Item]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Observation_Result_Set_Item]') AND [type]='U'))
DROP TABLE [dbo].[c_Observation_Result_Set_Item]
GO
-- Create Table [dbo].[c_Observation_Result_Set_Item]
Print 'Create Table [dbo].[c_Observation_Result_Set_Item]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Observation_Result_Set_Item]
	ADD
	CONSTRAINT [PK_c_Obs_Res_Set_Item_27]
	PRIMARY KEY
	CLUSTERED
	([result_set_id], [result_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Observation_Result_Set_Item]
...
ALTER TABLE [dbo].[c_Observation_Result_Set_Item]
	WITH CHECK
	ADD CONSTRAINT [FK_c_Observation_Res_1]
	FOREIGN KEY ([result_set_id]) REFERENCES [dbo].[c_Observation_Result_Set] ([result_set_id])
ALTER TABLE [dbo].[c_Observation_Result_Set_Item]
	CHECK CONSTRAINT [FK_c_Observation_Res_1]
