...
-- Drop Table [dbo].[p_assessment_Progress]
Print 'Drop Table [dbo].[p_assessment_Progress]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_assessment_Progress]') AND [type]='U'))
DROP TABLE [dbo].[p_assessment_Progress]
GO
-- Create Table [dbo].[p_assessment_Progress]
Print 'Create Table [dbo].[p_assessment_Progress]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[p_assessment_Progress]
	ADD
	CONSTRAINT [PK_p_assessment_Progress_1__11]
	PRIMARY KEY
	CLUSTERED
	([cpr_id], [problem_id], [assessment_progress_sequence])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[p_assessment_Progress]
...
ALTER TABLE [dbo].[p_assessment_Progress]
	ADD
	CONSTRAINT [DF__p_assessm_progress_curflg]
	DEFAULT ('Y') FOR [current_flag]
GO
ALTER TABLE [dbo].[p_assessment_Progress]
	ADD
	CONSTRAINT [DF__p_assessment__id__2FCFE5E1]
