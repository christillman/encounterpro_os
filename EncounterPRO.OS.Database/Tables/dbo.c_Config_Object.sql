...
-- Drop Table [dbo].[c_Config_Object]
Print 'Drop Table [dbo].[c_Config_Object]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Config_Object]') AND [type]='U'))
DROP TABLE [dbo].[c_Config_Object]
GO
-- Create Table [dbo].[c_Config_Object]
Print 'Create Table [dbo].[c_Config_Object]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Config_Object]
	ADD
	CONSTRAINT [DF_c_Config_Object_copyable]
	DEFAULT ((1)) FOR [copyable]
GO
ALTER TABLE [dbo].[c_Config_Object]
	ADD
	CONSTRAINT [DF_c_Config_Object_copyright_status]
	DEFAULT ('Owner') FOR [copyright_status]
GO
ALTER TABLE [dbo].[c_Config_Object]
	ADD
	CONSTRAINT [DF_c_Config_Object_created]
	DEFAULT (getdate()) FOR [created]
GO
ALTER TABLE [dbo].[c_Config_Object]
	ADD
	CONSTRAINT [DF_c_Config_Object_owner_id]
