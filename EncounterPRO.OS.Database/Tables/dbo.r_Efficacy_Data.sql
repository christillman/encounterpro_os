...
-- Drop Table [dbo].[r_Efficacy_Data]
Print 'Drop Table [dbo].[r_Efficacy_Data]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[r_Efficacy_Data]') AND [type]='U'))
DROP TABLE [dbo].[r_Efficacy_Data]
GO
-- Create Table [dbo].[r_Efficacy_Data]
Print 'Create Table [dbo].[r_Efficacy_Data]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[r_Efficacy_Data]
	ADD
	CONSTRAINT [PK_r_Efficacy_Data_40]
	PRIMARY KEY
	CLUSTERED
	([clinicaleventid])
	WITH FILLFACTOR=70
