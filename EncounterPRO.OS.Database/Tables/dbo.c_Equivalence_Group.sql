...
-- Drop Table [dbo].[c_Equivalence_Group]
Print 'Drop Table [dbo].[c_Equivalence_Group]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Equivalence_Group]') AND [type]='U'))
DROP TABLE [dbo].[c_Equivalence_Group]
GO
-- Create Table [dbo].[c_Equivalence_Group]
Print 'Create Table [dbo].[c_Equivalence_Group]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Equivalence_Group]
	ADD
	CONSTRAINT [PK_c_Equivalence_Group_1__11]
	PRIMARY KEY
	CLUSTERED
