...
-- Drop Table [dbo].[c_Classification_Set]
Print 'Drop Table [dbo].[c_Classification_Set]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Classification_Set]') AND [type]='U'))
DROP TABLE [dbo].[c_Classification_Set]
GO
-- Create Table [dbo].[c_Classification_Set]
Print 'Create Table [dbo].[c_Classification_Set]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [PK_c_Classification_Set]
	PRIMARY KEY
	CLUSTERED
...
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [DF_c_Classification_Set_created]
	DEFAULT (dbo.get_client_datetime()) FOR [created]
GO
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [DF_c_Classification_Set_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [DF_c_Classification_Set_owner_id]
	DEFAULT ([dbo].[fn_customer_id]()) FOR [owner_id]
GO
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [DF_c_Classification_Set_status]
	DEFAULT ('OK') FOR [status]
GO
ALTER TABLE [dbo].[c_Classification_Set]
	ADD
	CONSTRAINT [DF_c_Classification_Set_version]
