...
-- Drop Table [dbo].[c_Report_Params]
Print 'Drop Table [dbo].[c_Report_Params]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Report_Params]') AND [type]='U'))
DROP TABLE [dbo].[c_Report_Params]
GO
-- Create Table [dbo].[c_Report_Params]
Print 'Create Table [dbo].[c_Report_Params]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Report_Params]
	ADD
	CONSTRAINT [PK_Rep_params_21]
	PRIMARY KEY
	CLUSTERED
	([report_id], [param_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Report_Params]
