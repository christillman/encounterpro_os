...
-- Drop Table [dbo].[c_component_interface_object_log]
Print 'Drop Table [dbo].[c_component_interface_object_log]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_component_interface_object_log]') AND [type]='U'))
DROP TABLE [dbo].[c_component_interface_object_log]
GO
-- Create Table [dbo].[c_component_interface_object_log]
Print 'Create Table [dbo].[c_component_interface_object_log]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_component_interface_object_log]
	ADD
	CONSTRAINT [DF_c_comp_int_obj_log_id]
