...
-- Drop Table [dbo].[p_Observation_Result_Qualifier]
Print 'Drop Table [dbo].[p_Observation_Result_Qualifier]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[p_Observation_Result_Qualifier]') AND [type]='U'))
DROP TABLE [dbo].[p_Observation_Result_Qualifier]
GO
-- Create Table [dbo].[p_Observation_Result_Qualifier]
Print 'Create Table [dbo].[p_Observation_Result_Qualifier]'
GO
SET ANSI_NULLS OFF
...
ALTER TABLE [dbo].[p_Observation_Result_Qualifier]
	ADD
	CONSTRAINT [PK_p_Observation_Result_Qua1__13]
	PRIMARY KEY
	CLUSTERED
	([cpr_id], [treatment_id], [observation_sequence], [location], [result_sequence], [qualifier_domain_id], [qualifier])
	WITH FILLFACTOR=70
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[p_Observation_Result_Qualifier]
	ADD
	CONSTRAINT [DF__p_Observatio__id__538D5813]
