...
-- Drop Table [dbo].[c_Domain_Master]
Print 'Drop Table [dbo].[c_Domain_Master]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Domain_Master]') AND [type]='U'))
DROP TABLE [dbo].[c_Domain_Master]
GO
-- Create Table [dbo].[c_Domain_Master]
Print 'Create Table [dbo].[c_Domain_Master]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Domain_Master]
	ADD
	CONSTRAINT [DF__c_Domain___equiv__59EED7FB]
	DEFAULT ('N') FOR [equivalence_flag]
GO
ALTER TABLE [dbo].[c_Domain_Master]
	ADD
	CONSTRAINT [DF__c_Domain___item___58FAB3C2]
	DEFAULT ('Customer') FOR [item_owner]
GO
ALTER TABLE [dbo].[c_Domain_Master]
	ADD
	CONSTRAINT [DF__c_Domain___map_c__58068F89]
	DEFAULT ('ManyToOne') FOR [map_cardinality]
GO
ALTER TABLE [dbo].[c_Domain_Master]
	ADD
...
ALTER TABLE [dbo].[c_Domain_Master]
	ADD
	CONSTRAINT [DF__c_Domain_Master_id]
