...
-- Drop Table [dbo].[c_Growth_Data]
Print 'Drop Table [dbo].[c_Growth_Data]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Growth_Data]') AND [type]='U'))
DROP TABLE [dbo].[c_Growth_Data]
GO
-- Create Table [dbo].[c_Growth_Data]
Print 'Create Table [dbo].[c_Growth_Data]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Growth_Data]
	ADD
	CONSTRAINT [PK_c_Growth_Data_1__10]
	PRIMARY KEY
	CLUSTERED
	([measurement], [sex], [age_months])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
GRANT DELETE
