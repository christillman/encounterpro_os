...
-- Drop Table [dbo].[c_Cdc_WtAgeInf]
Print 'Drop Table [dbo].[c_Cdc_WtAgeInf]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Cdc_WtAgeInf]') AND [type]='U'))
DROP TABLE [dbo].[c_Cdc_WtAgeInf]
GO
-- Create Table [dbo].[c_Cdc_WtAgeInf]
Print 'Create Table [dbo].[c_Cdc_WtAgeInf]'
GO
SET ANSI_NULLS OFF
...
GO
ALTER TABLE [dbo].[c_Cdc_WtAgeInf]
	ADD
	CONSTRAINT [PK_c_Cdc_WtAgeInf]
	PRIMARY KEY
	CLUSTERED
	([Sex], [Months])
	WITH FILLFACTOR=100
