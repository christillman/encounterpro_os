...
-- Drop Table [dbo].[x_Property_Exception]
Print 'Drop Table [dbo].[x_Property_Exception]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[x_Property_Exception]') AND [type]='U'))
DROP TABLE [dbo].[x_Property_Exception]
GO
-- Create Table [dbo].[x_Property_Exception]
Print 'Create Table [dbo].[x_Property_Exception]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[x_Property_Exception]
	ADD
	CONSTRAINT [PK_x_Property_Exception]
	PRIMARY KEY
	CLUSTERED
	([spid])
	WITH FILLFACTOR=70
