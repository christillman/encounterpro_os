...
Print 'Drop Table [dbo].[pbcatfmt]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[pbcatfmt]') AND [type]='U'))
DROP TABLE [dbo].[pbcatfmt]
GO
-- Create Table [dbo].[pbcatfmt]
Print 'Create Table [dbo].[pbcatfmt]'
GO
SET ANSI_NULLS OFF
...
CREATE UNIQUE CLUSTERED INDEX [pbcatfmt_idx]
	ON [dbo].[pbcatfmt] ([pbf_name]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[pbcatfmt] SET (LOCK_ESCALATION = TABLE)
GO
