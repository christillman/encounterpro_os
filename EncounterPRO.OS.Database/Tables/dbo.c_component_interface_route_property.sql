...
-- Drop Table [dbo].[c_component_interface_route_property]
Print 'Drop Table [dbo].[c_component_interface_route_property]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_component_interface_route_property]') AND [type]='U'))
DROP TABLE [dbo].[c_component_interface_route_property]
GO
-- Create Table [dbo].[c_component_interface_route_property]
Print 'Create Table [dbo].[c_component_interface_route_property]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_component_interface_route_property]
	ADD
	CONSTRAINT [PK_c_component_interface_route_pty]
	PRIMARY KEY
	CLUSTERED
	([property_sequence])
	ON [PRIMARY]
