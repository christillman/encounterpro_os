...
-- Drop Table [dbo].[c_Treatment_Type_Progress_Type]
Print 'Drop Table [dbo].[c_Treatment_Type_Progress_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Treatment_Type_Progress_Type]') AND [type]='U'))
DROP TABLE [dbo].[c_Treatment_Type_Progress_Type]
GO
-- Create Table [dbo].[c_Treatment_Type_Progress_Type]
Print 'Create Table [dbo].[c_Treatment_Type_Progress_Type]'
GO
SET ANSI_NULLS ON
...
GO
ALTER TABLE [dbo].[c_Treatment_Type_Progress_Type]
	ADD
	CONSTRAINT [PK_c_Treatment_Type_Progress_Type]
	PRIMARY KEY
	CLUSTERED
	([treatment_type], [progress_type])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Treatment_Type_Progress_Type]
	ADD
	CONSTRAINT [DF__c_Treatme__displ__481183C6]
	DEFAULT ('Y') FOR [display_flag]
GO
ALTER TABLE [dbo].[c_Treatment_Type_Progress_Type]
	ADD
	CONSTRAINT [DF__c_Treatme__progr__4905A7FF]
