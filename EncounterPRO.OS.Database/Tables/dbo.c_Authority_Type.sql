...
-- Drop Table [dbo].[c_Authority_Type]
Print 'Drop Table [dbo].[c_Authority_Type]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Authority_Type]') AND [type]='U'))
DROP TABLE [dbo].[c_Authority_Type]
GO
-- Create Table [dbo].[c_Authority_Type]
Print 'Create Table [dbo].[c_Authority_Type]'
GO
SET ANSI_NULLS OFF
...
ALTER TABLE [dbo].[c_Authority_Type]
	ADD
	CONSTRAINT [PK_c_Authority_Type]
	PRIMARY KEY
	CLUSTERED
	([authority_type])
	WITH FILLFACTOR=100
