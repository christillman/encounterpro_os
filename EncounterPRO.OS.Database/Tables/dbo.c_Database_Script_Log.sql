...
-- Drop Table [dbo].[c_Database_Script_Log]
Print 'Drop Table [dbo].[c_Database_Script_Log]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Database_Script_Log]') AND [type]='U'))
DROP TABLE [dbo].[c_Database_Script_Log]
GO
-- Create Table [dbo].[c_Database_Script_Log]
Print 'Create Table [dbo].[c_Database_Script_Log]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Database_Script_Log]
	ADD
	CONSTRAINT [PK_c_Database_Script_Log]
	PRIMARY KEY
	CLUSTERED
	([script_log_id])
	WITH FILLFACTOR=100
