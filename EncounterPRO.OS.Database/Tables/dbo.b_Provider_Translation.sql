...
-- Drop Table [dbo].[b_Provider_Translation]
Print 'Drop Table [dbo].[b_Provider_Translation]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[b_Provider_Translation]') AND [type]='U'))
DROP TABLE [dbo].[b_Provider_Translation]
GO
-- Create Table [dbo].[b_Provider_Translation]
Print 'Create Table [dbo].[b_Provider_Translation]'
GO
SET ANSI_NULLS ON
...
CREATE TABLE [dbo].[b_Provider_Translation] (
		...
		[epro_id]         [varchar](24) NOT NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[b_Provider_Translation]
	ADD
	CONSTRAINT [PK_b_Provider_Translation]
	PRIMARY KEY
	CLUSTERED
