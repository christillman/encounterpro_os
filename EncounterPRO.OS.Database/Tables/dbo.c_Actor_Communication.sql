...
-- Drop Table [dbo].[c_Actor_Communication]
Print 'Drop Table [dbo].[c_Actor_Communication]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Actor_Communication]') AND [type]='U'))
DROP TABLE [dbo].[c_Actor_Communication]
GO
-- Create Table [dbo].[c_Actor_Communication]
Print 'Create Table [dbo].[c_Actor_Communication]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Actor_Communication]
	ADD
	CONSTRAINT [PK_c_Actor_Communication_40]
	PRIMARY KEY
	CLUSTERED
	([actor_id], [communication_sequence])
	WITH FILLFACTOR=80
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Actor_Communication]
...
ALTER TABLE [dbo].[c_Actor_Communication]
	ADD
	CONSTRAINT [DF_c_Actor_Communication_id]
	DEFAULT (newid()) FOR [id]
GO
ALTER TABLE [dbo].[c_Actor_Communication]
	ADD
	CONSTRAINT [DF_c_Actor_Communication_status]
	DEFAULT ('OK') FOR [status]
GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_communication_sequence]
