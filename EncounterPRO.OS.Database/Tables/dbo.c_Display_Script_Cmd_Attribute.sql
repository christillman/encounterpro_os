...
-- Drop Table [dbo].[c_Display_Script_Cmd_Attribute]
Print 'Drop Table [dbo].[c_Display_Script_Cmd_Attribute]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Display_Script_Cmd_Attribute]') AND [type]='U'))
DROP TABLE [dbo].[c_Display_Script_Cmd_Attribute]
GO
-- Create Table [dbo].[c_Display_Script_Cmd_Attribute]
Print 'Create Table [dbo].[c_Display_Script_Cmd_Attribute]'
GO
SET ANSI_NULLS ON
...
ALTER TABLE [dbo].[c_Display_Script_Cmd_Attribute]
	ADD
	CONSTRAINT [PK_c_Display_Script_Cmd_Attribute]
	PRIMARY KEY
	CLUSTERED
	([display_script_id], [display_command_id], [attribute_sequence])
	WITH FILLFACTOR=100
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[c_Display_Script_Cmd_Attribute]
