...
-- Drop Table [dbo].[c_Config_Log]
Print 'Drop Table [dbo].[c_Config_Log]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[c_Config_Log]') AND [type]='U'))
DROP TABLE [dbo].[c_Config_Log]
GO
-- Create Table [dbo].[c_Config_Log]
Print 'Create Table [dbo].[c_Config_Log]'
GO
SET ANSI_NULLS ON
