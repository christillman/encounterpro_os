...
-- Drop Table [dbo].[o_Users]
Print 'Drop Table [dbo].[o_Users]'
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[o_Users]') AND [type]='U'))
DROP TABLE [dbo].[o_Users]
GO
-- Create Table [dbo].[o_Users]
Print 'Create Table [dbo].[o_Users]'
GO
SET ANSI_NULLS ON
