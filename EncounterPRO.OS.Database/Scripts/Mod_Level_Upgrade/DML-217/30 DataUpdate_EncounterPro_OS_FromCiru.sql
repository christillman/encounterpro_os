...
UPDATE [dbo].[c_Office] SET [description]=N'Living Stone Medical Specialists', [address1]=N'Plot 112 Muteesa II Rd', [address2]=N'Ntinda', [city]=N'Kampala', [state]=N'UG', [zip]=N'NULL', [phone]=N'+256778532521', [billing_component_id]=N'FOXMEADOWS_BILL', [country]=N'UG' WHERE [office_id]=N'0001'
...
UPDATE [dbo].[o_Preferences] SET [preference_value]=N'NULL' WHERE [preference_type]=N'PROPERTY' AND [preference_level]=N'Global' AND [preference_key]=N'Global' AND [preference_id]=N'Favorite Adult Other HX'
