...
exec sp_add_epro_drug 0, 0, 'KE', '1544A', 'No Brand', 'BCG, Live (children over one year and adult) vaccine between 2 x105 and 8x105 C.F.U per 0.1 ML Injection', 'No Corresponding SCD RXCUI', 'BCG Vaccine', 'Vaccine'
exec sp_add_epro_drug 0, 0, 'KE', '1544B', 'No Brand', 'BCG, Live, BCG, Live (Infant under one year) vaccine between 2 x105 and 8x105 C.F.U per 0.05 ML Injection', 'No Corresponding SCD RXCUI', 'BCG Vaccine', 'Vaccine'
...
exec sp_add_epro_drug 0, 0, 'KE', '3627A', 'ENGERIX-B Adult Vaccine 20 MCG in 1 ML Injection', 'hepatitis B vaccine (recombinant) adult 20 MCG in 1 ML Injection', 'PSN-1658156', 'hepatitis B surface antigen vaccine', 'Vaccine'
exec sp_add_epro_drug 0, 0, 'KE', '3627B', 'ENGERIX-B Adult vaccine 20 MCG in 1 ML Prefilled Syringe', 'hepatitis B vaccine (recombinant) adult 20 MCG in 1 ML Injection', 'PSN-1658156', 'hepatitis B surface antigen vaccine', 'Vaccine'
exec sp_add_epro_drug 0, 0, 'KE', '3629A', 'ENGERIX-B Pediatric Vaccine 10 MCG in 0.5 ML Injection', 'hepatitis B vaccine (recombinant) pediatric/adolescent 10 MCG in 0.5 ML Injection', 'PSN-1658142', 'hepatitis B surface antigen vaccine', 'Vaccine'
exec sp_add_epro_drug 0, 0, 'KE', '3629B', 'ENGERIX-B Pediatric vaccine 10 MCG in 0.5 ML Prefilled Syringe', 'hepatitis B vaccine (recombinant) pediatric/adolescent 10 MCG in 0.5 ML Injection', 'PSN-1658142', 'hepatitis B surface antigen vaccine', 'Vaccine'
...
exec sp_add_epro_drug 0, 0, 'KE', '6791A', 'BCG vaccine SSI (Infant under one year) 0.05 ML Injectable Suspension', 'mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live attenuated Injectable Suspension', 'No Corresponding SCD RXCUI', 'mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live (Infant under one year) attenuated per 0.05 ML Injectable Suspension', 'Vaccine', 'Kenya SCD Version: mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live attenuated between 2-8 x105 bacteria/0.1 ML Injectable Suspension'
exec sp_add_epro_drug 0, 0, 'KE', '6791B', 'BCG vaccine SSI (children over one year and adult) 0.1 ML Injectable Suspension', 'mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live attenuated Injectable Suspension', 'No Corresponding SCD RXCUI', 'mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live (children over one year and adult) attenuated per 0.1 ML Injectable Suspension', 'Vaccine', 'Kenya SCD Version: mycobacterium bovis BCG (Bacillus Calmette-Guerin), danish strain 1331, live attenuated between 2-8 x105 bacteria/0.1 ML Injectable Suspension'
...
,('1544A', 'Intradermal (ID) Injection')
,('1544B', 'Intradermal (ID) Injection')
