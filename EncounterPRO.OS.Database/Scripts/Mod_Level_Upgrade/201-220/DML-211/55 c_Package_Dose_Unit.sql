-- Ciru email 1/26/2021
UPDATE df
SET default_dose_unit = NULL
-- select dosage_form, default_dose_unit
FROM c_Dosage_Form df
...
AND default_dose_unit IS NOT NULL
