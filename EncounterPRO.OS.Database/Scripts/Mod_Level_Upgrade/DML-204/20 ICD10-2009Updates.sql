...
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Abscess of ischiorectal fossa' where assessment_id = 'DEMO10435'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Alkalosis of newborn' where assessment_id = 'HYMAG'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Elevated urine level of vanillylmandelic acid (VMA)' where assessment_id = 'DEMO2131'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Elevated urine levels of 17-ketosteroids' where assessment_id = 'DEMO1288'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Elevated urine levels of catecholamines' where assessment_id = 'DEMO2129'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Elevated urine levels of indoleacetic acid' where assessment_id = 'DEMO2130'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Encounter for screening for developmental handicaps in early childhood' where assessment_id = 'DEMO9352'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Eye discharge' where assessment_id = 'DEMO6634'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Eye mass' where assessment_id = 'DEMO233'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Findings abnormal radiologic (X-ray) placenta' where assessment_id = '0^793.99^0'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Fistula ischiorectal' where assessment_id = 'DEMO7925'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Horseshoe abscess' where assessment_id = 'DEMO7924'
...
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Newborn affected by maternal use of cannabis' where assessment_id = 'DEMO6510Q'
...
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Other transitory electrolyte disturbance of newborn' where assessment_id = 'DEMO6727'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Other urethral stricture, male, meatal' where assessment_id = 'ICD-N358'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Primary hyperoxaluria' where assessment_id = 'ICD-E7253'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Screening developmental handicap in early childhood' where assessment_id = 'DEMO9351'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Unspecified bulbous urethral stricture, male' where assessment_id = 'DEMO8966'
UPDATE c_Assessment_Definition SET last_updated=getdate(), description ='Unspecified urethral stricture, male, meatal' where assessment_id = 'DEMO7046'
