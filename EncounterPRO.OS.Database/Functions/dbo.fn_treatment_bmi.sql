...
-- Drop Function [dbo].[fn_treatment_bmi]
Print 'Drop Function [dbo].[fn_treatment_bmi]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_treatment_bmi]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_treatment_bmi]
GO

-- Create Function [dbo].[fn_treatment_bmi]
Print 'Create Function [dbo].[fn_treatment_bmi]'
GO
SET ANSI_NULLS OFF
...
GO
GRANT SELECT ON [dbo].[fn_treatment_bmi] TO [cprsystem]
GO
