...
-- Drop Function [dbo].[fn_treatment_key_description]
Print 'Drop Function [dbo].[fn_treatment_key_description]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_treatment_key_description]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_treatment_key_description]
GO

-- Create Function [dbo].[fn_treatment_key_description]
Print 'Create Function [dbo].[fn_treatment_key_description]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_treatment_key_description]
	TO [cprsystem]
GO
