...
-- Drop Function [dbo].[fn_get_attribute]
Print 'Drop Function [dbo].[fn_get_attribute]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_get_attribute]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_get_attribute]
GO

-- Create Function [dbo].[fn_get_attribute]
Print 'Create Function [dbo].[fn_get_attribute]'
GO
SET ANSI_NULLS ON
