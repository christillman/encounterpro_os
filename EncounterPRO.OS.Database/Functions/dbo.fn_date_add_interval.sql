...
-- Drop Function [dbo].[fn_date_add_interval]
Print 'Drop Function [dbo].[fn_date_add_interval]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_date_add_interval]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_date_add_interval]
GO

-- Create Function [dbo].[fn_date_add_interval]
Print 'Create Function [dbo].[fn_date_add_interval]'
GO
SET ANSI_NULLS ON
