...
-- Drop Function [dbo].[fn_patient_object_progress_value]
Print 'Drop Function [dbo].[fn_patient_object_progress_value]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_patient_object_progress_value]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_patient_object_progress_value]
GO

-- Create Function [dbo].[fn_patient_object_progress_value]
Print 'Create Function [dbo].[fn_patient_object_progress_value]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_patient_object_progress_value]
	TO [cprsystem]
GO
