...
-- Drop Function [dbo].[fn_interval_compare]
Print 'Drop Function [dbo].[fn_interval_compare]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_interval_compare]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_interval_compare]
GO

-- Create Function [dbo].[fn_interval_compare]
Print 'Create Function [dbo].[fn_interval_compare]'
GO
SET ANSI_NULLS ON
