...
-- Drop Function [dbo].[fn_context_object_type]
Print 'Drop Function [dbo].[fn_context_object_type]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_context_object_type]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_context_object_type]
GO

-- Create Function [dbo].[fn_context_object_type]
Print 'Create Function [dbo].[fn_context_object_type]'
GO
SET ANSI_NULLS ON
