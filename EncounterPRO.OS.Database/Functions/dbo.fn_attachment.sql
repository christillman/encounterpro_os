...
-- Drop Function [dbo].[fn_attachment]
Print 'Drop Function [dbo].[fn_attachment]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_attachment]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_attachment]
GO

-- Create Function [dbo].[fn_attachment]
Print 'Create Function [dbo].[fn_attachment]'
GO
SET ANSI_NULLS ON
...
GO
GRANT SELECT ON [dbo].[fn_attachment] TO [cprsystem]
GO
