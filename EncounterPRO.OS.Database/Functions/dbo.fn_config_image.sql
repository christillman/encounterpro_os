...
-- Drop Function [dbo].[fn_config_image]
Print 'Drop Function [dbo].[fn_config_image]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_config_image]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_config_image]
GO

-- Create Function [dbo].[fn_config_image]
Print 'Create Function [dbo].[fn_config_image]'
GO
SET ANSI_NULLS ON
