...
-- Drop Function [dbo].[fn_patient_observation_last_result]
Print 'Drop Function [dbo].[fn_patient_observation_last_result]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_patient_observation_last_result]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_patient_observation_last_result]
GO

-- Create Function [dbo].[fn_patient_observation_last_result]
Print 'Create Function [dbo].[fn_patient_observation_last_result]'
GO
SET ANSI_NULLS ON
...
GO
GRANT SELECT ON [dbo].[fn_patient_observation_last_result] TO [cprsystem]
GO
