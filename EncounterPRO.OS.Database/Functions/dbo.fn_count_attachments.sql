...
-- Drop Function [dbo].[fn_count_attachments]
Print 'Drop Function [dbo].[fn_count_attachments]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_count_attachments]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_count_attachments]
GO

-- Create Function [dbo].[fn_count_attachments]
Print 'Create Function [dbo].[fn_count_attachments]'
GO
SET ANSI_NULLS ON
