...
-- Drop Function [dbo].[fn_lookup_treatment]
Print 'Drop Function [dbo].[fn_lookup_treatment]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_lookup_treatment]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_lookup_treatment]
GO

-- Create Function [dbo].[fn_lookup_treatment]
Print 'Create Function [dbo].[fn_lookup_treatment]'
GO
SET ANSI_NULLS ON
