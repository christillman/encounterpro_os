...
-- Drop Function [dbo].[fn_med_strength_unit]
Print 'Drop Function [dbo].[fn_med_strength_unit]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_med_strength_unit]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_med_strength_unit]
GO

-- Create Function [dbo].[fn_med_strength_unit]
Print 'Create Function [dbo].[fn_med_strength_unit]'
GO
SET ANSI_NULLS ON
