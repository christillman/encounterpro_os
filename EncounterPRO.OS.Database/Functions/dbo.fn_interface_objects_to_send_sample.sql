...
-- Drop Function [dbo].[fn_interface_objects_to_send_sample]
Print 'Drop Function [dbo].[fn_interface_objects_to_send_sample]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_interface_objects_to_send_sample]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_interface_objects_to_send_sample]
GO

-- Create Function [dbo].[fn_interface_objects_to_send_sample]
Print 'Create Function [dbo].[fn_interface_objects_to_send_sample]'
GO
SET ANSI_NULLS OFF
