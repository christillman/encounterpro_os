...
-- Drop Function [dbo].[fn_count_progress_for_object]
Print 'Drop Function [dbo].[fn_count_progress_for_object]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_count_progress_for_object]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_count_progress_for_object]
GO

-- Create Function [dbo].[fn_count_progress_for_object]
Print 'Create Function [dbo].[fn_count_progress_for_object]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_count_progress_for_object]
	TO [cprsystem]
GO
