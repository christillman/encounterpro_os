...
-- Drop Function [dbo].[fn_em_encounter_reviewed_results_detail]
Print 'Drop Function [dbo].[fn_em_encounter_reviewed_results_detail]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_em_encounter_reviewed_results_detail]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_em_encounter_reviewed_results_detail]
GO

-- Create Function [dbo].[fn_em_encounter_reviewed_results_detail]
Print 'Create Function [dbo].[fn_em_encounter_reviewed_results_detail]'
GO
SET ANSI_NULLS ON
...
GO
GRANT SELECT ON [dbo].[fn_em_encounter_reviewed_results_detail] TO [cprsystem]
GO
