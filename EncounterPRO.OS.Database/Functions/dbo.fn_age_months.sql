...
-- Drop Function [dbo].[fn_age_months]
Print 'Drop Function [dbo].[fn_age_months]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_age_months]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_age_months]
GO

-- Create Function [dbo].[fn_age_months]
Print 'Create Function [dbo].[fn_age_months]'
GO
SET ANSI_NULLS ON
