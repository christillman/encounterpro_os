...
-- Drop Function [dbo].[fn_date_add_interval_string]
Print 'Drop Function [dbo].[fn_date_add_interval_string]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_date_add_interval_string]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_date_add_interval_string]
GO

-- Create Function [dbo].[fn_date_add_interval_string]
Print 'Create Function [dbo].[fn_date_add_interval_string]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_date_add_interval_string]
	TO [cprsystem]
GO
