...
-- Drop Function [dbo].[fn_lookup_encounter]
Print 'Drop Function [dbo].[fn_lookup_encounter]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_lookup_encounter]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_lookup_encounter]
GO

-- Create Function [dbo].[fn_lookup_encounter]
Print 'Create Function [dbo].[fn_lookup_encounter]'
GO
SET ANSI_NULLS ON
