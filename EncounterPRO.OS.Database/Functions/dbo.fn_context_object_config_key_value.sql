...
-- Drop Function [dbo].[fn_context_object_config_key_value]
Print 'Drop Function [dbo].[fn_context_object_config_key_value]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_context_object_config_key_value]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_context_object_config_key_value]
GO

-- Create Function [dbo].[fn_context_object_config_key_value]
Print 'Create Function [dbo].[fn_context_object_config_key_value]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_context_object_config_key_value]
	TO [cprsystem]
GO
