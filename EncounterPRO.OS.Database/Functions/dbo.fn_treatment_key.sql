...
-- Drop Function [dbo].[fn_treatment_key]
Print 'Drop Function [dbo].[fn_treatment_key]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_treatment_key]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_treatment_key]
GO

-- Create Function [dbo].[fn_treatment_key]
Print 'Create Function [dbo].[fn_treatment_key]'
GO
SET ANSI_NULLS ON
