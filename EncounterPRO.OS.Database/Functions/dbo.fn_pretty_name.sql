...
-- Drop Function [dbo].[fn_pretty_name]
Print 'Drop Function [dbo].[fn_pretty_name]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_pretty_name]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_pretty_name]
GO

-- Create Function [dbo].[fn_pretty_name]
Print 'Create Function [dbo].[fn_pretty_name]'
GO
SET ANSI_NULLS ON
