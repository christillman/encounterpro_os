...
-- Drop Function [dbo].[fn_user_task_counts]
Print 'Drop Function [dbo].[fn_user_task_counts]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_user_task_counts]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_user_task_counts]
GO

-- Create Function [dbo].[fn_user_task_counts]
Print 'Create Function [dbo].[fn_user_task_counts]'
GO
SET ANSI_NULLS ON
