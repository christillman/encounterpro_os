...
-- Drop Function [dbo].[fn_attachment_location]
Print 'Drop Function [dbo].[fn_attachment_location]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_attachment_location]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_attachment_location]
GO

-- Create Function [dbo].[fn_attachment_location]
Print 'Create Function [dbo].[fn_attachment_location]'
GO
SET ANSI_NULLS OFF
