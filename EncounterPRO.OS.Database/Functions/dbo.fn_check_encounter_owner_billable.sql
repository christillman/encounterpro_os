...
-- Drop Function [dbo].[fn_check_encounter_owner_billable]
Print 'Drop Function [dbo].[fn_check_encounter_owner_billable]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_check_encounter_owner_billable]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_check_encounter_owner_billable]
GO

-- Create Function [dbo].[fn_check_encounter_owner_billable]
Print 'Create Function [dbo].[fn_check_encounter_owner_billable]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_check_encounter_owner_billable]
	TO [cprsystem]
GO
