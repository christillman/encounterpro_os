...
-- Drop Function [dbo].[fn_workplan_item_owned_by]
Print 'Drop Function [dbo].[fn_workplan_item_owned_by]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_workplan_item_owned_by]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_workplan_item_owned_by]
GO

-- Create Function [dbo].[fn_workplan_item_owned_by]
Print 'Create Function [dbo].[fn_workplan_item_owned_by]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_workplan_item_owned_by]
	TO [cprsystem]
GO
