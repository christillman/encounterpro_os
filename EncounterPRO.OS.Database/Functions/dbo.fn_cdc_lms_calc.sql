...
-- Drop Function [dbo].[fn_cdc_lms_calc]
Print 'Drop Function [dbo].[fn_cdc_lms_calc]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_cdc_lms_calc]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_cdc_lms_calc]
GO

-- Create Function [dbo].[fn_cdc_lms_calc]
Print 'Create Function [dbo].[fn_cdc_lms_calc]'
GO
SET ANSI_NULLS ON
