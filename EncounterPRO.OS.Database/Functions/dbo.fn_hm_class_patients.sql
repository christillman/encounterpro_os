...
-- Drop Function [dbo].[fn_hm_class_patients]
Print 'Drop Function [dbo].[fn_hm_class_patients]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_hm_class_patients]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_hm_class_patients]
GO

-- Create Function [dbo].[fn_hm_class_patients]
Print 'Create Function [dbo].[fn_hm_class_patients]'
GO
SET ANSI_NULLS ON
