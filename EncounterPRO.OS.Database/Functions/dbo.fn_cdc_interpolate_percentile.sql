...
-- Drop Function [dbo].[fn_cdc_interpolate_percentile]
Print 'Drop Function [dbo].[fn_cdc_interpolate_percentile]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_cdc_interpolate_percentile]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_cdc_interpolate_percentile]
GO

-- Create Function [dbo].[fn_cdc_interpolate_percentile]
Print 'Create Function [dbo].[fn_cdc_interpolate_percentile]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_cdc_interpolate_percentile]
	TO [cprsystem]
GO
