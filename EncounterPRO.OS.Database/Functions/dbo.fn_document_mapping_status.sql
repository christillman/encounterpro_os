...
-- Drop Function [dbo].[fn_document_mapping_status]
Print 'Drop Function [dbo].[fn_document_mapping_status]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_document_mapping_status]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_document_mapping_status]
GO

-- Create Function [dbo].[fn_document_mapping_status]
Print 'Create Function [dbo].[fn_document_mapping_status]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_document_mapping_status]
	TO [cprsystem]
GO
