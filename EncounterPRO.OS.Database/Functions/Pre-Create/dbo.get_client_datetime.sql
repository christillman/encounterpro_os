...
AS
BEGIN
RETURN CAST(SYSDATETIMEOFFSET() AT TIME ZONE 'E. Africa Standard Time' AS datetime)

--(SELECT TOP 1 CAST(SYSDATETIMEOFFSET() AT TIME ZONE /* IsNull(timezone, */'E. Africa Standard Time' /*)*/ AS datetime)
