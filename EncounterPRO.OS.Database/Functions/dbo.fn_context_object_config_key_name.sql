...
-- Drop Function [dbo].[fn_context_object_config_key_name]
Print 'Drop Function [dbo].[fn_context_object_config_key_name]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_context_object_config_key_name]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_context_object_config_key_name]
GO

-- Create Function [dbo].[fn_context_object_config_key_name]
Print 'Create Function [dbo].[fn_context_object_config_key_name]'
GO
SET ANSI_NULLS ON
...
GO
GRANT EXECUTE
	ON [dbo].[fn_context_object_config_key_name]
	TO [cprsystem]
GO
