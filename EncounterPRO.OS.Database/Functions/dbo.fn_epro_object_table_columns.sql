...
-- Drop Function [dbo].[fn_epro_object_table_columns]
Print 'Drop Function [dbo].[fn_epro_object_table_columns]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_epro_object_table_columns]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_epro_object_table_columns]
GO

-- Create Function [dbo].[fn_epro_object_table_columns]
Print 'Create Function [dbo].[fn_epro_object_table_columns]'
GO
SET ANSI_NULLS OFF
