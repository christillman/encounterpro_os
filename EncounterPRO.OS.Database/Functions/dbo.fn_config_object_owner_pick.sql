...
-- Drop Function [dbo].[fn_config_object_owner_pick]
Print 'Drop Function [dbo].[fn_config_object_owner_pick]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_config_object_owner_pick]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_config_object_owner_pick]
GO

-- Create Function [dbo].[fn_config_object_owner_pick]
Print 'Create Function [dbo].[fn_config_object_owner_pick]'
GO
SET ANSI_NULLS ON
