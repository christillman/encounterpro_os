...
-- Drop Function [dbo].[fn_patient_immunization_schedule]
Print 'Drop Function [dbo].[fn_patient_immunization_schedule]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_patient_immunization_schedule]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_patient_immunization_schedule]
GO

-- Create Function [dbo].[fn_patient_immunization_schedule]
Print 'Create Function [dbo].[fn_patient_immunization_schedule]'
GO
SET ANSI_NULLS ON
