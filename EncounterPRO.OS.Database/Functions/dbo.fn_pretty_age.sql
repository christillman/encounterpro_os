...
-- Drop Function [dbo].[fn_pretty_age]
Print 'Drop Function [dbo].[fn_pretty_age]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[fn_pretty_age]') AND ([type]='IF' OR [type]='FN' OR [type]='TF')))
DROP FUNCTION [dbo].[fn_pretty_age]
GO

-- Create Function [dbo].[fn_pretty_age]
Print 'Create Function [dbo].[fn_pretty_age]'
GO
SET ANSI_NULLS ON
