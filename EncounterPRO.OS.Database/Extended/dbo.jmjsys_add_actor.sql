...
-- Drop Procedure [dbo].[jmjsys_add_actor]
Print 'Drop Procedure [dbo].[jmjsys_add_actor]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[jmjsys_add_actor]') AND [type] = 'P'))
DROP PROCEDURE [dbo].[jmjsys_add_actor]
GO

-- Create Procedure [dbo].[jmjsys_add_actor]
Print 'Create Procedure [dbo].[jmjsys_add_actor]'
GO
SET ANSI_NULLS ON
