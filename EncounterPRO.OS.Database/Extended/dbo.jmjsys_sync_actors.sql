...
PRINT 'Special Sync Starting: ' + @ls_actor_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_actor_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Starting: ' + @ls_actor_address_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_actor_address_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Starting: ' + @ls_actor_communication_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_actor_communication_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Starting: ' + @ls_actor_progress_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_actor_progress_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Starting: ' + @ls_actor_Route_Purpose_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
...
-- Put a marker in the log
PRINT 'Special Sync Successful: ' + @ls_actor_Route_Purpose_tablename + '   ' + CAST(dbo.get_client_datetime() AS varchar(20))
