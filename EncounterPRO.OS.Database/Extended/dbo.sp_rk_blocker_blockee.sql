...
-- Drop Procedure [dbo].[sp_rk_blocker_blockee]
Print 'Drop Procedure [dbo].[sp_rk_blocker_blockee]'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[sp_rk_blocker_blockee]') AND [type]='P'))
DROP PROCEDURE [dbo].[sp_rk_blocker_blockee]
GO

-- Create Procedure [dbo].[sp_rk_blocker_blockee]
Print 'Create Procedure [dbo].[sp_rk_blocker_blockee]'
GO
SET ANSI_NULLS ON
