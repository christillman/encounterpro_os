...
{
	/// <summary>
	/// Summary description for EPSEventLog.
	/// </summary>
	public class EPSEventLog
	{
		private static System.Diagnostics.EventLog log = null;
		public static void WriteEntry(string Message, System.Diagnostics.EventLogEntryType EntryType)
		{
			if(log==null)
				log = new System.Diagnostics.EventLog("Application",Environment.MachineName,"EncounterPROService");
			log.WriteEntry("My PID = " + System.Diagnostics.Process.GetCurrentProcess().Id.ToString() +
				Environment.NewLine + Environment.NewLine + Message, EntryType);
		}
		public static void WriteEntry(string Message)
		{
			WriteEntry(Message, System.Diagnostics.EventLogEntryType.Information);
		}
